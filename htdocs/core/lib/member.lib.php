...
function member_prepare_head(Adherent $object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/card.php?rowid=' . $object->id;
    ...
    if ((!empty($conf->ldap->enabled) && !empty($conf->global->LDAP_MEMBER_ACTIVE))
        ...
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/ldap.php?id=' . $object->id;
    ...
    if (!empty($user->rights->adherent->cotisation->lire)) {
        ...
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/subscription.php?rowid=' . $object->id;
    ...
    if (getDolGlobalString('PARTNERSHIP_IS_MANAGED_FOR') == 'member') {
        if (!empty($user->rights->partnership->read)) {
            ...
            $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/partnership.php?rowid=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/note.php?id=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/document.php?id=' . $object->id;
    ...
    if (!empty($conf->agenda->enabled)) {
        $head[$h][0] = DOL_URL_ROOT . "/Modules/Adherents/agenda.php?id=" . $object->id;
...
function member_type_prepare_head(AdherentType $object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/type.php?rowid=' . $object->id;
    ...
    if (!empty($conf->global->MAIN_MULTILANGS)) {
        $head[$h][0] = DOL_URL_ROOT . "/Modules/Adherents/type_translation.php?rowid=" . $object->id;
    ...
    if ((!empty($conf->ldap->enabled) && !empty($conf->global->LDAP_MEMBER_TYPE_ACTIVE))
        ...
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/type_ldap.php?rowid=' . $object->id;
        $head[$h][1] = $langs->trans("LDAPCard");
        $head[$h][2] = 'ldap';
        $h++;
    }
...
function member_admin_prepare_head()
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/admin/member.php';
    $head[$h][1] = $langs->trans("Miscellaneous");
    $head[$h][2] = 'general';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/admin/member_emails.php';
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/admin/member_extrafields.php';
    $head[$h][1] = $langs->trans("ExtraFieldsMember");
    $head[$h][2] = 'attributes';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/admin/member_type_extrafields.php';
    $head[$h][1] = $langs->trans("ExtraFieldsMemberType");
    $head[$h][2] = 'attributes_type';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/admin/website.php';
...
function member_stats_prepare_head($object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/stats/index.php';
    $head[$h][1] = $langs->trans("Subscriptions");
    $head[$h][2] = 'statssubscription';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/stats/geo.php?mode=memberbycountry';
    $head[$h][1] = $langs->trans("Country");
    $head[$h][2] = 'statscountry';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/stats/geo.php?mode=memberbyregion';
    $head[$h][1] = $langs->trans("Region");
    $head[$h][2] = 'statsregion';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/stats/geo.php?mode=memberbystate';
    $head[$h][1] = $langs->trans("State");
    $head[$h][2] = 'statsstate';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/stats/geo.php?mode=memberbytown';
    $head[$h][1] = $langs->trans('Town');
    $head[$h][2] = 'statstown';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/stats/byproperties.php';
...
function subscription_prepare_head(Subscription $object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/subscription/card.php?rowid=' . $object->id;
    $head[$h][1] = $langs->trans("Subscription");
    $head[$h][2] = 'general';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Adherents/subscription/info.php?rowid=' . $object->id;
