...
function tax_prepare_head(ChargeSociales $object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/sociales/card.php?id=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/sociales/document.php?id=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/sociales/info.php?id=' . $object->id;
