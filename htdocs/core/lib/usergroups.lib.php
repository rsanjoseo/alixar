...
function user_prepare_head($object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Users/card.php?id=' . $object->id;
    ...
    if ((!empty($conf->ldap->enabled) && !empty($conf->global->LDAP_SYNCHRO_ACTIVE))
        ...
        $langs->load("ldap");
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Users/ldap.php?id=' . $object->id;
    ...
    if ($canreadperms) {
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Users/perms.php?id=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Users/param_ihm.php?id=' . $object->id;
    ...
    if (!empty($conf->agenda->enabled)) {
        ...
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Users/agenda_extsites.php?id=' . $object->id;
    ...
    if (!empty($conf->clicktodial->enabled)) {
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Users/clicktodial.php?id=' . $object->id;
    ...
    if ($user->socid == 0 && !empty($conf->notification->enabled)) {
        ...
        $langs->load("mails");
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Users/notify/card.php?id=' . $object->id;
    ...
    if ((!empty($conf->salaries->enabled) && !empty($user->rights->salaries->read))
        ...
        // Bank
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Users/bank.php?id=' . $object->id;
    ...
    if (empty($user->socid)) {
        ...
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Users/note.php?id=' . $object->id;
        ...
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Users/document.php?userid=' . $object->id;
        ...
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Users/info.php?id=' . $object->id;
...
function group_prepare_head($object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Users/group/card.php?id=' . $object->id;
    ...
    if ((!empty($conf->ldap->enabled) && !empty($conf->global->LDAP_SYNCHRO_ACTIVE))
        && (empty($conf->global->MAIN_DISABLE_LDAP_TAB) || !empty($user->admin))) {
        $langs->load("ldap");
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Users/group/ldap.php?id=' . $object->id;
        $head[$h][1] = $langs->trans("LDAPCard");
        $head[$h][2] = 'ldap';
        $h++;
    }
    ...
    if ($canreadperms) {
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Users/group/perms.php?id=' . $object->id;
...
function user_admin_prepare_head()
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Users/admin/user_extrafields.php';
    $head[$h][1] = $langs->trans("ExtraFields") . " (" . $langs->trans("Users") . ")";
    $head[$h][2] = 'attributes';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Users/admin/group_extrafields.php';
...
function showSkins($fuser, $edit = 0, $foruserprofile = false)
{
    ...
    if ($foruserprofile) {
        ...
        if ($edit) {
            print ajax_constantonoff('THEME_TOPMENU_DISABLE_IMAGE', [], null, 0, 0, 1);
    ...
    if ($foruserprofile) {
        ...
        if ($edit) {
            print $formother->selectColor(colorArrayToHex(colorStringToArray((!empty($conf->global->THEME_ELDY_BACKBODY) ? $conf->global->THEME_ELDY_BACKBODY : ''), []), ''), 'THEME_ELDY_BACKBODY', '', 1, '', '', 'colorbackbody') . ' ';
        } else {
            $color = colorArrayToHex(colorStringToArray($conf->global->THEME_ELDY_BACKBODY, []), '');
            if ($color) {
    ...
    if ($foruserprofile) {
        ...
        print '<td colspan="' . ($colspan - 1) . '">';
        if ($edit) {
            print $formother->selectColor(colorArrayToHex(colorStringToArray((!empty($conf->global->THEME_ELDY_TOPMENU_BACK1) ? $conf->global->THEME_ELDY_TOPMENU_BACK1 : ''), []), ''), 'THEME_ELDY_TOPMENU_BACK1', '', 1, '', '', 'colorbackhmenu1') . ' ';
        } else {
            $color = colorArrayToHex(colorStringToArray($conf->global->THEME_ELDY_TOPMENU_BACK1, []), '');
            if ($color) {
                print '<input type="text" class="colorthumb" disabled="disabled" style="padding: 1px; margin-top: 0; margin-bottom: 0; background-color: #' . $color . '" value="' . $color . '">';
            } else {
                print $langs->trans("Default");
    ...
    if ($foruserprofile) {
        ...
        print '<td colspan="' . ($colspan - 1) . '">';
        if ($edit) {
            print $formother->selectColor(colorArrayToHex(colorStringToArray((!empty($conf->global->THEME_ELDY_VERMENU_BACK1) ? $conf->global->THEME_ELDY_VERMENU_BACK1 : ''), []), ''), 'THEME_ELDY_VERMENU_BACK1', '', 1, '', '', 'colorbackvmenu1') . ' ';
        } else {
            $color = colorArrayToHex(colorStringToArray($conf->global->THEME_ELDY_VERMENU_BACK1, []), '');
            if ($color) {
                print '<input type="text" class="colorthumb" disabled="disabled" style="padding: 1px; margin-top: 0; margin-bottom: 0; background-color: #' . $color . '" value="' . $color . '">';
            } else {
                print $langs->trans("Default");
    ...
    if ($foruserprofile) {
        ...
        print '<td colspan="' . ($colspan - 1) . '">';
        if ($edit) {
            print $formother->selectColor(colorArrayToHex(colorStringToArray((!empty($conf->global->THEME_ELDY_TEXTTITLENOTAB) ? $conf->global->THEME_ELDY_TEXTTITLENOTAB : ''), []), ''), 'THEME_ELDY_TEXTTITLENOTAB', '', 1, '', '', 'colortexttitlenotab') . ' ';
        } else {
    ...
    if ($foruserprofile) {
        ...
        print '<td colspan="' . ($colspan - 1) . '">';
        if ($edit) {
            print $formother->selectColor(colorArrayToHex(colorStringToArray((!empty($conf->global->THEME_ELDY_BACKTITLE1) ? $conf->global->THEME_ELDY_BACKTITLE1 : ''), []), ''), 'THEME_ELDY_BACKTITLE1', '', 1, '', '', 'colorbacktitle1') . ' ';
        } else {
    ...
    if ($foruserprofile) {
        ...
        print '<td colspan="' . ($colspan - 1) . '">';
        if ($edit) {
            print $formother->selectColor(colorArrayToHex(colorStringToArray((!empty($conf->global->THEME_ELDY_TEXTTITLE) ? $conf->global->THEME_ELDY_TEXTTITLE : ''), []), ''), 'THEME_ELDY_TEXTTITLE', '', 1, '', '', 'colortexttitle') . ' ';
        } else {
    ...
    if ($foruserprofile) {
        ...
        print '<td colspan="' . ($colspan - 1) . '">';
        if ($edit) {
            print $formother->selectColor(colorArrayToHex(colorStringToArray((!empty($conf->global->THEME_ELDY_TEXTTITLELINK) ? $conf->global->THEME_ELDY_TEXTTITLELINK : ''), []), ''), 'THEME_ELDY_TEXTTITLELINK', '', 1, '', '', 'colortexttitlelink') . ' ';
        } else {
    ...
    if ($foruserprofile) {
        ...
        print '<td colspan="' . ($colspan - 1) . '">';
        if ($edit) {
            print $formother->selectColor(colorArrayToHex(colorStringToArray((!empty($conf->global->THEME_ELDY_LINEIMPAIR1) ? $conf->global->THEME_ELDY_LINEIMPAIR1 : ''), []), ''), 'THEME_ELDY_LINEIMPAIR1', '', 1, '', '', 'colorbacklinepair2') . ' ';
        } else {
            $color = colorArrayToHex(colorStringToArray($conf->global->THEME_ELDY_LINEIMPAIR1, []), '');
            if ($color) {
                print '<input type="text" class="colorthumb" disabled="disabled" style="padding: 1px; margin-top: 0; margin-bottom: 0; background-color: #' . $color . '" value="' . $color . '">';
            } else {
                print $langs->trans("Default");
    ...
    if ($foruserprofile) {
        ...
        print '<td colspan="' . ($colspan - 1) . '">';
        if ($edit) {
            print $formother->selectColor(colorArrayToHex(colorStringToArray((!empty($conf->global->THEME_ELDY_LINEPAIR1) ? $conf->global->THEME_ELDY_LINEPAIR1 : ''), []), ''), 'THEME_ELDY_LINEPAIR1', '', 1, '', '', 'colorbacklineimpair2') . ' ';
        } else {
            $color = colorArrayToHex(colorStringToArray($conf->global->THEME_ELDY_LINEPAIR1, []), '');
            if ($color) {
                print '<input type="text" class="colorthumb" disabled="disabled" style="padding: 1px; margin-top: 0; margin-bottom: 0; background-color: #' . $color . '" value="' . $color . '">';
            } else {
                print $langs->trans("Default");
    ...
    if ($foruserprofile) {
        ...
        print '<td colspan="' . ($colspan - 1) . '">';
        if ($edit) {
            print $formother->selectColor(colorArrayToHex(colorStringToArray((!empty($conf->global->THEME_ELDY_TEXTLINK) ? $conf->global->THEME_ELDY_TEXTLINK : ''), []), ''), 'THEME_ELDY_TEXTLINK', '', 1, '', '', 'colortextlink') . ' ';
        } else {
            $color = colorArrayToHex(colorStringToArray($conf->global->THEME_ELDY_TEXTLINK, []), '');
            if ($color) {
                print '<input type="text" class="colorthumb" disabled="disabled" style="padding: 1px; margin-top: 0; margin-bottom: 0; background-color: #' . $color . '" value="' . $color . '">';
            } else {
    ...
    if ($foruserprofile) {
        ...
        if ($edit) {
            if (!empty($conf->global->THEME_ELDY_USE_HOVER) && $conf->global->THEME_ELDY_USE_HOVER == '1') {
                ...
                $color = colorArrayToHex(colorStringToArray((!empty($conf->global->THEME_ELDY_USE_HOVER) ? $conf->global->THEME_ELDY_USE_HOVER : ''), []), '');
            }
    ...
    if ($foruserprofile) {
        ...
        if ($edit) {
            if (!empty($conf->global->THEME_ELDY_USE_CHECKED) && $conf->global->THEME_ELDY_USE_CHECKED == '1') {
                ...
                $color = colorArrayToHex(colorStringToArray((!empty($conf->global->THEME_ELDY_USE_CHECKED) ? $conf->global->THEME_ELDY_USE_CHECKED : ''), []), '');
            }
