...
function payment_prepare_head(Paiement $object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/paiement/card.php?id=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/paiement/info.php?id=' . $object->id;
...
function payment_supplier_prepare_head(Paiement $object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Fourn/paiement/card.php?id=' . $object->id;
    $head[$h][1] = $langs->trans("Payment");
    $head[$h][2] = 'payment';
    $h++;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Fourn/paiement/info.php?id=' . $object->id;
    $head[$h][1] = $langs->trans('Info');
    $head[$h][2] = 'info';
    $h++;
...
function showOnlinePaymentUrl($type, $ref)
{
    ...
    $langs->loadLangs(['payment', 'stripe']);
