...
function facture_prepare_head($object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/facture/card.php?facid=' . $object->id;
    ...
    if (empty($conf->global->MAIN_DISABLE_CONTACTS_TAB)) {
        ...
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/facture/contact.php?facid=' . urlencode($object->id);
    ...
    if (!empty($conf->prelevement->enabled)) {
        ...
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/facture/prelevement.php?facid=' . urlencode($object->id);
    ...
    if (empty($conf->global->MAIN_DISABLE_NOTES_TAB)) {
        ...
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/facture/note.php?facid=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/facture/document.php?facid=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/facture/info.php?facid=' . $object->id;
...
function invoice_admin_prepare_head()
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/facture/admin/facture_cust_extrafields.php';
    $head[$h][1] = $langs->trans("ExtraFieldsCustomerInvoices");
    $head[$h][2] = 'attributes';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/facture/admin/facturedet_cust_extrafields.php';
    $head[$h][1] = $langs->trans("ExtraFieldsLines");
    $head[$h][2] = 'attributeslines';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/facture/admin/facture_rec_cust_extrafields.php';
    $head[$h][1] = $langs->trans("ExtraFieldsCustomerInvoicesRec");
    $head[$h][2] = 'attributesrec';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/facture/admin/facturedet_rec_cust_extrafields.php';
...
function invoice_rec_prepare_head($object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/facture/card-rec.php?id=' . $object->id;
    ...
    if (!empty($conf->facture->enabled) && !empty($user->rights->facture->lire)) {
        ...
        if ($resql) {
            ...
            while ($i < $num) {
                $obj = $db->fetch_object($resql);
                $dataseries = [
                    [$langs->trans('InvoiceLate30Days'), $obj->nblate30]
                    , [$langs->trans('InvoiceLate15Days'), $obj->nblate15 - $obj->nblate30]
                    , [$langs->trans('InvoiceLateMinus15Days'), $obj->nblatenow - $obj->nblate15]
                    , [$langs->trans('InvoiceNotLate'), $obj->nbnotlatenow - $obj->nbnotlate15]
                    , [$langs->trans('InvoiceNotLate15Days'), $obj->nbnotlate15 - $obj->nbnotlate30]
                    , [$langs->trans('InvoiceNotLate30Days'), $obj->nbnotlate30],
                ];
                $i++;
            }
            ...
            $colorseries = [$badgeStatus8, $badgeStatus1, $badgeStatus3, $badgeStatus4, $badgeStatus11, '-' . $badgeStatus11];
...
function getCustomerInvoiceDraftTable($maxCount = 500, $socid = 0)
{
    ...
    if ($resql) {
        ...
        $result .= '<a href="' . DOL_URL_ROOT . '/Modules/Compta/facture/list.php?search_status=' . Facture::STATUS_DRAFT . '">';
...
function getDraftSupplierTable($maxCount = 500, $socid = 0)
{
    ...
    if ($resql) {
        ...
        $result .= '<a href="' . DOL_URL_ROOT . '/Modules/Fourn/facture/list.php?search_status=' . FactureFournisseur::STATUS_DRAFT . '">';
        $result .= '<span class="badge marginleftonlyshort">' . $num . '</span>';
        $result .= '</a>';
        $result .= '</th>';
        $result .= '</tr>';
...
function getCustomerInvoiceUnpaidOpenTable($maxCount = 500, $socid = 0)
{
    ...
    if (!empty($conf->facture->enabled) && !empty($user->rights->facture->lire)) {
        ...
        if ($resql) {
            ...
            print '<a href="' . DOL_URL_ROOT . '/Modules/Compta/facture/list.php?search_status=' . Facture::STATUS_VALIDATED . '">';
...
function getPurchaseInvoiceUnpaidOpenTable($maxCount = 500, $socid = 0)
{
    ...
    if ((!empty($conf->fournisseur->enabled) && empty($conf->global->MAIN_USE_NEW_SUPPLIERMOD) && $user->rights->fournisseur->facture->lire) || (!empty($conf->supplier_invoice->enabled) && $user->rights->supplier_invoice->lire)) {
        ...
        if ($resql) {
            ...
            print '<a href="' . DOL_URL_ROOT . '/Modules/Fourn/facture/list.php?search_status=' . FactureFournisseur::STATUS_VALIDATED . '">';
            print '<span class="badge">' . $num . '</span>';
            print '</a>';
            print '</th>';
