...
function cronadmin_prepare_head()
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Cron/admin/cron.php';
    $head[$h][1] = $langs->trans("Miscellaneous");
    $head[$h][2] = 'setup';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Cron/list.php?mode=modulesetup';
...
function cron_prepare_head(Cronjob $object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Cron/card.php?id=' . $object->id;
    $head[$h][1] = $langs->trans("CronTask");
    $head[$h][2] = 'card';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Cron/info.php?id=' . $object->id;
