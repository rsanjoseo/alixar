...
function vat_prepare_head($object)
{
    ...
    $head[$tab][0] = DOL_URL_ROOT . '/Modules/Compta/tva/card.php?id=' . $object->id;
    ...
    $head[$tab][0] = DOL_URL_ROOT . '/Modules/Compta/tva/document.php?id=' . $object->id;
    ...
    $head[$tab][0] = DOL_URL_ROOT . '/Modules/Compta/tva/info.php?id=' . $object->id;
