...
function fiscalyear_prepare_head(Fiscalyear $object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Accountancy/admin/fiscalyear_card.php?id=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Accountancy/admin/fiscalyear_info.php?id=' . $object->id;
