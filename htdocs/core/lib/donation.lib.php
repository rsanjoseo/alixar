...
function donation_admin_prepare_head()
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Don/admin/donation.php';
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Don/admin/donation_extrafields.php';
...
function donation_prepare_head($object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Don/card.php?id=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Don/document.php?id=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Don/note.php?id=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Don/info.php?id=' . $object->id;
