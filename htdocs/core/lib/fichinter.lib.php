...
function fichinter_prepare_head($object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Fichinter/card.php?id=' . $object->id;
    ...
    if (empty($conf->global->MAIN_DISABLE_CONTACTS_TAB)) {
        ...
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Fichinter/contact.php?id=' . $object->id;
    ...
    if (empty($conf->global->MAIN_DISABLE_NOTES_TAB)) {
        ...
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Fichinter/note.php?id=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Fichinter/document.php?id=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Fichinter/info.php?id=' . $object->id;
...
function fichinter_admin_prepare_head()
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Fichinter/admin/fichinter_extrafields.php';
    $head[$h][1] = $langs->trans("ExtraFields");
    $head[$h][2] = 'attributes';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Fichinter/admin/fichinterdet_extrafields.php';
...
function fichinter_rec_prepare_head($object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Fichinter/card-rec.php?id=' . $object->id;
