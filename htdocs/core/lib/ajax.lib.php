 ...
 */
function ajax_combobox($htmlname, $events = [], $minLengthToAutocomplete = 0, $forcefocus = 0, $widthTypeOfAutocomplete = 'resolve', $idforemptyvalue = '-1')
{
    global $conf;
 ...
 * @return    string
 */
function ajax_constantonoff($code, $input = [], $entity = null, $revertonoff = 0, $strict = 0, $forcereload = 0, $marginleftonlyshort = 2, $forcenoajax = 0, $setzeroinsteadofdel = 0, $suffix = '', $mode = '')
{
 ...
 */
function ajax_object_onoff($object, $code, $field, $text_on, $text_off, $input = [], $morecss = '')
{
    global $langs;
