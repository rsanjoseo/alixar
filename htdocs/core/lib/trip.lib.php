...
function trip_prepare_head(Deplacement $object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/deplacement/card.php?id=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/deplacement/document.php?id=' . $object->id;
    $head[$h][1] = $langs->trans("Documents");
    $head[$h][2] = 'documents';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/deplacement/info.php?id=' . $object->id;
