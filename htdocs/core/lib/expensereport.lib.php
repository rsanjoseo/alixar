...
function expensereport_prepare_head($object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/ExpenseReports/card.php?id=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/ExpenseReports/document.php?id=' . $object->id;
    ...
    if (empty($conf->global->MAIN_DISABLE_NOTES_TAB)) {
        ...
        $head[$h][0] = DOL_URL_ROOT . '/Modules/ExpenseReports/note.php?id=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/ExpenseReports/info.php?id=' . $object->id;
...
function payment_expensereport_prepare_head(PaymentExpenseReport $object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/ExpenseReports/payment/card.php?id=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/ExpenseReports/payment/info.php?id=' . $object->id;
    $head[$h][1] = $langs->trans("Info");
    $head[$h][2] = 'info';
    $h++;
