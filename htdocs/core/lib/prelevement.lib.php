...
function prelevement_prepare_head(BonPrelevement $object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/prelevement/card.php?id=' . $object->id;
    $head[$h][1] = $langs->trans($titleoftab);
    $head[$h][2] = 'prelevement';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/prelevement/factures.php?id=' . $object->id;
    $head[$h][1] = $langs->trans("Bills");
    $head[$h][2] = 'invoices';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/prelevement/fiche-rejet.php?id=' . $object->id;
    $head[$h][1] = $langs->trans("Rejects");
    $head[$h][2] = 'rejects';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/prelevement/fiche-stat.php?id=' . $object->id;
