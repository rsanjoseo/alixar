...
function stock_prepare_head($object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Products/stock/card.php?id=' . $object->id;
    $head[$h][1] = $langs->trans("Warehouse");
    $head[$h][2] = 'card';
    $h++;

    if (!empty($user->rights->stock->mouvement->lire)) {
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Products/stock/movement_list.php?id=' . $object->id;
    ...
    /*
    $head[$h][0] = DOL_URL_ROOT.'/Modules/Products/stock/fiche-valo.php?id='.$object->id;
    ...
    */
    ...
    if (! empty($conf->global->STOCK_USE_WAREHOUSE_BY_USER))
    {
        ...
        $head[$h][0] = DOL_URL_ROOT.'/Modules/Products/stock/user.php?id='.$object->id;
    ...
    */
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Products/stock/info.php?id=' . $object->id;
...
function stock_admin_prepare_head()
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Products/admin/stock_extrafields.php';
