...
print top_htmlhead('', $titleofloginpage, 0, 0, $arrayofjs, [], 0, $disablenofollow);
...
<body class="body bodylogin"
      style="background-image: url('<?php echo dol_escape_htmltag($conf->global->ADD_UNSPLASH_LOGIN_BACKGROUND); ?>'); background-repeat: no-repeat; background-position: center center; background-attachment: fixed; background-size: cover; background-color: #ffffff;">
<?php
} else {
?>
...
<div class="login_center center"<?php print empty($conf->global->MAIN_LOGIN_BACKGROUND) ? ' style="background-size: cover; background-position: center center; background-attachment: fixed; background-repeat: no-repeat; background-image: linear-gradient(rgb(' . $colorbackhmenu1 . ',0.3), rgb(240,240,240));"' : '' ?>>
	...
	<a class="inline-block valignmiddle" href="<?php echo $php_self; ?>" tabindex="4"
       data-role="button"><?php echo $captcha_refresh; ?></a>
        ...
        <?php if ($main_home) {
            ?>
            <div class="center login_main_home paddingtopbottom <?php echo empty($conf->global->MAIN_LOGIN_BACKGROUND) ? '' : ' backgroundsemitransparent boxshadow'; ?>"
                 style="max-width: 70%">
                <?php echo $main_home; ?>
            </div><br>
            <?php
