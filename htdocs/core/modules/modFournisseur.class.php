...
class modFournisseur extends DolibarrModules
{
    ...
    public function __construct()
    {
        ...
        $this->requiredby = ["modSupplierProposal"];
        $this->langfiles = ['bills', 'companies', 'suppliers', 'orders', 'sendings'];

        // Config pages
        $this->config_page_url = ["supplier_order.php"];
        ...
        */
        ...
        // Boxes
        $this->boxes = [
            0 => ['file' => 'box_graph_invoices_supplier_permonth.php', 'enabledbydefaulton' => 'Home'],
            1 => ['file' => 'box_graph_orders_supplier_permonth.php', 'enabledbydefaulton' => 'Home'],
            2 => ['file' => 'box_fournisseurs.php', 'enabledbydefaulton' => 'Home'],
            3 => ['file' => 'box_factures_fourn_imp.php', 'enabledbydefaulton' => 'Home'],
            4 => ['file' => 'box_factures_fourn.php', 'enabledbydefaulton' => 'Home'],
            5 => ['file' => 'box_supplier_orders.php', 'enabledbydefaulton' => 'Home'],
            6 => ['file' => 'box_supplier_orders_awaiting_reception.php', 'enabledbydefaulton' => 'Home'],
        ];
        ...
        $this->export_permission[$r] = [["fournisseur", "facture", "export"]];
        ...
        $this->export_dependencies_array[$r] = ['invoice_line' => 'fd.rowid', 'product' => 'fd.rowid']; // To add unique key if we ask a field of a child to avoid the DISTINCT to discard them
        ...
        $this->export_dependencies_array[$r] = ['payment' => 'p.rowid']; // To add unique key if we ask a field of a child to avoid the DISTINCT to discard them
        // Add extra fields object
        $keyforselect = 'facture_fourn';
        $keyforelement = 'invoice';
        $keyforaliasextra = 'extra';
        ...
        $this->export_permission[$r] = [["fournisseur", "commande", "export"]];
        $this->export_fields_array[$r] = [
            's.rowid' => "IdCompany", 's.nom' => 'CompanyName', 'ps.nom' => 'ParentCompany', 's.address' => 'Address', 's.zip' => 'Zip', 's.town' => 'Town', 'c.code' => 'CountryCode', 's.phone' => 'Phone',
        ...
        $this->export_dependencies_array[$r] = ['order_line' => 'fd.rowid', 'product' => 'fd.rowid']; // To add unique key if we ask a field of a child to avoid the DISTINCT to discard them
        // Add extra fields object
        ...
        $this->import_convertvalue_array[$r] = [
            ...
            'f.fk_soc' => ['rule' => 'fetchidfromref', 'file' => '/Modules/Societes/class/societe.class.php', 'class' => 'Societe', 'method' => 'fetch', 'element' => 'ThirdParty'],
            'f.fk_account' => ['rule' => 'fetchidfromref', 'file' => '/Modules/Compta/bank/class/account.class.php', 'class' => 'Account', 'method' => 'fetch', 'element' => 'bank_account'],
        ];
        ...
        $this->import_convertvalue_array[$r] = [
            'fd.fk_facture_fourn' => ['rule' => 'fetchidfromref', 'file' => '/Modules/Fourn/class/fournisseur.facture.class.php', 'class' => 'FactureFournisseur', 'method' => 'fetch'],
        ];
        ...
        $this->import_convertvalue_array[$r] = [
            'cd.fk_commande' => [
                'rule' => 'fetchidfromref',
                'file' => '/Modules/Fourn/class/fournisseur.commande.class.php',
