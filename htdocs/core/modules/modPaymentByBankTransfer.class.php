...
class modPaymentByBankTransfer extends DolibarrModules
{
    ...
    public function __construct()
    {
        ...
        $this->dirs = ["/paymentbybanktransfer/temp", "/paymentbybanktransfer/receipts"];

        // Dependencies
        $this->hidden = false; // A condition to hide module
        $this->depends = ["modFournisseur", "modBanque"]; // List of module class names as string that must be enabled if this module is enabled
        ...
        // Config pages
        $this->config_page_url = ["paymentbybanktransfer.php"];
