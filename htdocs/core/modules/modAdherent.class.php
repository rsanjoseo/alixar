...
class modAdherent extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        // Config pages
        $this->config_page_url = ["member.php@adherents"];
        ...
        $this->conflictwith = ['modMailmanSpip']; // List of module class names as string this module is in conflict with
        $this->langfiles = ["members", "companies"];
        ...
        //-------
        $this->boxes = [
            0 => ['file' => 'box_members.php', 'enabledbydefaulton' => 'Home'],
            2 => ['file' => 'box_birthdays_members.php', 'enabledbydefaulton' => 'Home'],
            3 => ['file' => 'box_members_last_modified.php', 'enabledbydefaulton' => 'membersindex'],
            4 => ['file' => 'box_members_last_subscriptions.php', 'enabledbydefaulton' => 'membersindex'],
            5 => ['file' => 'box_members_subscriptions_by_year.php', 'enabledbydefaulton' => 'membersindex'],
            6 => ['file' => 'box_members_by_type.php', 'enabledbydefaulton' => 'membersindex'],
        ];
        ...
        $this->export_permission[$r] = [["adherent", "export"]];
        ...
        $this->import_tables_array[$r] = ['a' => MAIN_DB_PREFIX . 'adherent', 'extra' => MAIN_DB_PREFIX . 'adherent_extrafields'];
        $this->import_tables_creator_array[$r] = ['a' => 'fk_user_author']; // Fields to store import user id
