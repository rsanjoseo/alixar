...
class modProductBatch extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->config_page_url = ["product_lot.php@product"];

        // Dependencies
        $this->hidden = false; // A condition to hide module
        $this->depends = ["modProduct", "modStock", "modExpedition", "modFournisseur"]; // List of module class names as string that must be enabled if this module is enabled
