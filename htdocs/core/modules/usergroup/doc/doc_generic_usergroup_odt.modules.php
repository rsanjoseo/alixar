...
class doc_generic_usergroup_odt extends ModelePDFUserGroup
{
    ...
    public function write_file($object, $outputlangs, $srctemplatepath, $hidedetails = 0, $hidedesc = 0, $hideref = 0)
    {
        ...
        // Load translation files required by the page
        $outputlangs->loadLangs(["main", "companies", "bills", "dict"]);
        ...
        if ($conf->user->dir_output) {
            ...
            if (file_exists($dir)) {
                ...
                try {
                    ...
                    if ($foundtagforlines) {
                        foreach ($object->members as $u) {
                            ...
                            $parameters = ['odfHandler' => &$odfHandler, 'file' => $file, 'object' => $object, 'outputlangs' => $outputlangs, 'substitutionarray' => &$tmparray, 'line' => $u];
                ...
                $parameters = ['odfHandler' => &$odfHandler, 'file' => $file, 'object' => $object, 'outputlangs' => $outputlangs];
