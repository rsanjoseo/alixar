...
class modImport extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->dirs = ["/import/temp"];

        // Config pages
        $this->config_page_url = ["import.php"];
        ...
        $this->phpmin = [5, 6]; // Minimum version of PHP required by module - Need auto_detect_line_endings php option to solve MAC pbs.
        $this->phpmax = [];
