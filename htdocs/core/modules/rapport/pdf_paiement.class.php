...
class pdf_paiement
{
    ...
    public function __construct($db)
    {
        ...
        $langs->loadLangs(["bills", "compta", "main"]);
    ...
    public function write_file($_dir, $month, $year, $outputlangs)
    {
        ...
        $parameters = ['file' => $file, 'outputlangs' => $outputlangs];
        global $action;
        ...
        for ($j = 0; $j < $numlines; $j++) {
            ...
            if ($oldprowid <> $lines[$j][7]) {
                if ($yp > $this->tab_height - 15) {
                    ...
                    $pdf->line($this->marge_gauche, $this->tab_top + 10 + $yp, $this->page_largeur - $this->marge_droite, $this->tab_top + 10 + $yp, ['dash' => 1]);
