...
class printing_printipp extends PrintingDriver
{
    ...
    public function __construct($db)
    {
        ...
        $this->conf[] = ['varname' => 'PRINTIPP_HOST', 'required' => 1, 'example' => 'localhost', 'type' => 'text'];
        $this->conf[] = ['varname' => 'PRINTIPP_PORT', 'required' => 1, 'example' => '631', 'type' => 'text'];
        $this->conf[] = ['varname' => 'PRINTIPP_USER', 'required' => 0, 'example' => '', 'type' => 'text', 'moreattributes' => 'autocomplete="off"'];
        $this->conf[] = ['varname' => 'PRINTIPP_PASSWORD', 'required' => 0, 'example' => '', 'type' => 'password', 'moreattributes' => 'autocomplete="off"'];
