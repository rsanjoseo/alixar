...
class modTakePos extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->config_page_url = ["setup.php@takepos"];

        // Dependencies
        $this->hidden = false; // A condition to hide module
        $this->depends = ['always1' => "modBanque", 'always2' => "modFacture", 'always3' => "modProduct", 'always4' => 'modCategorie', 'FR1' => 'modBlockedLog']; // List of module class names as string that must be enabled if this module is enabled
        ...
        $this->langfiles = ["cashdesk"];
        $this->phpmin = [5, 6]; // Minimum version of PHP required by module
        $this->need_dolibarr_version = [4, 0]; // Minimum version of Dolibarr required by module
        $this->warnings_activation = ['FR' => 'WarningNoteModulePOSForFrenchLaw']; // Warning to show when we activate module. array('always'='text') or array('FR'='text')
