...
class modDataPolicy extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->langfiles = ["datapolicy@datapolicy"];
        $this->phpmin = [5, 3]; // Minimum version of PHP required by module
