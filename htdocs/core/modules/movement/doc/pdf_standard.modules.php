...
class pdf_standard extends ModelePDFMovement
{
    ...
    public function write_file($object, $outputlangs, $srctemplatepath, $hidedetails = 0, $hidedesc = 0, $hideref = 0)
    {
        ...
        // Load traductions files required by page
        $outputlangs->loadLangs(["main", "dict", "companies", "bills", "stocks", "orders", "deliveries"]);
        ...
        if ($conf->stock->dir_output) {
            ...
            if (file_exists($dir)) {
                ...
                if ($resql) {
                    ...
                    $pdf->SetLineStyle(['dash' => '0', 'color' => [220, 26, 26]]);
    ...
    protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $titlekey = "")
    {
        ...
        // Load traductions files required by page
        $outputlangs->loadLangs(["main", "propal", "companies", "bills", "orders", "stocks"]);
