...
class modHoliday extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->dirs = ["/Modules/Holiday/temp"];
        $r = 0;

        // Config pages
        $this->config_page_url = ["holiday.php"];
        ...
        $this->export_permission[$r] = [["holiday", "readall"]];
        ...
        $this->export_alias_array[$r] = ['d.rowid' => "idholiday"];
        $this->export_special_array[$r] = ['none.num_open_days' => 'getNumOpenDays'];
