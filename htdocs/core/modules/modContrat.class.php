...
class modContrat extends DolibarrModules
{
    ...
    public function __construct()
    {
        ...
        // Boxes
        $this->boxes = [
            0 => ['file' => 'box_contracts.php', 'enabledbydefaulton' => 'Home'],
            1 => ['file' => 'box_services_expired.php', 'enabledbydefaulton' => 'Home'],
        ];
        ...
        $this->export_permission[$r] = [["contrat", "export"]];
        $this->export_fields_array[$r] = [
            's.rowid' => "IdCompany", 's.nom' => 'CompanyName', 's.address' => 'Address', 's.zip' => 'Zip', 's.town' => 'Town', 'c.code' => 'CountryCode',
        ...
        $this->export_entities_array[$r] = [
            's.rowid' => "company", 's.nom' => 'company', 's.address' => 'company', 's.zip' => 'company',
        ...
        $this->export_TypeFields_array[$r] = [
            's.rowid' => "List:societe:nom", 's.nom' => 'Text', 's.address' => 'Text', 's.zip' => 'Text', 's.town' => 'Text', 'c.code' => 'Text',
