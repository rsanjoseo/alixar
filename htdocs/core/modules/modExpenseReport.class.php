...
class modExpenseReport extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->dirs = ["/Modules/ExpenseReports/temp"];
        $r = 0;
        ...
        $this->need_dolibarr_version = [3, 7]; // Minimum version of Dolibarr required by module
        ...
        $this->export_permission[$r] = [["expensereport", "export"]];
        ...
        $this->export_alias_array[$r] = ['d.rowid' => "idtrip", 'd.type' => "type", 'd.note_private' => 'note_private', 'd.note_public' => 'note_public', 'u.lastname' => 'name', 'u.firstname' => 'firstname', 'u.login' => 'login'];
        $this->export_dependencies_array[$r] = ['expensereport_line' => 'ed.rowid', 'type_fees' => 'tf.rowid']; // To add unique key if we ask a field of a child to avoid the DISTINCT to discard them
