...
class modSalaries extends DolibarrModules
{
    ...
    public function __construct()
    {
        ...
        $this->dirs = ["/salaries/temp"];

        // Config pages
        $this->config_page_url = ['salaries.php@salaries'];
        ...
        $this->export_permission[$r] = [["salaries", "export"]];
        $this->export_fields_array[$r] = ['u.firstname' => "Firstname", 'u.lastname' => "Lastname", 'u.login' => "Login", 'u.salary' => 'CurrentSalary', 'p.datep' => 'DatePayment', 'p.datesp' => 'DateStartPeriod', 'p.dateep' => 'DateEndPeriod', 'p.amount' => 'AmountPayment', 'p.num_payment' => 'Numero', 'p.label' => 'Label', 'p.note' => 'Note'];
        $this->export_TypeFields_array[$r] = ['u.firstname' => "Text", 'u.lastname' => "Text", 'u.login' => 'Text', 'u.salary' => "Numeric", 'p.datep' => 'Date', 'p.datesp' => 'Date', 'p.dateep' => 'Date', 'p.amount' => 'Numeric', 'p.num_payment' => 'Numeric', 'p.label' => 'Text'];
        $this->export_entities_array[$r] = ['u.firstname' => 'user', 'u.lastname' => 'user', 'u.login' => 'user', 'u.salary' => 'user', 'p.datep' => 'payment', 'p.datesp' => 'payment', 'p.dateep' => 'payment', 'p.amount' => 'payment', 'p.label' => 'payment', 'p.note' => 'payment', 'p.num_payment' => 'payment'];
