...
class modSupplierProposal extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->config_page_url = ["supplier_proposal.php"];

        // Dependencies
        $this->hidden = false; // A condition to hide module
        $this->depends = ['modFournisseur']; // List of module class names as string that must be enabled if this module is enabled
        ...
        $this->langfiles = ["supplier_proposal"];
