...
class modTicket extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        // Example: this->dirs = array("/Modules/Ticket/temp");
        $this->dirs = [];
        ...
        // Example:
        $this->const = [
            1 => ['TICKET_ENABLE_PUBLIC_INTERFACE', 'chaine', '0', 'Enable ticket public interface', 0],
            2 => ['TICKET_ADDON', 'chaine', 'mod_ticket_simple', 'Ticket ref module', 0],
            3 => ['TICKET_ADDON_PDF_ODT_PATH', 'chaine', 'DOL_DATA_ROOT/doctemplates/tickets', 'Ticket templates ODT/ODS directory for templates', 0],
        ];
        ...
        $this->dictionaries = [
            ...
            'tabsqlsort' => ["pos ASC", "pos ASC", "pos ASC", "pos ASC"],
            'tabfield' => ["code,label,pos,use_default", "code,label,pos,use_default", "code,label,pos,use_default,public,fk_parent", "code,label,pos,use_default"],
        ...
        $this->boxes = [
            0 => ['file' => 'box_last_ticket.php', 'enabledbydefaulton' => 'Home'],
            1 => ['file' => 'box_last_modified_ticket.php', 'enabledbydefaulton' => 'Home'],
            2 => ['file' => 'box_ticket_by_severity.php', 'enabledbydefaulton' => 'ticketindex'],
            3 => ['file' => 'box_nb_ticket_last_x_days.php', 'enabledbydefaulton' => 'ticketindex'],
            4 => ['file' => 'box_nb_tickets_type.php', 'enabledbydefaulton' => 'ticketindex'],
            5 => ['file' => 'box_new_vs_close_ticket.php', 'enabledbydefaulton' => 'ticketindex'],
        ]; // Boxes list
        ...
        */
        ...
        // Main menu entries
        $this->menus = []; // List of menus to add
        $r = 0;
    ...
    public function init($options = '')
    {
        ...
        $sql = [
            ["sql" => "insert into llx_c_type_contact(rowid, element, source, code, libelle, active ) values (110120, 'ticket',  'internal', 'SUPPORTTEC', 'Utilisateur assigné au ticket', 1);", "ignoreerror" => 1],
