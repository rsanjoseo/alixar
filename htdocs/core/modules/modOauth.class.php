...
class modOauth extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        // Config pages
        $this->config_page_url = ["oauth.php"];
        ...
        $this->phpmin = [5, 6]; // Minimum version of PHP required by module                    // Minimum version of PHP required by module
        $this->need_dolibarr_version = [3, 7, -2]; // Minimum version of Dolibarr required by module
        $this->conflictwith = [];
        $this->langfiles = ["oauth"];
        ...
        //                        'position'=>300,
        //                        'enabled'=>'$this->conf->oauth->enabled && preg_match(\'/^(admintools|all)/\',$leftmenu)',
