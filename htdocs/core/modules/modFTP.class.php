...
class modFTP extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->config_page_url = ['ftpclient.php@ftp'];
        ...
        // Constants
        $this->const = [
            1 => ['FTP_CONNECT_WITH_SSL', 'chaine', '0', 'Use FTPS for FTP module', 1, 'current', 1],
            2 => ['FTP_CONNECT_WITH_SFTP', 'chaine', '0', 'Use SFTP for FTP module', 1, 'current', 1],
        ]; // List of parameters
