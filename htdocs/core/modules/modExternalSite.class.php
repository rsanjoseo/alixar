...
class modExternalSite extends DolibarrModules
{
    ...
    public function __construct()
    {
        ...
        $this->langfiles = ["externalsite"];

        // Data directories to create when module is enabled
        $this->dirs = [];

        // Config pages. Put here list of php page names stored in admmin directory used to setup module
        $this->config_page_url = ["index.php@externalsite"];
        ...
        // );
        $this->const = [0 => ['EXTERNALSITE_LABEL', 'chaine', 'ExternalSite', 'To declare label to use into external site menu entry', 0]];
        ...
        $this->menu[$r] = [
            ...
            'position' => 100,
            'perms' => '',
            'enabled' => '$this->conf->externalsite->enabled',
            'target' => '',
            'user' => 0,
        ];
        $r++;
