...
class doc_generic_project_odt extends ModelePDFProjects
{
    ...
    public function __construct($db)
    {
        ...
        $langs->loadLangs(["companies", "main"]);
    ...
    public function info($langs)
    {
        ...
        $langs->loadLangs(["companies", "errors"]);
    ...
    public function write_file($object, $outputlangs, $srctemplatepath)
    {
        ...
        // Load translation files required by the page
        $outputlangs->loadLangs(["main", "dict", "companies", "projects"]);
            ...
            if (file_exists($dir)) {
                ...
                $listofreferent = [
                    ...
                    'chargesociales' => [
                        ...
                        'urlnew' => DOL_URL_ROOT . '/Modules/Compta/sociales/card.php?action=create&projectid=' . $object->id,
