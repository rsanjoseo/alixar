...
class modBanque extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->dirs = ["/banque/temp"];

        // Config pages
        //-------------
        $this->config_page_url = ["bank.php"];

        // Dependancies
        $this->depends = [];
        $this->requiredby = ["modComptabilite", "modAccounting", "modPrelevement"];
        $this->conflictwith = [];
        $this->langfiles = ["banks", "compta", "bills", "companies", "accounting"];

        // Constants
        $this->const = [];

        // Boxes
        $this->boxes = [0 => ['file' => 'box_comptes.php', 'enabledbydefaulton' => 'Home']];
        ...
        $this->export_permission[$r] = [["banque", "export"]];
        ...
        $this->export_TypeFields_array[$r] = ['ba.ref' => 'Text', 'ba.label' => 'Text', 'b.datev' => 'Date', 'b.dateo' => 'Date', 'b.label' => 'Text', 'b.num_chq' => 'Text', 'b.fk_bordereau' => 'Text', '-b.amount' => 'Numeric', 'b.amount' => 'Numeric', 'b.num_releve' => 'Text', 'b.rappro' => 'Boolean', 'b.datec' => "Date", "bu.url_id" => "Text", "s.nom" => "Text", "s.code_compta" => "Text", "s.code_compta_fournisseur" => "Text"];
        ...
        $this->export_permission[$r] = [["banque", "export"]];
        $this->export_fields_array[$r] = [
            "bch.rowid" => "DepositId", "bch.ref" => "Numero", "bch.ref_ext" => "RefExt", 'ba.ref' => 'AccountRef', 'ba.label' => 'AccountLabel', 'b.datev' => 'DateValue', 'b.num_chq' => 'ChequeOrTransferNumber', 'b.amount' => 'Credit', 'b.num_releve' => 'AccountStatement', 'b.datec' => "DateCreation",
        ...
        $this->export_TypeFields_array[$r] = [
            'ba.ref' => 'Text', 'ba.label' => 'Text', 'b.datev' => 'Date', 'b.num_chq' => 'Text', 'b.amount' => 'Numeric', 'b.num_releve' => 'Text', 'b.datec' => "Date",
        ...
        $this->export_entities_array[$r] = [
            'ba.ref' => 'account', 'ba.label' => 'account', 'b.datev' => 'account', 'b.num_chq' => 'account', 'b.amount' => 'account', 'b.num_releve' => 'account', 'b.datec' => "account",
            "bu.url_id" => "company", "s.nom" => "company", "s.code_compta" => "company", "s.code_compta_fournisseur" => "company", "f.ref" => "invoice",
        ];
        $this->export_special_array[$r] = ['b.amount' => 'NULLIFNEG'];
