...
class modMargin extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->dirs = ['/margin/temp'];

        // Config pages. Put here list of php page names stored in admmin directory used to setup module.
        $this->config_page_url = ["margin.php@margin"];

        // Dependencies
        $this->hidden = false; // A condition to hide module
        $this->depends = ["modPropale", "modProduct"]; // List of module class names as string that must be enabled if this module is enabled
        ...
        $this->need_dolibarr_version = [3, 2]; // Minimum version of Dolibarr required by module
        $this->langfiles = ["margins"];
        ...
        // );
        $this->const = [0 => ['MARGIN_TYPE', 'chaine', 'costprice', 'Rule for margin calculation by default', 0, 'current', 0]]; // List of particular constants to add when module is enabled
        ...
        $this->menu[$r] = [
            ...
            'position' => 100,
            'enabled' => '$this->conf->margin->enabled', // Define condition to show or hide menu entry. Use '$this->conf->monmodule->enabled' if entry must be visible if module is enabled.
