...
class modBom extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->module_parts = [
            ...
            'css' => array('/Modules/Bom/css/bom.css.php'),	// Set this to relative path of css file if module has its own css file
             'js' => array('/Modules/Bom/js/bom.js.php'),          // Set this to relative path of js file if module must load a js on all pages
        ...
        $this->config_page_url = ["bom.php"];

        // Dependencies
        $this->hidden = false; // A condition to hide module
        $this->depends = ['modProduct']; // List of module class names as string that must be enabled if this module is enabled. Example: array('always1'=>'modModuleToEnable1','always2'=>'modModuleToEnable2', 'FR1'=>'modModuleToEnableFR'...)
        $this->requiredby = ['modMrp']; // List of module class names as string to disable if this one is disabled. Example: array('modModuleToDisable1', ...)
        $this->conflictwith = []; // List of module class names as string this module is in conflict with. Example: array('modModuleToDisable1', ...)
        $this->langfiles = ["mrp"];
        //$this->phpmin = array(5, 6));					// Minimum version of PHP required by module
        $this->need_dolibarr_version = [9, 0]; // Minimum version of Dolibarr required by module
        ...
        // );
        $this->const = [
            1 => ['BOM_ADDON_PDF', 'chaine', 'generic_bom_odt', 'Name of PDF model of BOM', 0],
            2 => ['BOM_ADDON', 'chaine', 'mod_bom_standard', 'Name of numbering rules of BOM', 0],
            3 => ['BOM_ADDON_PDF_ODT_PATH', 'chaine', 'DOL_DATA_ROOT/doctemplates/boms', '', 0],
        ];
        ...
        */
        ...
        $this->boxes = [
            0 => ['file' => 'box_boms.php', 'note' => '', 'enabledbydefaulton' => 'Home'],
        ];
        ...
        */
        ...
        $this->import_convertvalue_array[$r] = [
            'b.fk_product' => [
                'rule' => 'fetchidfromref',
                'file' => '/Modules/Products/class/product.class.php',
                'class' => 'Product',
                'method' => 'fetch',
                'element' => 'Product',
            ],
            'b.fk_warehouse' => [
                'rule' => 'fetchidfromref',
                'file' => '/Modules/Products/stock/class/entrepot.class.php',
                'class' => 'Entrepot',
                'method' => 'fetch',
                'element' => 'Warehouse',
            ],
        ...
        $this->import_convertvalue_array[$r] = [
            'bd.fk_bom' => [
                'rule' => 'fetchidfromref',
                'file' => '/Modules/Bom/class/bom.class.php',
                'class' => 'BOM',
                'method' => 'fetch',
                'element' => 'bom',
            ],
    ...
    public function init($options = '')
    {
        ...
        $result = $this->_load_tables('/Modules/Bom/sql/');
        if ($result < 0) {
