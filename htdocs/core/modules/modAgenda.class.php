...
class modAgenda extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->dirs = ["/agenda/temp"];

        // Config pages
        $this->config_page_url = ["agenda_other.php"];
        ...
        if ($resql) {
            while ($obj = $this->db->fetch_object($resql)) {
                ...
                $this->const[] = ['MAIN_AGENDA_ACTIONAUTO_' . $obj->code, "chaine", "1", '', 0, 'current'];
            }
        } else {
        ...
        // Boxes
        //------
        $this->boxes = [0 => ['file' => 'box_actions.php', 'enabledbydefaulton' => 'Home']];
        ...
        $this->menu[$r] = [
            ...
            'titre' => 'NewAction',
            'mainmenu' => 'agenda',
            'url' => '/Modules/Comm/action/card.php?mainmenu=agenda&amp;leftmenu=agenda&amp;action=create',
            'langs' => 'commercial',
            'position' => 101,
        ...
        $this->menu[$r] = [
            ...
            'titre' => 'Calendar',
            'mainmenu' => 'agenda',
            'url' => '/Modules/Comm/action/index.php?action=default&amp;mainmenu=agenda&amp;leftmenu=agenda',
            'langs' => 'agenda',
            'position' => 140,
            'perms' => '$user->rights->agenda->myactions->read',
            'enabled' => '$this->conf->agenda->enabled',
        ...
        $this->menu[$r] = [
            ...
            'mainmenu' => 'agenda',
            'url' => '/Modules/Comm/action/index.php?action=default&amp;mainmenu=agenda&amp;leftmenu=agenda&amp;status=todo&amp;filter=mine',
            'langs' => 'agenda',
            'position' => 141,
            'perms' => '$user->rights->agenda->myactions->read',
            'enabled' => '$this->conf->agenda->enabled',
        ...
        $this->menu[$r] = [
            ...
            'mainmenu' => 'agenda',
            'url' => '/Modules/Comm/action/index.php?action=default&amp;mainmenu=agenda&amp;leftmenu=agenda&amp;status=done&amp;filter=mine',
            'langs' => 'agenda',
            'position' => 142,
            'perms' => '$user->rights->agenda->myactions->read',
            'enabled' => '$this->conf->agenda->enabled',
        ...
        $this->menu[$r] = [
            ...
            'mainmenu' => 'agenda',
            'url' => '/Modules/Comm/action/index.php?action=default&amp;mainmenu=agenda&amp;leftmenu=agenda&amp;status=todo&amp;filtert=-1',
            'langs' => 'agenda',
            'position' => 143,
        ...
        $this->menu[$r] = [
            ...
            'mainmenu' => 'agenda',
            'url' => '/Modules/Comm/action/index.php?action=default&amp;mainmenu=agenda&amp;leftmenu=agenda&amp;status=done&amp;filtert=-1',
            'langs' => 'agenda',
            'position' => 144,
            'perms' => '$user->rights->agenda->allactions->read',
            'enabled' => '$user->rights->agenda->allactions->read',
        ...
        $this->menu[$r] = [
            ...
            'titre' => 'List',
            'mainmenu' => 'agenda',
            'url' => '/Modules/Comm/action/list.php?action=show_list&amp;mainmenu=agenda&amp;leftmenu=agenda',
            'langs' => 'agenda',
            'position' => 110,
            'perms' => '$user->rights->agenda->myactions->read',
            'enabled' => '$this->conf->agenda->enabled',
        ...
        $this->menu[$r] = [
            ...
            'titre' => 'MenuToDoMyActions',
            'mainmenu' => 'agenda',
            'url' => '/Modules/Comm/action/list.php?action=show_list&amp;mainmenu=agenda&amp;leftmenu=agenda&amp;status=todo&amp;filter=mine',
            'langs' => 'agenda',
            'position' => 111,
            'perms' => '$user->rights->agenda->myactions->read',
            'enabled' => '$this->conf->agenda->enabled',
        ...
        $this->menu[$r] = [
            ...
            'titre' => 'MenuDoneMyActions',
            'mainmenu' => 'agenda',
            'url' => '/Modules/Comm/action/list.php?action=show_list&amp;mainmenu=agenda&amp;leftmenu=agenda&amp;status=done&amp;filter=mine',
            'langs' => 'agenda',
            'position' => 112,
            'perms' => '$user->rights->agenda->myactions->read',
            'enabled' => '$this->conf->agenda->enabled',
        ...
        $this->menu[$r] = [
            ...
            'titre' => 'MenuToDoActions',
            'mainmenu' => 'agenda',
            'url' => '/Modules/Comm/action/list.php?action=show_list&amp;mainmenu=agenda&amp;leftmenu=agenda&amp;status=todo&amp;filtert=-1',
            'langs' => 'agenda',
            'position' => 113,
            'perms' => '$user->rights->agenda->allactions->read',
            'enabled' => '$user->rights->agenda->allactions->read',
        ...
        $this->menu[$r] = [
            ...
            'titre' => 'MenuDoneActions',
            'mainmenu' => 'agenda',
            'url' => '/Modules/Comm/action/list.php?action=show_list&amp;mainmenu=agenda&amp;leftmenu=agenda&amp;status=done&amp;filtert=-1',
            'langs' => 'agenda',
            'position' => 114,
            'perms' => '$user->rights->agenda->allactions->read',
            'enabled' => '$user->rights->agenda->allactions->read',
        ...
        $this->menu[$r] = [
            ...
            'titre' => 'Reportings',
            'mainmenu' => 'agenda',
            'url' => '/Modules/Comm/action/rapport/index.php?mainmenu=agenda&amp;leftmenu=agenda',
            'langs' => 'agenda',
            'position' => 160,
            'perms' => '$user->rights->agenda->allactions->read',
            'enabled' => '$this->conf->agenda->enabled',
        ...
        $this->menu[$r] = [
            ...
            'titre' => 'Categories',
            'mainmenu' => 'agenda',
            'url' => '/Modules/Categories/index.php?mainmenu=agenda&amp;leftmenu=agenda&type=10',
            'langs' => 'agenda',
            'position' => 170,
            'perms' => '$user->rights->agenda->allactions->read',
        ...
        $this->export_permission[$r] = [["agenda", "export"]];
        $this->export_fields_array[$r] = [
            'ac.id' => "IdAgenda", 'ac.ref_ext' => "ExternalRef", 'ac.datec' => "DateCreation", 'ac.datep' => "DateActionBegin",
