...
class modPartnership extends DolibarrModules
{
    ...
    public function __construct()
    {
        ...
        $this->dictionaries = [
            ...
            'tabname' => [MAIN_DB_PREFIX . "c_partnership_type"],
            // Label of tables
    ...
    public function init($options = '')
    {
        ...
        $myTmpObjects = [];
        $myTmpObjects['Partnership'] = ['includerefgeneration' => 0, 'includedocgeneration' => 0];
