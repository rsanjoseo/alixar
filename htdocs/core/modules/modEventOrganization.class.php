 ...
 *
 *  \file       htdocs/Modules/Eventorganization/core/modules/modEventOrganization.class.php
...
class modEventOrganization extends DolibarrModules
{
    ...
    public function __construct()
    {
        ...
        $this->module_parts = [
            ...
            'css' => [
                //    '/Modules/Eventorganization/css/eventorganization.css.php',
            ],
            // Set this to relative path of js file if module must load a js on all pages
            'js' => [
                //   '/Modules/Eventorganization/js/eventorganization.js.php',
            ],
        ...
        // Example: this->dirs = array("/Modules/Eventorganization/temp","/Modules/Eventorganization/subdir");
        $this->dirs = ["/Modules/Eventorganization/temp"];

        // Config pages. Put here list of php page, stored into eventorganization/admin directory, to use to setup module.
        $this->config_page_url = ["eventorganization.php"];

        // Dependencies
        // A condition to hide module
        $this->hidden = false;
        // List of module class names as string that must be enabled if this module is enabled. Example: array('always1'=>'modModuleToEnable1','always2'=>'modModuleToEnable2', 'FR1'=>'modModuleToEnableFR'...)
        $this->depends = ['modProjet', 'modCategorie'];
        $this->requiredby = []; // List of module class names as string to disable if this one is disabled. Example: array('modModuleToDisable1', ...)
        $this->conflictwith = []; // List of module class names as string this module is in conflict with. Example: array('modModuleToDisable1', ...)

        // The language file dedicated to your module
        $this->langfiles = ["eventorganization"];
        ...
        // );
        $this->const = [1 => ['EVENTORGANIZATION_TASK_LABEL', 'chaine', '', '', 0]];
        ...
        $this->tabs = [];
        // Example:
        // $this->tabs[] = array('data'=>'objecttype:+tabname1:Title1:mylangfile@eventorganization:$user->rights->eventorganization->read:/Modules/Eventorganization/mynewtab1.php?id=__ID__');  					// To add a new tab identified by code tabname1
        // $this->tabs[] = array('data'=>'objecttype:+tabname2:SUBSTITUTION_Title2:mylangfile@eventorganization:$user->rights->othermodule->read:/Modules/Eventorganization/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2. Label will be result of calling all substitution functions on 'Title2' key.
    ...
    public function init($options = '')
    {
        ...
        $result = $this->_load_tables('/Modules/Eventorganization/sql/');
        if ($result < 0) {
        ...
        $myTmpObjects = [];
        $myTmpObjects['ConferenceOrBooth'] = ['includerefgeneration' => 0, 'includedocgeneration' => 0];
        ...
        foreach ($myTmpObjects as $myTmpObjectKey => $myTmpObjectArray) {
            ...
            if ($myTmpObjectArray['includerefgeneration']) {
                $src = DOL_DOCUMENT_ROOT . '/install/doctemplates/Modules/Eventorganization/template_conferenceorbooths.odt';
