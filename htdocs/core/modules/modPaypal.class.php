...
class modPaypal extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->dirs = ['/paypal/temp'];

        // Config pages. Put here list of php page names stored in admmin directory used to setup module.
        $this->config_page_url = ["paypal.php@paypal"];

        // Dependencies
        $this->hidden = false; // A condition to hide module
        $this->depends = []; // List of module class names as string that must be enabled if this module is enabled
        $this->requiredby = ['modPaypalPlus']; // List of module ids to disable if this one is disabled
