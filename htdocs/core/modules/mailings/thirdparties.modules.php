...
class mailing_thirdparties extends MailingTargets
{
    ...
    public $require_module = ["societe"]; // This module allows to select by categories must be also enabled if category module is not activated
    ...
    {
        return '<a href="' . DOL_URL_ROOT . '/index.php?module=societes&controller=card&socid=' . $id . '">' . img_object('', "company") . '</a>';
    }
