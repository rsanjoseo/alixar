...
class mailing_contacts1 extends MailingTargets
{
    ...
    public $require_module = ["societe"]; // Module mailing actif si modules require_module actifs
    ...
    public function formFilter()
    {
        ...
        $langs->loadLangs(["commercial", "companies", "suppliers", "categories"]);
    ...
    {
        return '<a href="' . DOL_URL_ROOT . '/Modules/Contacts/card.php?id=' . $id . '">' . img_object('', "contact") . '</a>';
    }
}
