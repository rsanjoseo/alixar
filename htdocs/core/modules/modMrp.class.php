...
class modMrp extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->module_parts = [
            ...
            'css' => [
                //    '/Modules/Mrp/css/mrp.css.php',
            ],
            // Set this to relative path of js file if module must load a js on all pages
            'js' => [
                //   '/Modules/Mrp/js/mrp.js.php',
            ],
        ...
        $this->need_dolibarr_version = [8, 0]; // Minimum version of Dolibarr required by module
        ...
        // );
        $this->const = [
            1 => ['MRP_MO_ADDON_PDF', 'chaine', 'alpha', 'Name of PDF model of MO', 0],
            2 => ['MRP_MO_ADDON', 'chaine', 'mod_mo_standard', 'Name of numbering rules of MO', 0],
            3 => ['MRP_MO_ADDON_PDF_ODT_PATH', 'chaine', 'DOL_DATA_ROOT/doctemplates/mrps', '', 0],
        ];
        ...
        */
        ...
        $this->boxes = [
            0 => ['file' => 'box_mos.php', 'note' => '', 'enabledbydefaulton' => 'Home'],
        ];
        ...
        $this->cronjobs = [
            ...
            //      'label' => 'MyJob label',
            //      'jobtype' => 'method',
            //      'class' => '/Modules/Mrp/class/mo.class.php',
            //      'objectname' => 'Mo',
        ...
        $this->import_tables_array[$r] = ['m' => MAIN_DB_PREFIX . 'mrp_mo', 'extra' => MAIN_DB_PREFIX . 'mrp_mo_extrafields'];
        $this->import_tables_creator_array[$r] = ['m' => 'fk_user_creat']; // Fields to store import user id
    ...
    public function init($options = '')
    {
        ...
        $result = $this->_load_tables('/Modules/Mrp/sql/');
        if ($result < 0) {
