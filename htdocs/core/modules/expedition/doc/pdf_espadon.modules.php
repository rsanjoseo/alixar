...
class pdf_espadon extends ModelePdfExpedition
{
    ...
    public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
    {
        ...
        $outputlangs->loadLangs(["main", "bills", "orders", "products", "dict", "companies", "propal", "deliveries", "sendings", "productbatch"]);
        ...
        if (!empty($conf->global->PDF_USE_ALSO_LANGUAGE_CODE) && $outputlangs->defaultlang != $conf->global->PDF_USE_ALSO_LANGUAGE_CODE) {
            ...
            $outputlangsbis->loadLangs(["main", "bills", "orders", "products", "dict", "companies", "propal", "deliveries", "sendings", "productbatch"]);
        }
            ...
            if (file_exists($dir)) {
                ...
                for ($i = 0; $i < $nblines; $i++) {
                    ...
                    if ($this->getColumnStatus('weight')) {
                        $this->printStdColumnContent($pdf, $curY, 'weight', $weighttxt . (($weighttxt && $voltxt) ? '<br>' : '') . $voltxt, ['html' => 1]);
    ...
    public function defineColumnField($object, $outputlangs, $hidedetails = 0, $hidedesc = 0, $hideref = 0)
    {
        ...
        $this->cols['desc'] = [
            ...
            'title' => [
                ...
                'padding' => [0.5, 1, 0.5, 1.5], // Like css 0 => top , 1 => right, 2 => bottom, 3 => left
            ],
            'content' => [
