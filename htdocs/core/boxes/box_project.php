...
class box_project extends ModeleBoxes
{
    ...
    public function loadBox($max = 5)
    {
        ...
        $this->info_box_head = ['text' => $textHead, 'limit' => dol_strlen($textHead)];
                ...
                while ($i < min($num, $max)) {
                    ...
                    if ($resultTask) {
                        ...
                        if ($objTask->nb > 0) {
                            ...
                            $this->info_box_contents[$i][] = ['td' => 'class="right"', 'text' => "N/A&nbsp;"];
                        }
                        $totalnbTask += $objTask->nb;
                    } else {
                        $this->info_box_contents[$i][] = ['td' => 'class="right"', 'text' => round(0)];
                        $this->info_box_contents[$i][] = ['td' => 'class="right"', 'text' => "N/A&nbsp;"];
                    }
                    $this->info_box_contents[$i][] = ['td' => 'class="right"', 'text' => $projectstatic->getLibStatut(3)];

                    $i++;
                }
                if ($max < $num) {
                    $this->info_box_contents[$i][] = ['td' => 'colspan="5"', 'text' => '...'];
                    $i++;
                }
            }
        }
