...
class box_dolibarr_state_board extends ModeleBoxes
{
    ...
    public function loadBox($max = 5)
    {
        ...
        $this->max = $max;
        $this->info_box_head = ['text' => $langs->trans("DolibarrStateBoard")];
        ...
        if (empty($user->socid) && empty($conf->global->MAIN_DISABLE_GLOBAL_BOXSTATS)) {
            ...
            $includes = [
                'users' => DOL_DOCUMENT_ROOT . "/Modules/Users/class/user.class.php",
                'members' => DOL_DOCUMENT_ROOT . "/Modules/Adherents/class/adherent.class.php",
                'customers' => DOL_DOCUMENT_ROOT . "/Modules/Societes/class/client.class.php",
                'prospects' => DOL_DOCUMENT_ROOT . "/Modules/Societes/class/client.class.php",
                'suppliers' => DOL_DOCUMENT_ROOT . "/Modules/Fourn/class/fournisseur.class.php",
                'contacts' => DOL_DOCUMENT_ROOT . "/Modules/Contacts/class/contact.class.php",
                'products' => DOL_DOCUMENT_ROOT . "/Modules/Products/class/product.class.php",
                'services' => DOL_DOCUMENT_ROOT . "/Modules/Products/class/product.class.php",
                'proposals' => DOL_DOCUMENT_ROOT . "/Modules/Comm/propal/class/propal.class.php",
                'orders' => DOL_DOCUMENT_ROOT . "/Modules/Commande/class/commande.class.php",
                'invoices' => DOL_DOCUMENT_ROOT . "/Modules/Compta/facture/class/facture.class.php",
                'donations' => DOL_DOCUMENT_ROOT . "/Modules/Don/class/don.class.php",
                'contracts' => DOL_DOCUMENT_ROOT . "/Modules/Contracts/class/contrat.class.php",
                'interventions' => DOL_DOCUMENT_ROOT . "/Modules/Fichinter/class/fichinter.class.php",
                'supplier_orders' => DOL_DOCUMENT_ROOT . "/Modules/Fourn/class/fournisseur.commande.class.php",
                'supplier_invoices' => DOL_DOCUMENT_ROOT . "/Modules/Fourn/class/fournisseur.facture.class.php",
                'supplier_proposals' => DOL_DOCUMENT_ROOT . "/Modules/SupplierProposal/class/supplier_proposal.class.php",
                'projects' => DOL_DOCUMENT_ROOT . "/Modules/Projects/class/project.class.php",
                'expensereports' => DOL_DOCUMENT_ROOT . "/Modules/ExpenseReports/class/expensereport.class.php",
                'holidays' => DOL_DOCUMENT_ROOT . "/Modules/Holiday/class/holiday.class.php",
                'ticket' => DOL_DOCUMENT_ROOT . "/Modules/Ticket/class/ticket.class.php",
            ];
            $links = [
                'users' => DOL_URL_ROOT . '/Modules/Users/list.php',
                'members' => DOL_URL_ROOT . '/Modules/Adherents/list.php?statut=1&mainmenu=members',
                'customers' => DOL_URL_ROOT . '/Modules/Societes/list.php?type=c&mainmenu=companies',
                'prospects' => DOL_URL_ROOT . '/Modules/Societes/list.php?type=p&mainmenu=companies',
                'suppliers' => DOL_URL_ROOT . '/Modules/Societes/list.php?type=f&mainmenu=companies',
                'contacts' => DOL_URL_ROOT . '/Modules/Contacts/list.php?mainmenu=companies',
                'products' => DOL_URL_ROOT . '/Modules/Products/list.php?type=0&mainmenu=products',
                'services' => DOL_URL_ROOT . '/Modules/Products/list.php?type=1&mainmenu=products',
                'proposals' => DOL_URL_ROOT . '/Modules/Comm/propal/list.php?mainmenu=commercial&leftmenu=propals',
                'orders' => DOL_URL_ROOT . '/Modules/Commande/list.php?mainmenu=commercial&leftmenu=orders',
                'invoices' => DOL_URL_ROOT . '/Modules/Compta/facture/list.php?mainmenu=billing&leftmenu=customers_bills',
                'donations' => DOL_URL_ROOT . '/Modules/Don/list.php?leftmenu=donations',
                'contracts' => DOL_URL_ROOT . '/Modules/Contrats/list.php?mainmenu=commercial&leftmenu=contracts',
                'interventions' => DOL_URL_ROOT . '/Modules/Fichinter/list.php?mainmenu=commercial&leftmenu=ficheinter',
                'supplier_orders' => DOL_URL_ROOT . '/Modules/Fourn/commande/list.php?mainmenu=commercial&leftmenu=orders_suppliers',
                'supplier_invoices' => DOL_URL_ROOT . '/Modules/Fourn/facture/list.php?mainmenu=billing&leftmenu=suppliers_bills',
                'supplier_proposals' => DOL_URL_ROOT . '/supplier_proposal/list.php?mainmenu=commercial&leftmenu=',
                'projects' => DOL_URL_ROOT . '/Modules/Projects/list.php?mainmenu=project',
                'expensereports' => DOL_URL_ROOT . '/Modules/ExpenseReports/list.php?mainmenu=hrm&leftmenu=expensereport',
                'holidays' => DOL_URL_ROOT . '/Modules/Holiday/list.php?mainmenu=hrm&leftmenu=holiday',
                'ticket' => DOL_URL_ROOT . '/Modules/Tickets/list.php?leftmenu=ticket',
            ];
            $titres = [
                'users' => "Users",
                'members' => "Members",
