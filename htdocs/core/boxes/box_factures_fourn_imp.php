...
class box_factures_fourn_imp extends ModeleBoxes
{
    ...
    public $depends = ["facture", "fournisseur"];
    ...
    public function loadBox($max = 5)
    {
        ...
        include_once DOL_DOCUMENT_ROOT . '/Modules/Fourn/class/fournisseur.class.php';
        $thirdpartystatic = new Fournisseur($this->db);

        $this->info_box_head = ['text' => $langs->trans("BoxTitleOldestUnpaidSupplierBills", $max)];
