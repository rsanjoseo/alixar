...
class box_customers_outstanding_bill_reached extends ModeleBoxes
{
    ...
    public $depends = ["facture", "societe"];
    ...
    public function loadBox($max = 5)
    {
        ...
        $this->info_box_head = ['text' => $langs->trans("BoxTitleLastOutstandingBillReached", $max)];
            ...
            if ($result) {
                ...
                while ($line < $num) {
                    ...
                    if ($outstandingtotal >= $outstandinglimit) {
                        $this->info_box_contents[$nboutstandingbillreachedcustomers][] = [
                            'td' => '',
