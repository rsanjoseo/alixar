...
class box_propales extends ModeleBoxes
{
    ...
    public $depends = ["propal"]; // conf->propal->enabled
    ...
    public function loadBox($max = 5)
    {
        ...
        $this->info_box_head = ['text' => $langs->trans("BoxTitleLast" . (!empty($conf->global->MAIN_LASTBOX_ON_OBJECT_DATE) ? "" : "Modified") . "Propals", $max)];
