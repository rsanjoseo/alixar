...
class box_actions extends ModeleBoxes
{
    ...
    public function loadBox($max = 5)
    {
        ...
        include_once DOL_DOCUMENT_ROOT . '/Modules/Societe/class/societe.class.php';
        include_once DOL_DOCUMENT_ROOT . '/Modules/Comm/action/class/actioncomm.class.php';
        $societestatic = new Societe($this->db);
        $actionstatic = new ActionComm($this->db);

        $this->info_box_head = ['text' => $langs->trans("BoxTitleLastActionsToDo", $max)];
