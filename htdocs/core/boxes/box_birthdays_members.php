...
class box_birthdays_members extends ModeleBoxes
{
    ...
    public function loadBox($max = 20)
    {
        ...
        $this->info_box_head = ['text' => $langs->trans("BoxTitleMemberNextBirthdays")];
        ...
        if ($user->rights->adherent->lire) {
            ...
            if ($result) {
                ...
                if ($num == 0) {
                    $this->info_box_contents[$line][0] = ['td' => 'class="center opacitymedium"', 'text' => $langs->trans("None")];
                }
