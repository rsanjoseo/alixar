        ...
        if ($user->rights->ticket->read) {
            ...
            if ($resql) {
                ...
                while ($i < $num) {
                    ...
                    // Subject
                    $this->info_box_contents[$i][$r] = [
                        'td' => 'class="nowrap tdoverflowmax150"',
                        'text' => $objp->subject, // Some event have no ref
                        'url' => DOL_URL_ROOT . "/Modules/Ticket/card.php?track_id=" . $objp->track_id,
                    ];
                    $r++;
                ...
                if ($num == 0) {
                    $this->info_box_contents[$i][0] = ['td' => 'class="center"', 'text' => $langs->trans("BoxLastModifiedTicketNoRecordedTickets")];
                }
            } else {
