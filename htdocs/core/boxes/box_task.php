...
class box_task extends ModeleBoxes
{
    ...
    public function loadBox($max = 5)
    {
        ...
        $filterValue = 'all';
        if (in_array(GETPOST($cookie_name), ['all', 'im_project_contact', 'im_task_contact'])) {
        ...
        if ($user->rights->projet->lire) {
            ...
            $selectArray = ['all' => $langs->trans("NoFilter"), 'im_task_contact' => $langs->trans("WhichIamLinkedTo"), 'im_project_contact' => $langs->trans("WhichIamLinkedToProject")];
