        ...
        if ($user->rights->ticket->read) {
            ...
            if ($resql) {
                ...
                if ($num > 0) {
                    ...
                    $data[] = [$langs->trans('TicketCreatedToday'), $objp->nb];
                    $totalnb += $objp->nb;
                } else {
                    $data[] = [$langs->trans('TicketCreatedToday'), 0];
                }
            } else {
            ...
            if ($resql) {
                ...
                if ($num > 0) {
                    $objp = $this->db->fetch_object($resql);
                    $data[] = [$langs->trans('TicketClosedToday'), $objp->nb];
                    $totalnb += $objp->nb;
                } else {
                    $data[] = [$langs->trans('TicketClosedToday'), 0];
                }
            } else {
                dol_print_error($this->db);
            }
