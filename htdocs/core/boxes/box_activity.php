...
class box_activity extends ModeleBoxes
{
    ...
    public function loadBox($max = 5)
    {
            ...
            if (!empty($data)) {
                ...
                while ($j < count($data)) {
                    $this->info_box_contents[$line][0] = [
                        ...
                        'url' => DOL_URL_ROOT . "/Modules/Comm/propal/list.php?mainmenu=commercial&amp;leftmenu=propals&amp;search_status=" . $data[$j]->fk_statut,
                    ...
                    $this->info_box_contents[$line][3] = [
                        'td' => 'class="nowraponall right"',
                        'text' => price($data[$j]->Mnttot, 1, $langs, 0, 0, -1, $conf->currency),
                    ];
                    $this->info_box_contents[$line][4] = [
        ...
        if (!empty($conf->commande->enabled) && $user->rights->commande->lire) {
            ...
            $cachedir = DOL_DATA_ROOT . '/Modules/Commande/temp';
            ...
            if (!empty($data)) {
                ...
                while ($j < count($data)) {
                    $this->info_box_contents[$line][0] = [
                        'td' => 'class="left" width="16"',
                        'url' => DOL_URL_ROOT . "/Modules/Commande/list.php?mainmenu=commercial&amp;leftmenu=orders&amp;search_status=" . $data[$j]->fk_statut,
            ...
            if (!empty($data)) {
                ...
                while ($j < count($data)) {
                    ...
                    $this->info_box_contents[$line][0] = [
                        ...
                        'url' => DOL_URL_ROOT . "/Modules/Compta/facture/list.php?" . $billurl . "&amp;mainmenu=accountancy&amp;leftmenu=customers_bills",
                        'logo' => 'bill',
                    ];
        ...
        $this->info_box_contents[$line][0] = ['tr' => 'class="liste_total_wrap"'];
        $this->info_box_contents[$line][1] = ['td' => 'class="liste_total left" ', 'text' => $langs->trans("Total") . "&nbsp;" . $textHead];
        $this->info_box_contents[$line][2] = ['td' => 'class="liste_total right" ', 'text' => $totalnb];
        $this->info_box_contents[$line][3] = ['td' => 'class="liste_total right" ', 'text' => ''];
        $this->info_box_contents[$line][4] = ['td' => 'class="liste_total right" ', 'text' => ""];
    }
