...
class box_shipments extends ModeleBoxes
{
    ...
    public function loadBox($max = 5)
    {
        ...
        include_once DOL_DOCUMENT_ROOT . '/Modules/Expedition/class/expedition.class.php';
        ...
        $this->info_box_head = ['text' => $langs->trans("BoxTitleLastCustomerShipments", $max)];
