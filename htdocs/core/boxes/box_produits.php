...
class box_produits extends ModeleBoxes
{
    ...
    public function __construct($db, $param)
    {
        ...
        $tmpentry = ['enabled' => (!empty($conf->product->enabled) || !empty($conf->service->enabled)), 'perms' => (!empty($user->rights->produit->lire) || !empty($user->rights->service->lire)), 'module' => 'product|service'];
    ...
    public function loadBox($max = 5)
    {
        ...
        $this->info_box_head = ['text' => $langs->trans("BoxTitleLastProducts", $max)];
