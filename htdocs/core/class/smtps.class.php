...
class SMTPs
{
     ...
     * Defaulted to 0 - 7bit
     */
    private $_smtpsTransEncodeType = 0; // UUENCODE encoding
    /**
     * Content-Transfer-Encoding
     */
    private $_smtpsTransEncodeTypes = [
    ...
    private function _strip_email($_strAddr)
    {
        ...
        [$_aryEmail['user'], $_aryEmail['host']] = explode('@', $_aryEmail['addr']);
