...
class FormAccounting extends Form
{
     ...
     * @return string                       String with HTML select
     */
    public function select_account($selectid, $htmlname = 'account', $showempty = 0, $event = [], $select_in = 0, $select_out = 0, $morecss = 'minwidth100 maxwidth300 maxwidthonsmartphone', $usecache = '')
    {
        // phpcs:enable
        global $conf, $langs;
