...
class SimpleOpenID
{
    ...
    public function GetError()
    {
        // phpcs:enable
        $e = $this->error;
        return ['code' => $e[0], 'description' => $e[1]];
    }
    ...
    public function GetOpenIDServer($url = '')
    {
        ...
        $response = getURLContent($url, 'GET', '', 1, [], ['http', 'https']);
    ...
    public function sendDiscoveryRequestToGetXRDS($url = '')
    {
        ...
        $addheaders = ['Accept: application/xrds+xml'];
        $response = getURLContent($url, 'GET', '', 1, $addheaders, ['http', 'https'], 0);
