...
class Events // extends CommonObject
{
    ...
    public $eventstolog = [
        ['id' => 'USER_LOGIN', 'test' => 1],
        ['id' => 'USER_LOGIN_FAILED', 'test' => 1],
        ['id' => 'USER_LOGOUT', 'test' => 1],
        ['id' => 'USER_CREATE', 'test' => 1],
        ['id' => 'USER_MODIFY', 'test' => 1],
        ['id' => 'USER_NEW_PASSWORD', 'test' => 1],
        ['id' => 'USER_ENABLEDISABLE', 'test' => 1],
        ['id' => 'USER_DELETE', 'test' => 1],
        ['id' => 'USERGROUP_CREATE', 'test' => 1],
        ['id' => 'USERGROUP_MODIFY', 'test' => 1],
        ['id' => 'USERGROUP_DELETE', 'test' => 1],
    ];
     ...
     */
    public $fields = [
        'rowid' => ['type' => 'integer', 'label' => 'TechnicalID', 'enabled' => 1, 'visible' => -2, 'noteditable' => 1, 'notnull' => 1, 'index' => 1, 'position' => 1, 'comment' => 'Id'],
        'entity' => ['type' => 'integer', 'label' => 'Entity', 'enabled' => 1, 'visible' => 0, 'notnull' => 1, 'default' => 1, 'index' => 1, 'position' => 20],
        'prefix_session' => ['type' => 'varchar(255)', 'label' => 'PrefixSession', 'enabled' => 1, 'visible' => -1, 'notnull' => -1, 'index' => 0, 'position' => 1000],
        'user_agent' => ['type' => 'varchar(255)', 'label' => 'UserAgent', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'default' => 0, 'index' => 1, 'position' => 1000],
    ];
