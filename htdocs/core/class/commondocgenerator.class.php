...
abstract class CommonDocGenerator
{
    ...
    public function get_substitutionarray_object($object, $outputlangs, $array_key = 'object')
    {
        ...
        if (method_exists($object, 'getTotalDiscount') && in_array(get_class($object), ['Proposal', 'Commande', 'Facture', 'SupplierProposal', 'CommandeFournisseur', 'FactureFournisseur'])) {
    ...
    public function prepareArrayColumnField($object, $outputlangs, $hidedetails = 0, $hidedesc = 0, $hideref = 0)
    {
        ...
        // Sorting
        uasort($this->cols, [$this, 'columnSort']);
    ...
    public function getExtrafieldsInHtml($object, $outputlangs, $params = [])
    {
        ...
        $defaultParams = [
            ...
            'table' => [
                ...
                'border' => 0,
                'labelcolwidth' => '25%',
                'arrayOfLineBreakType' => ['text', 'html'],
            ],
