...
$hookmanager->initHooks(['userhome']);
...
if ($resql) {
    ...
    $lastcreatedbox .= '<td class="right" colspan="2"><a class="commonlink" href="' . DOL_URL_ROOT . '/Modules/Users/list.php?sortfield=u.datec&sortorder=DESC">' . $langs->trans("FullList") . '</td>';
    $lastcreatedbox .= '</tr>' . "\n";
    $i = 0;
...
if ($canreadperms) {
    ...
    if ($resql) {
        ...
        $lastgroupbox .= '<td class="right"><a class="commonlink" href="' . DOL_URL_ROOT . '/Modules/Users/group/list.php?sortfield=g.datec&sortorder=DESC">' . $langs->trans("FullList") . '</td>';
        $lastgroupbox .= '</tr>';
        $i = 0;
