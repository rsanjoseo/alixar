...
class Ticket extends CommonObject
{
     ...
     * @var string msgid
     */
    public $email_msgid;            // on hold
    public $lines;            // Closed - Solved
    /**
     * @var string Regex pour les images
     */
    public $regeximgext = '\.jpg|\.jpeg|\.bmp|\.gif|\.png|\.tiff';            // Closed - Not solved
    ...
    public $fields = [
        'rowid' => ['type' => 'integer', 'label' => 'TechnicalID', 'position' => 1, 'visible' => -2, 'enabled' => 1, 'position' => 1, 'notnull' => 1, 'index' => 1, 'comment' => "Id"],
        ...
        'fk_user_create' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'Author', 'visible' => 1, 'enabled' => 1, 'position' => 15, 'notnull' => 1, 'css' => 'tdoverflowmax125 maxwidth150onsmartphone'],
        'origin_email' => ['type' => 'mail', 'label' => 'OriginEmail', 'visible' => -2, 'enabled' => 1, 'position' => 16, 'notnull' => 1, 'index' => 1, 'searchall' => 1, 'comment' => "Reference of object", 'css' => 'tdoverflowmax150'],
        ...
        'type_code' => ['type' => 'varchar(32)', 'label' => 'Type', 'visible' => 1, 'enabled' => 1, 'position' => 20, 'notnull' => -1, 'help' => "", 'css' => 'maxwidth125 tdoverflowmax50'],
        'category_code' => ['type' => 'varchar(32)', 'label' => 'TicketCategory', 'visible' => -1, 'enabled' => 1, 'position' => 21, 'notnull' => -1, 'help' => "", 'css' => 'maxwidth100'],
        'severity_code' => ['type' => 'varchar(32)', 'label' => 'Severity', 'visible' => 1, 'enabled' => 1, 'position' => 22, 'notnull' => -1, 'help' => "", 'css' => 'maxwidth100'],
        'fk_soc' => ['type' => 'integer:Societe:societe/class/societe.class.php', 'label' => 'ThirdParty', 'visible' => 1, 'enabled' => '$conf->societe->enabled', 'position' => 50, 'notnull' => -1, 'index' => 1, 'searchall' => 1, 'help' => "LinkToThirparty", 'css' => 'tdoverflowmax150 maxwidth150onsmartphone'],
        'notify_tiers_at_create' => ['type' => 'integer', 'label' => 'NotifyThirdparty', 'visible' => -1, 'enabled' => 0, 'position' => 51, 'notnull' => 1, 'index' => 1],
        'fk_project' => ['type' => 'integer:Project:projet/class/project.class.php', 'label' => 'Project', 'visible' => -1, 'enabled' => 1, 'position' => 52, 'notnull' => -1, 'index' => 1, 'help' => "LinkToProject"],
        'timing' => ['type' => 'varchar(20)', 'label' => 'Timing', 'visible' => -1, 'enabled' => 1, 'position' => 42, 'notnull' => -1, 'help' => ""],
        'datec' => ['type' => 'datetime', 'label' => 'DateCreation', 'visible' => 1, 'enabled' => 1, 'position' => 500, 'notnull' => 1],
        'date_read' => ['type' => 'datetime', 'label' => 'TicketReadOn', 'visible' => -1, 'enabled' => 1, 'position' => 501, 'notnull' => 1],
        'fk_user_assign' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'AssignedTo', 'visible' => 1, 'enabled' => 1, 'position' => 505, 'notnull' => 1, 'css' => 'tdoverflowmax125'],
        ...
        'message' => ['type' => 'text', 'label' => 'Message', 'visible' => -2, 'enabled' => 1, 'position' => 540, 'notnull' => -1,],
        'email_msgid' => ['type' => 'varchar(255)', 'label' => 'EmailMsgID', 'visible' => -2, 'enabled' => 1, 'position' => 540, 'notnull' => -1, 'help' => 'EmailMsgIDDesc'],
        'progress' => ['type' => 'varchar(100)', 'label' => 'Progression', 'visible' => -1, 'enabled' => 1, 'position' => 540, 'notnull' => -1, 'css' => 'right', 'help' => "", 'isameasure' => 1],
        'resolution' => ['type' => 'integer', 'label' => 'Resolution', 'visible' => -1, 'enabled' => '$conf->global->TICKET_ENABLE_RESOLUTION', 'position' => 550, 'notnull' => 1],
        'fk_statut' => ['type' => 'integer', 'label' => 'Status', 'visible' => 1, 'enabled' => 1, 'position' => 600, 'notnull' => 1, 'index' => 1, 'arrayofkeyval' => [0 => 'Unread', 1 => 'Read', 3 => 'Answered', 4 => 'Assigned', 5 => 'InProgress', 6 => 'Waiting', 8 => 'SolvedClosed', 9 => 'Deleted']],
     ...
     * @return int                          <0 if KO, >0 if OK
     */
    public function createTicketMessage($user, $notrigger = 0, $filename_list = [], $mimetype_list = [], $mimefilename_list = [])
    {
        global $conf, $langs;
        $error = 0;
    ...
    private function sendLogByEmail($user, $message)
    {
        ...
        if (!empty($this->origin_email) && empty($this->fk_soc)) {
            $array_ext = [['firstname' => '', 'lastname' => '', 'email' => $this->origin_email, 'libelle' => $langs->transnoentities('TicketEmailOriginIssuer'), 'socid' => "-1"]];
            $contacts = array_merge($contacts, $array_ext);
        }

        if (!empty($this->fk_soc)) {
            $this->fetch_thirdparty($this->fk_soc);
            $array_company = [['firstname' => '', 'lastname' => $this->client->name, 'email' => $this->client->email, 'libelle' => $langs->transnoentities('Customer'), 'socid' => $this->client->id]];
