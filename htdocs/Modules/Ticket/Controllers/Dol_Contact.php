...
$langs->loadLangs(['companies', 'ticket']);
...
$url_page_current = DOL_URL_ROOT . '/Modules/Tickets/contact.php';
...
if ($id > 0 || !empty($track_id) || !empty($ref)) {
    if ($object->fetch($id, $ref, $track_id) > 0) {
        ...
        $linkback = '<a href="' . dol_buildpath('/Modules/Tickets/list.php', 1) . '"><strong>' . $langs->trans("BackToList") . '</strong></a> ';
