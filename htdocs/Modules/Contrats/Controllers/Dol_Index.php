...
if ($resql) {
    ...
    while ($i < min($num, $max)) {
        ...
        if ($obj->fk_product > 0) {
            ...
            print '<a href="' . DOL_URL_ROOT . '/Modules/Contrats/card.php?id=' . $obj->fk_contrat . '">' . img_object($langs->trans("ShowService"), "service");
            if ($obj->label) {
        ...
        print $staticcompany->getNomUrl(1, '', 20);
        print '</td>';
        print '<td class="nowrap right"><a href="' . DOL_URL_ROOT . '/Modules/Contrats/card.php?id=' . $obj->fk_contrat . '&ligne=' . $obj->cid . '">';
...
if ($resql) {
    ...
    print '<tr class="liste_titre"><th colspan="4">' . $langs->trans("NotActivatedServices") . ' <a href="' . DOL_URL_ROOT . '/Modules/Contrats/services_list.php?mode=0"><span class="badge">' . $num . '</span></a></th>';
    print "</tr>\n";
...
if ($resql) {
    ...
    print '<tr class="liste_titre"><th colspan="4">' . $langs->trans("ListOfExpiredServices") . ' <a href="' . DOL_URL_ROOT . '/Modules/Contrats/services_list.php?mode=4&amp;filter=expired"><span class="badge">' . $num . '</span></a></th>';
    print "</tr>\n";
