...
if ($id > 0) {
    ...
    {
        //$out.='<a href="'.DOL_URL_ROOT.'/Modules/Comm/action/card.php?action=create';
    ...
    if (!empty($conf->agenda->enabled)) {
        if (!empty($user->rights->agenda->myactions->create) || !empty($user->rights->agenda->allactions->create)) {
            $newcardbutton .= dolGetButtonTitle($langs->trans('AddAction'), '', 'fa fa-plus-circle', DOL_URL_ROOT . '/Modules/Comm/action/card.php?action=create' . $out);
        }
    }
