...
$arrayfields = [
    ...
    'cd.total_ht' => ['label' => "TotalHT", 'checked' => -1, 'position' => 109],
    'cd.total_tva' => ['label' => "TotalVAT", 'checked' => -1, 'position' => 110],
    'cd.date_ouverture_prevue' => ['label' => "DateStartPlannedShort", 'checked' => (($mode == "" || $mode == -1) || $mode == "0"), 'position' => 150],
    'cd.date_ouverture' => ['label' => "DateStartRealShort", 'checked' => (($mode == "" || $mode == -1) || $mode > 0), 'position' => 160],
    'cd.date_fin_validite' => ['label' => "DateEndPlannedShort", 'checked' => (($mode == "" || $mode == -1) || $mode < 5), 'position' => 170],
    'cd.date_cloture' => ['label' => "DateEndRealShort", 'checked' => (($mode == "" || $mode == -1) || $mode >= 5), 'position' => 180],
...
if ($num == 1 && ! empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all)
{
	...
	$id = $obj->id;
	header("Location: ".DOL_URL_ROOT.'/Modules/Projects/tasks/task.php?id='.$id.'&withprojet=1');
	exit;
}*/
