...
class Contrat extends CommonObject
{
    ...
    public $fields = [
        ...
        'ref' => ['type' => 'varchar(50)', 'label' => 'Ref', 'enabled' => 1, 'visible' => -1, 'showoncombobox' => 1, 'position' => 15],
        'ref_ext' => ['type' => 'varchar(255)', 'label' => 'Ref ext', 'enabled' => 1, 'visible' => 0, 'position' => 20],
        'ref_supplier' => ['type' => 'varchar(50)', 'label' => 'Ref supplier', 'enabled' => 1, 'visible' => -1, 'position' => 25],
        ...
        'fk_soc' => ['type' => 'integer:Societe:societe/class/societe.class.php', 'label' => 'ThirdParty', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 70],
        'fk_projet' => ['type' => 'integer:Project:projet/class/project.class.php:1:fk_statut=1', 'label' => 'Fk projet', 'enabled' => 1, 'visible' => -1, 'position' => 75],
        'fk_commercial_signature' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'Fk commercial signature', 'enabled' => 1, 'visible' => -1, 'position' => 80],
        'fk_commercial_suivi' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'Fk commercial suivi', 'enabled' => 1, 'visible' => -1, 'position' => 85],
        'fk_user_author' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'Fk user author', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 90],
        'note_private' => ['type' => 'text', 'label' => 'NotePublic', 'enabled' => 1, 'visible' => 0, 'position' => 105],
        'note_public' => ['type' => 'text', 'label' => 'NotePrivate', 'enabled' => 1, 'visible' => 0, 'position' => 110],
        ...
        'ref_customer' => ['type' => 'varchar(50)', 'label' => 'Ref customer', 'enabled' => 1, 'visible' => -1, 'position' => 130],
        ...
        'statut' => ['type' => 'smallint(6)', 'label' => 'Statut', 'enabled' => 1, 'visible' => -1, 'position' => 500, 'arrayofkeyval' => [0 => 'Draft', 1 => 'Validated', 2 => 'Closed']],
    ];
