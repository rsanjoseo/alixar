...
/**
 * \file        htdocs/Modules/Accountancy/class/bookkeeping.class.php
...
class BookKeeping extends CommonObject
{
    ...
    public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
    {
        ...
        $url = DOL_URL_ROOT . '/Modules/Accountancy/bookkeeping/card.php?piece_num=' . $this->piece_num;
     ...
     */
    public function fetchAllByAccount($sortorder = '', $sortfield = '', $limit = 0, $offset = 0, array $filter = [], $filtermode = 'AND', $option = 0)
    {
        global $conf;
     ...
     * @return int <0 if KO, >0 if OK
     */
    public function fetchAllBalance($sortorder = '', $sortfield = '', $limit = 0, $offset = 0, array $filter = [], $filtermode = 'AND')
    {
        global $conf;
