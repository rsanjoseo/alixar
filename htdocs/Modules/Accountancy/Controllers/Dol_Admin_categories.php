...
/**
 * \file    htdocs/Modules/Accountancy/admin/categories.php
...
$linkback = '<a href="' . DOL_URL_ROOT . '/Modules/Accountancy/admin/categories_list.php?restore_lastsearch_values=1">' . $langs->trans("BackToList") . '</a>';
$titlepicto = 'setup';
