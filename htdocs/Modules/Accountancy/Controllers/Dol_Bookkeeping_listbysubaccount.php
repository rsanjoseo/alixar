...
/**
 * \file        htdocs/Modules/Accountancy/bookkeeping/listbysubaccount.php
...
$hookmanager->initHooks(['bookkeepingbysubaccountlist']);
...
if (empty($reshook)) {
    $newcardbutton = dolGetButtonTitle($langs->trans('ViewFlatList'), '', 'fa fa-list paddingleft imgforviewmode', DOL_URL_ROOT . '/Modules/Accountancy/bookkeeping/list.php?' . $param);
    ...
    $newcardbutton .= dolGetButtonTitle($langs->trans('GroupBySubAccountAccounting'), '', 'fa fa-align-left vmirror paddingleft imgforviewmode', DOL_URL_ROOT . '/Modules/Accountancy/bookkeeping/listbysubaccount.php?' . $param, '', 1, ['morecss' => 'marginleftonly btnTitleSelected']);
    $newcardbutton .= dolGetButtonTitle($langs->trans('NewAccountingMvt'), '', 'fa fa-plus-circle paddingleft', DOL_URL_ROOT . '/Modules/Accountancy/bookkeeping/card.php?action=create');
}
...
while ($i < min($num, $limit)) {
    ...
    if (!empty($arrayfields['t.date_validating']['checked'])) {
        $colspanend++;
    }
    if (!empty($arrayfields['t.lettering_code']['checked'])) {
        $colspanend++;
