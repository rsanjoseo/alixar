...
/**
 * \file        htdocs/Modules/Accountancy/bookkeeping/thirdparty_lettering_supplier.php
...
require_once DOL_DOCUMENT_ROOT . '/Modules/Accountancy/class/lettering.class.php';
...
$langs->loadLangs(["compta", "accountancy"]);
...
dol_syslog("/Modules/Accountancy/bookkeeping/thirdparty_lettering_supplier.php", LOG_DEBUG);
$resql = $db->query($sql);
if (!$resql) {
    dol_print_error($db);
    exit;
    ...
    */
    ...
    while ($obj = $db->fetch_object($resql)) {
        ...
        if (empty($obj->lettering_code) && empty($obj->date_validated)) {
            ...
            print '<td><a href="' . DOL_URL_ROOT . '/Modules/Accountancy/bookkeeping/card.php?piece_num=' . $obj->piece_num . '">';
            print img_edit();
            print '</a></td>' . "\n";
        } else {
