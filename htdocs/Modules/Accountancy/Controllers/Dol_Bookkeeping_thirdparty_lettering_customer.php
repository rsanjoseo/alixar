...
/**
 * \file        htdocs/Modules/Accountancy/bookkeeping/thirdparty_lettering_customer.php
 * \ingroup     accountancy
...
dol_syslog("/Modules/Accountancy/bookkeeping/thirdparty_lettering_customer.php", LOG_DEBUG);
$resql = $db->query($sql);
if (!$resql) {
    dol_print_error($db);
    exit();
