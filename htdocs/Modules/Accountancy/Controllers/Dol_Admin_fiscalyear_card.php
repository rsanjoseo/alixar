...
/**
 * \file        htdocs/Modules/Accountancy/admin/fiscalyear_card.php
    ...
    */
    ...
    if ($result > 0) {
        ...
        if ($action == 'edit') {
            ...
            $linkback = '<a href="' . DOL_URL_ROOT . '/Modules/Accountancy/admin/fiscalyear.php">' . $langs->trans("BackToList") . '</a>';
