...
$langs->loadLangs(["compta", "bills", "admin", "accountancy", "salaries"]);
...
$arrayfields = [
    'aa.account_number' => ['label' => $langs->trans("AccountNumber"), 'checked' => 1],
    'aa.label' => ['label' => $langs->trans("Label"), 'checked' => 1],
    'aa.labelshort' => ['label' => $langs->trans("LabelToShow"), 'checked' => 1],
    'aa.account_parent' => ['label' => $langs->trans("Accountparent"), 'checked' => 1],
    'aa.pcg_type' => ['label' => $langs->trans("Pcgtype"), 'checked' => 1, 'help' => 'PcgtypeDesc'],
    'aa.reconcilable' => ['label' => $langs->trans("Reconcilable"), 'checked' => 1],
    'aa.active' => ['label' => $langs->trans("Activated"), 'checked' => 1],
];
