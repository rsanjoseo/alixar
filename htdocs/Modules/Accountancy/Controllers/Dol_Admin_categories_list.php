...
/**
 *        \file       htdocs/Modules/Accountancy/admin/categories_list.php
 *        \ingroup    setup
...
dol_syslog("htdocs/Modules/Accountancy/admin/categories_list.php", LOG_DEBUG);
    ...
    if ($num) {
        ...
        while ($i < $num) {
            ...
            if ($action == 'edit' && ($rowid == (!empty($obj->rowid) ? $obj->rowid : $obj->code))) {
                ...
                $tmpaction = 'view';
                $parameters = ['var' => $var, 'fieldlist' => $fieldlist, 'tabname' => $tabname[$id]];
                ...
                if (empty($obj->formula)) {
                    print '<a href="' . DOL_URL_ROOT . '/Modules/Accountancy/admin/categories.php?action=display&save_lastsearch_values=1&account_category=' . $obj->rowid . '">';
