...
/**
 * \file        htdocs/Modules/Accountancy/closure/index.php
 * \ingroup     Accountancy
    ...
    if ($result < 0) {
        ...
        if (is_array($object->lines)) {
            foreach ($object->lines as $movement) {
                ...
                dol_syslog("/Modules/Accountancy/closure/index.php :: Function validate_movement_confirm Specify movements as validated", LOG_DEBUG);
                $result = $db->query($sql);
                if (!$result) {
                    $error++;
                    break;
...
dol_syslog('htdocs/Modules/Accountancy/closure/index.php', LOG_DEBUG);
$resql = $db->query($sql);
if ($resql) {
