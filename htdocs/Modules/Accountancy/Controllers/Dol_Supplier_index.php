...
/**
 * \file        htdocs/Modules/Accountancy/supplier/index.php
...
if ($action == 'validatehistory') {
    ...
    dol_syslog('htdocs/Modules/Accountancy/supplier/index.php');
...
if ($resql) {
    ...
    while ($row = $db->fetch_row($resql)) {
        ...
        print '<td>';
        if ($row[0] == 'tobind') {
            print $langs->trans("UseMenuToSetBindindManualy", DOL_URL_ROOT . '/Modules/Accountancy/supplier/list.php?search_year=' . $y, $langs->transnoentitiesnoconv("ToBind"));
        } else {
            print $row[1];
        }
        print '</td>';
