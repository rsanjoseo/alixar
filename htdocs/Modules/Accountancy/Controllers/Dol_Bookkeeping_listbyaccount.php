...
/**
 * \file        htdocs/Modules/Accountancy/bookkeeping/listbyaccount.php
...
$hookmanager->initHooks(['bookkeepingbyaccountlist']);
...
if (empty($reshook)) {
    ...
    $newcardbutton .= dolGetButtonTitle($langs->trans('GroupByAccountAccounting'), '', 'fa fa-stream paddingleft imgforviewmode', DOL_URL_ROOT . '/Modules/Accountancy/bookkeeping/listbyaccount.php?' . $param, '', 1, ['morecss' => 'marginleftonly btnTitleSelected']);
