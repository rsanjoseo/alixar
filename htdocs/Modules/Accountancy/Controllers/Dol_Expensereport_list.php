...
/**
 * \file        htdocs/Modules/Accountancy/expensereport/list.php
...
if ($result) {
    ...
    while ($i < min($num_lines, $limit)) {
        ...
        print '<td>';
        print $formaccounting->select_account($objp->aarowid_suggest, 'codeventil' . $objp->rowid, 1, [], 0, 0, 'codeventil maxwidth300 maxwidthonsmartphone', 'cachewithshowemptyone');
        print '</td>';
