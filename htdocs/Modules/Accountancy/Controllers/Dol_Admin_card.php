...
/**
 *  \file       htdocs/Modules/Accountancy/admin/card.php
...
require_once DOL_DOCUMENT_ROOT . '/Modules/Accountancy/class/accountancysystem.class.php';
...
if (GETPOST('cancel', 'alpha')) {
    $urltogo = $backtopage ? $backtopage : DOL_URL_ROOT . '/Modules/Accountancy/admin/account.php';
...
if ($action == 'create') {
    ...
    if ($result > 0) {
        ...
        if ($action == 'update') {
            ...
            // View mode
            $linkback = '<a href="' . DOL_URL_ROOT . '/Modules/Accountancy/admin/account.php?restore_lastsearch_values=1">' . $langs->trans("BackToList") . '</a>';
