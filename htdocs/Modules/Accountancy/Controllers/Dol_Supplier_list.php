...
/**
 * \file        htdocs/Modules/Accountancy/supplier/list.php
...
if ($result) {
    ...
    while ($i < min($num_lines, $limit)) {
        ...
        */
        ...
        print $formaccounting->select_account($suggestedid, 'codeventil' . $objp->rowid, 1, [], 0, 0, 'codeventil maxwidth200 maxwidthonsmartphone', 'cachewithshowemptyone');
        print '</td>';
