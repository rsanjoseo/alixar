...
$langs->loadlangs(['errors', 'admin', 'companies', 'website']);
...
$tabhelp = [];
$tabhelp[1] = ['ref' => $langs->trans("EnterAnyCode"), 'virtualhost' => $langs->trans("SetHereVirtualHost", DOL_DATA_ROOT . '/website/<i>websiteref</i>')];
        ...
        if ($resql) {
            ...
            if ($newname != $website->ref) {
                ...
                if (dol_is_dir($destfile)) {
                    ...
                    $arrayreplacement = [$website->ref . '/htmlheader.html' => $newname . '/htmlheader.html'];
