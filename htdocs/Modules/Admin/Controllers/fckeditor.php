...
$langs->loadLangs(['admin', 'fckeditor']);
...
if (empty($conf->use_javascript_ajax)) {
    setEventMessages([$langs->trans("NotAvailable"), $langs->trans("JavascriptDisabled")], null, 'errors');
} else {
    ...
    $listofmodes = ['dolibarr_mailings', 'dolibarr_notes', 'dolibarr_details', 'dolibarr_readonly', 'Full', 'Full_inline'];
    $linkstomode = '';
