...
$langs->loadLangs(['admin', 'other', 'agenda', 'users']);
...
if ($action == 'set') {
    ...
    $result = $defaultValues->fetchAll('', '', 0, 0, ['t.page' => 'comm/action/card.php', 't.param' => 'complete', 't.user_id' => '0', 't.type' => 'createform', 't.entity' => $conf->entity]);
...
print '<td class="center">&nbsp;</td>' . "\n";
print '<td class="right">' . "\n";
$tmplist = ['' => '&nbsp;', 'show_list' => $langs->trans("ViewList"), 'show_month' => $langs->trans("ViewCal"), 'show_week' => $langs->trans("ViewWeek"), 'show_day' => $langs->trans("ViewDay"), 'show_peruser' => $langs->trans("ViewPerUser")];
