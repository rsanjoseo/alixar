...
$langs->loadLangs(["errors", "admin", "main", "companies", "resource", "holiday", "accountancy", "hrm", "orders", "contracts", "projects", "propal", "bills", "interventions", "ticket"]);
...
$taborder = [9, 15, 30, 0, 4, 3, 2, 0, 1, 8, 19, 16, 39, 27, 40, 38, 0, 5, 11, 0, 6, 24, 0, 29, 0, 33, 34, 32, 28, 17, 35, 36, 0, 10, 23, 12, 13, 7, 0, 14, 0, 22, 20, 18, 21, 41, 0, 37, 42, 0, 43, 0, 25, 0];
...
$tabhelp = [];
$tabhelp[1] = ['code' => $langs->trans("EnterAnyCode")];
$tabhelp[2] = ['code' => $langs->trans("EnterAnyCode")];
$tabhelp[3] = ['code' => $langs->trans("EnterAnyCode")];
$tabhelp[4] = ['code' => $langs->trans("EnterAnyCode")];
$tabhelp[5] = ['code' => $langs->trans("EnterAnyCode")];
$tabhelp[6] = ['code' => $langs->trans("EnterAnyCode"), 'color' => $langs->trans("ColorFormat"), 'position' => $langs->trans("PositionIntoComboList")];
$tabhelp[7] = ['code' => $langs->trans("EnterAnyCode")];
$tabhelp[8] = ['code' => $langs->trans("EnterAnyCode"), 'position' => $langs->trans("PositionIntoComboList")];
$tabhelp[9] = ['code' => $langs->trans("EnterAnyCode"), 'unicode' => $langs->trans("UnicodeCurrency")];
$tabhelp[10] = ['code' => $langs->trans("EnterAnyCode"), 'taux' => $langs->trans("SellTaxRate"), 'recuperableonly' => $langs->trans("RecuperableOnly"), 'localtax1_type' => $langs->trans("LocalTaxDesc"), 'localtax2_type' => $langs->trans("LocalTaxDesc")];
$tabhelp[11] = ['code' => $langs->trans("EnterAnyCode"), 'position' => $langs->trans("PositionIntoComboList")];
$tabhelp[12] = ['code' => $langs->trans("EnterAnyCode"), 'type_cdr' => $langs->trans("TypeCdr", $langs->transnoentitiesnoconv("NbOfDays"), $langs->transnoentitiesnoconv("Offset"), $langs->transnoentitiesnoconv("NbOfDays"), $langs->transnoentitiesnoconv("Offset"))];
$tabhelp[13] = ['code' => $langs->trans("EnterAnyCode")];
$tabhelp[14] = ['code' => $langs->trans("EnterAnyCode")];
$tabhelp[15] = ['code' => $langs->trans("EnterAnyCode")];
$tabhelp[16] = ['code' => $langs->trans("EnterAnyCode")];
$tabhelp[17] = ['code' => $langs->trans("EnterAnyCode")];
$tabhelp[18] = ['code' => $langs->trans("EnterAnyCode"), 'tracking' => $langs->trans("UrlTrackingDesc")];
$tabhelp[19] = ['code' => $langs->trans("EnterAnyCode")];
$tabhelp[20] = ['code' => $langs->trans("EnterAnyCode")];
$tabhelp[21] = ['code' => $langs->trans("EnterAnyCode"), 'position' => $langs->trans("PositionIntoComboList")];
$tabhelp[22] = ['code' => $langs->trans("EnterAnyCode")];
$tabhelp[23] = ['revenuestamp_type' => 'FixedOrPercent'];
$tabhelp[24] = ['code' => $langs->trans("EnterAnyCode")];
$tabhelp[25] = ['code' => $langs->trans('EnterAnyCode')];
//$tabhelp[26] = array('code'=>$langs->trans("EnterAnyCode"));
$tabhelp[27] = ['code' => $langs->trans("EnterAnyCode"), 'picto' => $langs->trans("PictoHelp")];
$tabhelp[28] = ['affect' => $langs->trans("FollowedByACounter"), 'delay' => $langs->trans("MinimumNoticePeriod"), 'newByMonth' => $langs->trans("NbAddedAutomatically")];
$tabhelp[29] = ['code' => $langs->trans("EnterAnyCode"), 'percent' => $langs->trans("OpportunityPercent"), 'position' => $langs->trans("PositionIntoComboList")];
$tabhelp[30] = ['code' => $langs->trans("EnterAnyCode"), 'name' => $langs->trans("LabelName"), 'paper_size' => $langs->trans("LabelPaperSize")];
//$tabhelp[31] = array('pcg_version'=>$langs->trans("EnterAnyCode"));
$tabhelp[32] = ['code' => $langs->trans("EnterAnyCode"), 'dayrule' => "Keep empty for a date defined with month and day (most common case).<br>Use a keyword like 'easter', 'eastermonday', ... for a date predefined by complex rules.", 'country' => $langs->trans("CountryIfSpecificToOneCountry"), 'year' => $langs->trans("ZeroMeansEveryYear")];
$tabhelp[33] = ['code' => $langs->trans("EnterAnyCode")];
$tabhelp[34] = ['code' => $langs->trans("EnterAnyCode")];
$tabhelp[35] = [];
$tabhelp[36] = ['range_ik' => $langs->trans('PrevRangeToThisRange')];
$tabhelp[37] = ['code' => $langs->trans("EnterAnyCode"), 'unit_type' => $langs->trans('MeasuringUnitTypeDesc'), 'scale' => $langs->trans('MeasuringScaleDesc')];
$tabhelp[38] = ['code' => $langs->trans("EnterAnyCode"), 'url' => $langs->trans('UrlSocialNetworksDesc'), 'icon' => $langs->trans('FafaIconSocialNetworksDesc')];
$tabhelp[39] = ['code' => $langs->trans("EnterAnyCode")];
$tabhelp[40] = ['code' => $langs->trans("EnterAnyCode"), 'picto' => $langs->trans("PictoHelp")];
$tabhelp[41] = ['code' => $langs->trans("EnterAnyCode")];
$tabhelp[42] = ['code' => $langs->trans("EnterAnyCode")];
$tabhelp[43] = ['code' => $langs->trans("EnterAnyCode")];

// Table to store complete informations (will replace all other table). Key is table name.
$tabcomplete = [
    'c_forme_juridique' => ['picto' => 'company'],
    'c_departements' => ['picto' => 'state'],
    'c_regions' => ['picto' => 'region'],
    'c_country' => ['picto' => 'country'],
    'c_civility' => ['picto' => 'contact'],
    'c_actioncomm' => ['picto' => 'action'],
    'c_chargesociales' => ['picto' => 'bill'],
    'c_typent' => ['picto' => 'company'],
    'c_currencies' => ['picto' => 'multicurrency'],
    'c_tva' => ['picto' => 'bill'],
    'c_type_contact' => ['picto' => 'contact'],
    'c_payment_term' => ['picto' => 'bill'],
    'c_paiement' => ['picto' => 'bill'],
    'c_ecotaxe' => ['picto' => 'bill'],
    'c_paper_format' => ['picto' => 'generic'],
    'c_prospectlevel' => ['picto' => 'company'],
    'c_type_fees' => ['picto' => 'trip'],
    'c_effectif' => ['picto' => 'company'],
    'c_input_method' => ['picto' => 'order'],
    'c_input_reason' => ['picto' => 'order'],
    'c_availability' => ['picto' => 'shipment'],
    'c_shipment_mode' => ['picto' => 'shipment'],
    'c_revenuestamp' => ['picto' => 'bill'],
    'c_type_resource' => ['picto' => 'resource'],
    'c_type_container' => ['picto' => 'website'],
    'c_stcomm' => ['picto' => 'company'],
    'c_holiday_types' => ['picto' => 'holiday'],
    'c_lead_status' => ['picto' => 'project'],
    'c_format_cards' => ['picto' => 'generic'],
    'c_hrm_public_holiday' => ['picto' => 'holiday'],
    'c_hrm_department' => ['picto' => 'hrm'],
    'c_hrm_function' => ['picto' => 'hrm'],
    'c_exp_tax_cat' => ['picto' => 'expensereport'],
    'c_exp_tax_range' => ['picto' => 'expensereport'],
    'c_units' => ['picto' => 'product'],
    'c_socialnetworks' => ['picto' => 'share-alt'],
    'c_product_nature' => ['picto' => 'product'],
    'c_transport_mode' => ['picto' => 'incoterm'],
    'c_prospectcontactlevel' => ['picto' => 'company'],
    'c_stcommcontact' => ['picto' => 'company'],
    'c_product_nature' => ['picto' => 'product'],
    'c_productbatch_qcstatus' => ['picto' => 'lot'],
...
if (GETPOST('actionadd') || GETPOST('actionmodify')) {
    ...
    foreach ($listfield as $f => $value) {
        ...
        if ($value == 'country_id' && in_array($tablib[$id], ['DictionaryPublicHolidays', 'DictionaryVAT', 'DictionaryRegion', 'DictionaryCompanyType', 'DictionaryHolidayTypes', 'DictionaryRevenueStamp', 'DictionaryAccountancysystem', 'DictionaryAccountancyCategory'])) {
            continue; // For some pages, country is not mandatory
        }
        if ($value == 'country' && in_array($tablib[$id], ['DictionaryPublicHolidays', 'DictionaryCanton', 'DictionaryCompanyType', 'DictionaryHolidayTypes', 'DictionaryRevenueStamp'])) {
            continue; // For some pages, country is not mandatory
        }
        ...
        if ((!GETPOSTISSET($value) || GETPOST($value) == '')
            && (!in_array($value, ['decalage', 'module', 'accountancy_code', 'accountancy_code_sell', 'accountancy_code_buy', 'tracking', 'picto'])  // Fields that are not mandatory
    ...
    // Other checks
    if (GETPOST('actionadd') && $tabname[$id] == MAIN_DB_PREFIX . "c_actioncomm" && GETPOSTISSET("type") && in_array(GETPOST("type"), ['system', 'systemauto'])) {
        $ok = 0;
    ...
    if (GETPOSTISSET("country") && (GETPOST("country") == '0') && ($id != 2)) {
        if (in_array($tablib[$id], ['DictionaryCompanyType', 'DictionaryHolidayTypes'])) {    // Field country is no mandatory for such dictionaries
            $_POST["country"] = '';
        } else {
            $ok = 0;
    ...
    if ($ok && GETPOST('actionadd')) {
        ...
        foreach ($listfieldinsert as $f => $value) {
            ...
            } elseif (in_array($keycode, ['joinfile', 'private', 'pos', 'position', 'scale', 'use_default'])) {
...
if ($id) {
    ...
    if ($resql) {
        ...
        foreach ($fieldlist as $field => $value) {
            ...
            if (in_array($value, ['label', 'libelle', 'libelle_facture']) && empty($tabhelp[$id][$value])) {
        ...
        if ($num) {
            ...
            while ($i < $num) {
                ...
                if ($action == 'edit' && ($rowid == (!empty($obj->rowid) ? $obj->rowid : $obj->code))) {
                    ...
                    if (empty($reshook)) {
                        ...
                        foreach ($fieldlist as $field => $value) {
                            ...
                            if ($value == 'private') {
                                ...
                                $payment_type_list = [0 => $langs->trans('PaymentTypeCustomer'), 1 => $langs->trans('PaymentTypeSupplier'), 2 => $langs->trans('PaymentTypeBoth')];
                            ...
                            if (in_array($value, ['localtax1_type', 'localtax2_type'])) {
                                $class .= ' nowrap';
                            }
                            if (in_array($value, ['use_default', 'fk_parent'])) {
                                $class .= ' center';
                            }
                            if ($value == 'public') {
                                $class .= ' center';
                    ...
                    if ($id == 25 && in_array($obj->code, ['banner', 'blogpost', 'other', 'page'])) {
                        $iserasable = 0;
                        $canbedisabled = 0;
                        if (in_array($obj->code, ['banner'])) {
                            $canbedisabled = 1;
                        }
                    }
                    if (isset($obj->type) && in_array($obj->type, ['system', 'systemauto'])) {
                        $iserasable = 0;
                    }
                    if (in_array(empty($obj->code) ? '' : $obj->code, ['AC_OTH', 'AC_OTH_AUTO']) || in_array(empty($obj->type) ? '' : $obj->type, ['systemauto'])) {
                        $canbedisabled = 0;
                        $canbedisabled = 0;
                    }
                    ...
                    if (empty($rowidcol) || in_array($id, [6, 7, 8, 13, 17, 19, 27, 32])) {
                        $rowidcol = 'rowid';
                    }
                    ...
                    if ($canbedisabled) {
                        ...
                        if (in_array($obj->code, ['AC_OTH', 'AC_OTH_AUTO'])) {
                            print $langs->trans("AlwaysActive");
                        } elseif (isset($obj->type) && in_array($obj->type, ['systemauto']) && empty($obj->active)) {
                            print $langs->trans("Deprecated");
                        } elseif (isset($obj->type) && in_array($obj->type, ['system']) && !empty($obj->active) && $obj->code != 'AC_OTH') {
...
function fieldList($fieldlist, $obj = '', $tabname = '', $context = '')
{
    ...
    foreach ($fieldlist as $field => $value) {
        ...
        if (in_array($value, ['code', 'libelle', 'type']) && $tabname == MAIN_DB_PREFIX . "c_actioncomm" && in_array($obj->type, ['system', 'systemauto'])) {
            ...
            print '</td>';
        } elseif (in_array($value, ['public', 'use_default'])) {
            ...
            print '<td>';
            $select_list = [0 => $langs->trans('PaymentTypeCustomer'), 1 => $langs->trans('PaymentTypeSupplier'), 2 => $langs->trans('PaymentTypeBoth')];
            ...
            if ($value == 'type_cdr') {
                print $form->selectarray($value, [0 => $langs->trans('None'), 1 => $langs->trans('AtEndOfMonth'), 2 => $langs->trans('CurrentNext')], (!empty($obj->{$value}) ? $obj->{$value} : ''));
            } else {
                print $form->selectyesno($value, (!empty($obj->{$value}) ? $obj->{$value} : ''), 1);
            }
            print '</td>';
        } elseif (in_array($value, ['nbjour', 'decalage', 'taux', 'localtax1', 'localtax2'])) {
            $class = "left";
            if (in_array($value, ['taux', 'localtax1', 'localtax2'])) {
            ...
            print '</td>';
        } elseif (in_array($value, ['libelle_facture'])) {
            print '<td>';
            $transfound = 0;
            $transkey = '';
            ...
            if (in_array($fieldlist[$field], ['pos', 'position'])) {
                $classtd = 'right';
                $class = 'maxwidth50 right';
            }
            if (in_array($fieldlist[$field], ['dayrule', 'day', 'month', 'year', 'use_default', 'affect', 'delay', 'public', 'sortorder', 'sens', 'category_type', 'fk_parent'])) {
                $class = 'maxwidth50 center';
            }
            if (in_array($fieldlist[$field], ['use_default', 'public', 'fk_parent'])) {
                $classtd = 'center';
            }
            if (in_array($fieldlist[$field], ['libelle', 'label', 'tracking'])) {
            ...
            $transfound = 0;
            $transkey = '';
            if (in_array($fieldlist[$field], ['label', 'libelle'])) {        // For label
                // Special case for labels
