...
$hookmanager->initHooks(['moduleoverview']);
$form = new Form($db);
$object = new stdClass();

// Definition of fields for lists
$arrayfields = [
    'name' => ['label' => $langs->trans("Modules"), 'checked' => 1, 'position' => 10],
    'version' => ['label' => $langs->trans("Version"), 'checked' => 1, 'position' => 20],
    'id' => ['label' => $langs->trans("IdModule"), 'checked' => 1, 'position' => 30],
    'module_position' => ['label' => $langs->trans("Position"), 'checked' => 1, 'position' => 35],
    'permission' => ['label' => $langs->trans("IdPermissions"), 'checked' => 1, 'position' => 40],
];
