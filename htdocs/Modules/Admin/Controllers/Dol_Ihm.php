...
$langs->loadLangs(['admin', 'languages', 'other', 'companies', 'products', 'members', 'projects', 'hrm', 'agenda']);
...
if ($mode == 'dashboard') {
    ...
    $substitutionarray = getCommonSubstitutionArray($langs, 0, ['object', 'objectamount']);
    ...
    */
    ...
    print ajax_constantonoff("MAIN_DISABLE_GLOBAL_WORKBOARD", [], $conf->entity, 0, 0, 1, 0, 0, 0, '_red', 'dashboard');
    print '</td>';
    print '</tr>';
    ...
    if (empty($conf->global->MAIN_DISABLE_GLOBAL_WORKBOARD)) {
        ...
        print ajax_constantonoff("MAIN_DISABLE_METEO", [], $conf->entity, 0, 0, 1, 0, 0, 0, '_red', 'dashboard');
        print '</td>';
        print '</tr>';

        // Block agenda
        print '<tr class="oddeven"><td>' . $langs->trans('DashboardDisableBlockAgenda') . '</td><td>';
        print ajax_constantonoff("MAIN_DISABLE_BLOCK_AGENDA", [], $conf->entity, 0, 0, 1, 0, 0, 0, '_red', 'dashboard');
        print '</td>';
        print '</tr>';

        // Block agenda
        print '<tr class="oddeven"><td>' . $langs->trans('DashboardDisableBlockProject') . '</td><td>';
        print ajax_constantonoff("MAIN_DISABLE_BLOCK_PROJECT", [], $conf->entity, 0, 0, 1, 0, 0, 0, '_red', 'dashboard');
        print '</td>';
        print '</tr>';

        // Block customer
        print '<tr class="oddeven"><td>' . $langs->trans('DashboardDisableBlockCustomer') . '</td><td>';
        print ajax_constantonoff("MAIN_DISABLE_BLOCK_CUSTOMER", [], $conf->entity, 0, 0, 1, 0, 0, 0, '_red', 'dashboard');
        print '</td>';
        print '</tr>';

        // Block supplier
        print '<tr class="oddeven"><td>' . $langs->trans('DashboardDisableBlockSupplier') . '</td><td>';
        print ajax_constantonoff("MAIN_DISABLE_BLOCK_SUPPLIER", [], $conf->entity, 0, 0, 1, 0, 0, 0, '_red', 'dashboard');
        print '</td>';
        print '</tr>';

        // Block contract
        print '<tr class="oddeven"><td>' . $langs->trans('DashboardDisableBlockContract') . '</td><td>';
        print ajax_constantonoff("MAIN_DISABLE_BLOCK_CONTRACT", [], $conf->entity, 0, 0, 1, 0, 0, 0, '_red', 'dashboard');
        print '</td>';
        print '</tr>';

        // Block ticket
        print '<tr class="oddeven"><td>' . $langs->trans('DashboardDisableBlockTicket') . '</td><td>';
        print ajax_constantonoff("MAIN_DISABLE_BLOCK_TICKET", [], $conf->entity, 0, 0, 1, 0, 0, 0, '_red', 'dashboard');
        print '</td>';
        print '</tr>';

        // Block bank
        print '<tr class="oddeven"><td>' . $langs->trans('DashboardDisableBlockBank') . '</td><td>';
        print ajax_constantonoff("MAIN_DISABLE_BLOCK_BANK", [], $conf->entity, 0, 0, 1, 0, 0, 0, '_red', 'dashboard');
        print '</td>';
        print '</tr>';

        // Block adherent
        print '<tr class="oddeven"><td>' . $langs->trans('DashboardDisableBlockAdherent') . '</td><td>';
        print ajax_constantonoff("MAIN_DISABLE_BLOCK_ADHERENT", [], $conf->entity, 0, 0, 1, 0, 0, 0, '_red', 'dashboard');
        print '</td>';
        print '</tr>';

        // Block expense report
        print '<tr class="oddeven"><td>' . $langs->trans('DashboardDisableBlockExpenseReport') . '</td><td>';
        print ajax_constantonoff("MAIN_DISABLE_BLOCK_EXPENSEREPORT", [], $conf->entity, 0, 0, 1, 0, 0, 0, '_red', 'dashboard');
        print '</td>';
        print '</tr>';

        // Block holiday
        print '<tr class="oddeven"><td>' . $langs->trans('DashboardDisableBlockHoliday') . '</td><td>';
        print ajax_constantonoff("MAIN_DISABLE_BLOCK_HOLIDAY", [], $conf->entity, 0, 0, 1, 0, 0, 0, '_red', 'dashboard');
        print '</td>';
        print '</tr>';
    }
...
if ($mode == 'other') {
    ...
    print ajax_constantonoff("MAIN_MULTILANGS", [], $conf->entity, 0, 0, 1, 0, 0, 0, '', 'language');
    print '</td>';
    print '</tr>';
    ...
    $array = [0 => $langs->trans("Firstname") . ' ' . $langs->trans("Lastname"), 1 => $langs->trans("Lastname") . ' ' . $langs->trans("Firstname")];
    ...
    print ajax_constantonoff("MAIN_MENU_HIDE_UNAUTHORIZED", [], $conf->entity, 0, 0, 1, 0, 0, 0, '', 'other');
    print '</td>';
    print '<td width="20">&nbsp;</td>';
    print '</tr>';
    ...
    print ajax_constantonoff("MAIN_BUTTON_HIDE_UNAUTHORIZED", [], $conf->entity, 0, 0, 1, 0, 0, 0, '', 'other');
    print '</td>';
    print '<td width="20">&nbsp;</td>';
    print '</tr>';
    ...
    */
    ...
    print ajax_constantonoff("MAIN_HELP_DISABLELINK", [], $conf->entity, 0, 0, 1, 0, 0, 0, '', 'other');
    ...
    print ajax_constantonoff("MAIN_DISABLE_JAVASCRIPT", [], $conf->entity, 0, 0, 1, 0, 0, 0, '', 'other');
...
if ($mode == 'login') {
    ...
    print ajax_constantonoff("MAIN_HELPCENTER_DISABLELINK", [], $conf->entity, 0, 0, 0, 0, 0, 0, '', 'login');
    print '</td>';
    print '</tr>';

    // Message on login page
    $substitutionarray = getCommonSubstitutionArray($langs, 0, ['object', 'objectamount', 'user']);
    complete_substitutions_array($substitutionarray, $langs);
    print '<tr class="oddeven"><td>';
    $texthelp = $langs->trans("FollowingConstantsWillBeSubstituted") . '<br>';
    foreach ($substitutionarray as $key => $val) {
