...
$langs->loadLangs(['users', 'admin', 'other']);
...
if ($action == 'updateform') {
    ...
    $antivircommand = dol_string_nospecial($antivircommand, '', ["|", ";", "<", ">", "&"]); // Sanitize command
    $antivirparam = dol_string_nospecial($antivirparam, '', ["|", ";", "<", ">", "&"]); // Sanitize params
