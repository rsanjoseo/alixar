    ...
    if ($base == 1) {
        ...
        if ($resql) {
            ...
            while ($i < $num) {
                ...
                if (isset($obj->Row_format) && (in_array($obj->Row_format, ["Compact"]))) {
                ...
                if (isset($obj->Collation) && (in_array($obj->Collation, ["utf8mb4_general_ci", "utf8mb4_unicode_ci", "latin1_swedish_ci"]))) {
