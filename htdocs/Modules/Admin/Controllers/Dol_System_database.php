...
$arraylist = ['listofvars', 'listofstatus'];
...
if (!count($listofvars) && !count($listofstatus)) {
    ...
    foreach ($arraylist as $listname) {
        ...
        if (preg_match('/mysql/i', $db->type)) {
            $arraytest = [
                'character_set_database' => ['var' => 'dolibarr_main_db_character_set', 'valifempty' => 'utf8'],
                'collation_database' => ['var' => 'dolibarr_main_db_collation', 'valifempty' => 'utf8_unicode_ci'],
            ];
        }
