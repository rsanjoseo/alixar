...
if ($action == 'edit') {
    ...
    // ID
    if (!empty($conf->use_javascript_ajax) || (isset($conf->global->MAIN_MAIL_SENDMODE_TICKET) && in_array($conf->global->MAIN_MAIL_SENDMODE_TICKET, ['smtps', 'swiftmailer']))) {
    ...
    if (!empty($conf->global->MAIN_MAIL_SENDMODE_TICKET) && $conf->global->MAIN_MAIL_SENDMODE_TICKET != 'default') {
        ...
        // SMTPS ID
        if (isset($conf->global->MAIN_MAIL_SENDMODE_TICKET) && in_array($conf->global->MAIN_MAIL_SENDMODE_TICKET, ['smtps', 'swiftmailer'])) {
    ...
    if ($conf->global->MAIN_MAIL_SENDMODE_TICKET == 'mail' && !in_array($action, ['testconnect', 'test', 'testhtml'])) {
