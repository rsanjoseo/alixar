 ...
 *
 * It is used until the migration to objects is complete, to be used from the
 * obsolete non-object-oriented controllers.
 *
 * @package    Alxarafe\Modules\Admin\Controllers
 *
 * @deprecated Use only for non-object-oriented controllers
 */
class NullController extends DolibarrController
{
