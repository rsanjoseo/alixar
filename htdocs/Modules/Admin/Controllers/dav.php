...
$langs->loadLangs(["admin", "other", "agenda"]);
...
$arrayofparameters = [
    'DAV_RESTICT_ON_IP' => ['css' => 'minwidth200', 'enabled' => 1],
    'DAV_ALLOW_PRIVATE_DIR' => ['css' => 'minwidth200', 'enabled' => 2],
    'DAV_ALLOW_PUBLIC_DIR' => ['css' => 'minwidth200', 'enabled' => 1],
    'DAV_ALLOW_ECM_DIR' => ['css' => 'minwidth200', 'enabled' => $conf->ecm->enabled],
];
