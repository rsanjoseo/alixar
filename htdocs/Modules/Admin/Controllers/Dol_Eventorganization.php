...
// Translations
$langs->loadLangs(["admin", "eventorganization"]);
...
$arrayofparameters = [
    'EVENTORGANIZATION_TASK_LABEL' => ['type' => 'textarea', 'enabled' => 1],
    'EVENTORGANIZATION_CATEG_THIRDPARTY_CONF' => ['type' => 'category:' . Categorie::TYPE_CUSTOMER, 'enabled' => 1],
    'EVENTORGANIZATION_CATEG_THIRDPARTY_BOOTH' => ['type' => 'category:' . Categorie::TYPE_CUSTOMER, 'enabled' => 1],
    'EVENTORGANIZATION_FILTERATTENDEES_CAT' => ['type' => 'category:' . Categorie::TYPE_CUSTOMER, 'enabled' => 1],
    'EVENTORGANIZATION_FILTERATTENDEES_TYPE' => ['type' => 'thirdparty_type:', 'enabled' => 1],
    'EVENTORGANIZATION_TEMPLATE_EMAIL_ASK_CONF' => ['type' => 'emailtemplate:conferenceorbooth', 'enabled' => 1],
    'EVENTORGANIZATION_TEMPLATE_EMAIL_ASK_BOOTH' => ['type' => 'emailtemplate:conferenceorbooth', 'enabled' => 1],
    'EVENTORGANIZATION_TEMPLATE_EMAIL_AFT_SUBS_BOOTH' => ['type' => 'emailtemplate:conferenceorbooth', 'enabled' => 1],
    'EVENTORGANIZATION_TEMPLATE_EMAIL_AFT_SUBS_EVENT' => ['type' => 'emailtemplate:conferenceorbooth', 'enabled' => 1],
    'EVENTORGANIZATION_TEMPLATE_EMAIL_BULK_SPEAKER' => ['type' => 'emailtemplate:conferenceorbooth', 'enabled' => 1],
    'EVENTORGANIZATION_TEMPLATE_EMAIL_BULK_ATTENDES' => ['type' => 'emailtemplate:conferenceorbooth', 'enabled' => 1],
    'EVENTORGANIZATION_SECUREKEY' => ['type' => 'securekey', 'enabled' => 1],
    'SERVICE_BOOTH_LOCATION' => ['type' => 'product', 'enabled' => 1],
    'SERVICE_CONFERENCE_ATTENDEE_SUBSCRIPTION' => ['type' => 'product', 'enabled' => 1],
];
...
if ($action == 'updateMask') {
    ...
    foreach ($dirmodels as $reldir) {
        $file = dol_buildpath($reldir . "'Modules/Eventorganization/doc/pdf_" . $modele . "_" . strtolower($tmpobjectkey) . ".modules.php", 0);
        if (file_exists($file)) {
            $filefound = 1;
