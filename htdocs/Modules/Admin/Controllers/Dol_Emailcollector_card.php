...
$langs->loadLangs(["admin", "mails", "other"]);
...
$hookmanager->initHooks(['emailcollectorcard']); // Note that conf->hooks_modules contains array
...
if (GETPOST('addoperation', 'alpha')) {
    ...
    if (in_array($emailcollectoroperation->type, ['loadthirdparty', 'loadandcreatethirdparty'])
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create'))) {
    ...
    */
    ...
    print '<td>';
    $arrayoftypes = [
        'from' => ['label' => 'MailFrom', 'data-placeholder' => $langs->trans('SearchString')],
        'to' => ['label' => 'MailTo', 'data-placeholder' => $langs->trans('SearchString')],
        'cc' => ['label' => 'Cc', 'data-placeholder' => $langs->trans('SearchString')],
        'bcc' => ['label' => 'Bcc', 'data-placeholder' => $langs->trans('SearchString')],
        'subject' => ['label' => 'Subject', 'data-placeholder' => $langs->trans('SearchString')],
        'body' => ['label' => 'Body', 'data-placeholder' => $langs->trans('SearchString')],
        ...
        'X2' => '---',
        'seen' => ['label' => 'AlreadyRead', 'data-noparam' => 1],
        'unseen' => ['label' => 'NotRead', 'data-noparam' => 1],
        'unanswered' => ['label' => 'Unanswered', 'data-noparam' => 1],
        'answered' => ['label' => 'Answered', 'data-noparam' => 1],
        'smaller' => ['label' => 'SmallerThan', 'data-placeholder' => $langs->trans('NumberOfBytes')],
        'larger' => ['label' => 'LargerThan', 'data-placeholder' => $langs->trans('NumberOfBytes')],
        'X3' => '---',
        'withtrackingid' => ['label' => 'WithDolTrackingID', 'data-noparam' => 1],
        'withouttrackingid' => ['label' => 'WithoutDolTrackingID', 'data-noparam' => 1],
        'withtrackingidinmsgid' => ['label' => 'WithDolTrackingIDInMsgId', 'data-noparam' => 1],
        'withouttrackingidinmsgid' => ['label' => 'WithoutDolTrackingIDInMsgId', 'data-noparam' => 1],
        'X4' => '---',
        'isnotanswer' => ['label' => 'IsNotAnAnswer', 'data-noparam' => 1],
        'isanswer' => ['label' => 'IsAnAnswer', 'data-noparam' => 1],
    ];
    ...
    $parameters = ['arrayoftypes' => $arrayoftypes];
    ...
    foreach ($object->actions as $ruleaction) {
        ...
        if (in_array($ruleaction['type'], ['recordevent'])) {
            print $form->textwithpicto('', $langs->transnoentitiesnoconv('IfTrackingIDFoundEventWillBeLinked'));
        } elseif (in_array($ruleaction['type'], ['loadthirdparty', 'loadandcreatethirdparty'])) {
