...
$langs->loadLangs(["admin", "workflow", "propal", "workflow", "orders", "supplier_proposal", "receptions", "errors", 'sendings']);
...
$workflowcodes = [
    ...
    'separator1' => ['family' => 'separator', 'position' => 25, 'title' => ''],
    ...
    'WORKFLOW_ORDER_CLASSIFY_SHIPPED_SHIPPING' => [  // when shipping validated
                                                     'family' => 'classify_order',
                                                     'position' => 40,
                                                     'enabled' => (!empty($conf->expedition->enabled) && !empty($conf->commande->enabled)),
                                                     'picto' => 'order',
    ],
    'WORKFLOW_ORDER_CLASSIFY_SHIPPED_SHIPPING_CLOSED' => [ // when shipping closed
                                                           'family' => 'classify_order',
                                                           'position' => 41,
                                                           'enabled' => (!empty($conf->expedition->enabled) && !empty($conf->commande->enabled)),
                                                           'picto' => 'order',
    ...
    'separator2' => ['family' => 'separator', 'position' => 50],
