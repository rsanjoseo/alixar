...
if ($action == 'edit') {
    ...
    // ID
    if (!empty($conf->use_javascript_ajax) || (isset($conf->global->MAIN_MAIL_SENDMODE_EMAILING) && in_array($conf->global->MAIN_MAIL_SENDMODE_EMAILING, ['smtps', 'swiftmailer']))) {
    ...
    if (!empty($conf->global->MAIN_MAIL_SENDMODE_EMAILING) && $conf->global->MAIN_MAIL_SENDMODE_EMAILING != 'default') {
        ...
        // SMTPS ID
        if (isset($conf->global->MAIN_MAIL_SENDMODE_EMAILING) && in_array($conf->global->MAIN_MAIL_SENDMODE_EMAILING, ['smtps', 'swiftmailer'])) {
    ...
    if ($conf->global->MAIN_MAIL_SENDMODE_EMAILING == 'mail' && !in_array($action, ['testconnect', 'test', 'testhtml'])) {
