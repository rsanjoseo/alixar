...
$langs->loadLangs(['admin', 'errors', 'other', 'bills']);
...
_printInputFormPart($confkey, $langs->trans('AllowedInvoiceForRetainedWarranty'), '', [], $formSelectInvoiceType);
 ...
 * @return void
 */
function _printInputFormPart($confkey, $title = false, $desc = '', $metas = [], $type = 'input', $help = false)
{
