...
class Dolistore
{
    ...
    public function __construct($debug = false)
    {
        ...
        $lang = $langtmp[0];
        $lang_array = ['en' => 1, 'fr' => 2, 'es' => 3, 'it' => 4, 'de' => 5]; // Into table ps_lang of Prestashop - 1
     ...
     * @return    void
     */
    public function getRemoteProducts($options = ['start' => 0, 'end' => 10, 'per_page' => 50, 'categorie' => 0, 'search' => ''])
    {
        global $conf;
