                    ...
                    <tr>
                        ...
                        <td class="right">
                            <?php if ($user->rights->societe->creer) { ?>
                                <a href="<?php echo DOL_URL_ROOT . '/Modules/Societes/paymentmodes.php?socid=' . $this->control->tpl['id']; ?>"><?php echo $this->control->tpl['image_edit']; ?></a>
                            <?php } else { ?>
                                &nbsp;
                            <?php } ?>
                        </td>
            ...
            <td>
                <table class="nobordernopadding allwidth">
                    <tr>
                        ...
                        <td class="right">
                            <?php if ($user->rights->societe->creer) { ?>
                                <a href="<?php echo DOL_URL_ROOT . '/Modules/Societes/commerciaux.php?socid=' . $this->control->tpl['id']; ?>"><?php echo $this->control->tpl['image_edit']; ?></a>
                            <?php } else { ?>
                                &nbsp;
                            <?php } ?>
                        </td>
