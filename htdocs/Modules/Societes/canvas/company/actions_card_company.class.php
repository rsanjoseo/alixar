 ...
 */
include_once DOL_DOCUMENT_ROOT . '/Modules/Societes/canvas/actions_card_common.class.php';
...
class ActionsCardCompany extends ActionsCardCommon
{
    ...
    public function assign_values(&$action, $id = 0, $ref = '')
    {
        ...
        if ($conf->use_javascript_ajax && empty($conf->global->MAIN_DISABLEVATCHECK)) {
            ...
            $js .= "newpopup('" . DOL_URL_ROOT . "/Modules/Societes/checkvat/checkVatPopup.php?vatNumber='+a,'" . dol_escape_js($langs->trans("VATIntraCheckableOnEUSite")) . "',500,230);\n";
            $js .= "}\n";
            $js .= '</script>';
            $js .= "\n";
