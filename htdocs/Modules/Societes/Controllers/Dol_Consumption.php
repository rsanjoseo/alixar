...
$langs->loadLangs(["companies", "bills", "orders", "suppliers", "propal", "interventions", "contracts", "products"]);

// Initialize technical object to manage hooks of page. Note that conf->hooks_modules contains array of hook context
$hookmanager->initHooks(['consumptionthirdparty']);
...
if ($sql_select) {
    ...
    while (($objp = $db->fetch_object($resql)) && $i < min($num, $limit)) {
        ...
        if (($objp->info_bits & 2) == 2) { ?>
            <a href="<?php echo DOL_URL_ROOT . '/Modules/Comm/remx.php?id=' . $object->id; ?>">
                <?php
                $txt = '';
