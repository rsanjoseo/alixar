...
$hookmanager->initHooks(['projectthirdparty']);
...
if ($socid) {
    ...
    $newcardbutton = dolGetButtonTitle($langs->trans("NewProject"), '', 'fa fa-plus-circle', DOL_URL_ROOT . '/Modules/Projects/card.php?action=create&socid=' . $object->id . '&backtopageforcancel=' . urlencode($backtopage), '', 1, $params);
