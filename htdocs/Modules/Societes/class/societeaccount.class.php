...
class SocieteAccount extends CommonObject
{
    ...
    public $fields = [
        ...
        'pass_crypted' => ['type' => 'varchar(128)', 'label' => 'Password', 'visible' => 1, 'enabled' => 1, 'position' => 31, 'notnull' => 1],
        'pass_temp' => ['type' => 'varchar(128)', 'label' => 'Temp', 'visible' => 0, 'enabled' => 0, 'position' => 32, 'notnull' => -1,],
        'fk_soc' => ['type' => 'integer:Societe:societe/class/societe.class.php', 'label' => 'ThirdParty', 'visible' => 1, 'enabled' => 1, 'position' => 40, 'notnull' => -1, 'index' => 1],
        'fk_website' => ['type' => 'integer:Website:website/class/website.class.php', 'label' => 'WebSite', 'visible' => 1, 'enabled' => 1, 'position' => 42, 'notnull' => -1, 'index' => 1],
        'site' => ['type' => 'varchar(128)', 'label' => 'ExternalSite', 'visible' => 0, 'enabled' => 1, 'position' => 43, 'help' => 'Name of the website or service if this is account on an external website or service'],
        ...
        'note_private' => ['type' => 'text', 'label' => 'NotePrivate', 'visible' => -1, 'enabled' => 1, 'position' => 46, 'notnull' => -1,],
