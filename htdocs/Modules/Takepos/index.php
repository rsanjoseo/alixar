...
?>
    <script type="text/javascript"
            src="js/jquery.colorbox-min.js"></script>    <!-- TODO It seems we don't need this -->
        ...
        */
        ...
        function MoreProducts(moreorless) {
            ...
            $.getJSON('<?php echo DOL_URL_ROOT ?>/takepos/ajax/ajax.php?action=getProducts&category=' + currentcat, function (data) {
                ...
                idata =<?php echo($MAXPRODUCT - 2); ?> *
                pageproducts; //product data counter
                ishow = 0; //product to show counter
        ...
        function FreeZone() {
            ...
            $.colorbox({
                href: "freezone.php?action=freezone&place=" + place,
                width: "80%",
                height: "200px",
                transition: "none",
                iframe: "true",
    ...
    <div class="container">
                    ...
                    <div class="topnav-right">
                        <div class="login_block_other">
                            <input type="text" id="search" name="search"
                                   onkeyup="Search2(<?php echo $keyCodeForEnter; ?>);"
                                   placeholder="<?php echo $langs->trans("Search"); ?>" autofocus>
                            <a onclick="ClearSearch();"><span class="fa fa-backspace"></span></a>
                            <a onclick="window.location.href='<?php echo DOL_URL_ROOT . '/'; ?>';"><span
                                        class="fas fa-home"></span></a>
                            <?php if (empty($conf->dol_use_jmobile)) { ?>
                                <a class="hideonsmartphone" onclick="FullScreen();"><span
                                            class="fa fa-expand-arrows-alt"></span></a>
                            <?php } ?>
                        </div>
                        <div class="login_block_user">
                            <?php
                            print top_menu_user(1, DOL_URL_ROOT . '/Modules/Users/logout.php');
                            ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <button type="button" class="block"
                            onclick="location.href='index.php?setterminal=1'"><?php print $langs->trans("Terminal"); ?>1
                    </button>
                    <?php
        ...
        <div class="row1<?php if (empty($conf->global->TAKEPOS_HIDE_HEAD_BAR)) {
            ...
            $menus[$r++] = ['title' => '<span class="fa fa-percent paddingrightonly"></span><div class="trunc">' . $langs->trans("Reduction") . '</div>', 'action' => 'Reduction();'];
            ...
            if (!empty($conf->global->TAKEPOS_HIDE_HEAD_BAR)) {
                $menus[$r++] = ['title' => '<span class="fa fa-sign-out-alt paddingrightonly"></span><div class="trunc">' . $langs->trans("Logout") . '</div>', 'action' => 'window.location.href=\'' . DOL_URL_ROOT . '/Modules/Users/logout.php\';'];
            }
