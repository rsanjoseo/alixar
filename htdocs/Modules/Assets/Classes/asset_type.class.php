...
class AssetType extends CommonObject
{
    ...
    public $fields = [
        ...
        'tms' => ['type' => 'timestamp', 'label' => 'DateModification', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 20],
        'label' => ['type' => 'varchar(50)', 'label' => 'Label', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 25, 'showoncombobox' => 1],
        'accountancy_code_asset' => ['type' => 'varchar(32)', 'label' => 'Accountancy code asset', 'enabled' => 1, 'visible' => -1, 'position' => 30],
        'accountancy_code_depreciation_asset' => ['type' => 'varchar(32)', 'label' => 'Accountancy code depreciation asset', 'enabled' => 1, 'visible' => -1, 'position' => 35],
        'accountancy_code_depreciation_expense' => ['type' => 'varchar(32)', 'label' => 'Accountancy code depreciation expense', 'enabled' => 1, 'visible' => -1, 'position' => 40],
        'note' => ['type' => 'mediumtext', 'label' => 'Note', 'enabled' => 1, 'visible' => -1, 'position' => 45],
    ];
