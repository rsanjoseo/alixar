...
$hookmanager->initHooks(['EditorRatelist', 'globallist']);
...
$arrayfields = [
    'cr.date_sync' => ['label' => 'Date', 'checked' => 1],
    'cr.rate' => ['label' => 'Rate', 'checked' => 1],
    'm.code' => ['label' => 'Code', 'checked' => 1],
];
...
if (!in_array($action, ["updateRate", "deleteRate"])) {
