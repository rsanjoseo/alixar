...
function moPrepareHead($object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Mrp/mo_card.php?id=' . $object->id;
    $head[$h][1] = $langs->trans("ManufacturingOrder");
    $head[$h][2] = 'card';
    $h++;

    $head[$h][0] = DOL_URL_ROOT . '/Modules/Mrp/mo_production.php?id=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Mrp/mo_movements.php?id=' . $object->id;
    ...
    if (isset($object->fields['note_public']) || isset($object->fields['note_private'])) {
        ...
        $head[$h][0] = dol_buildpath('/Modules/Mrp/mo_note.php', 1) . '?id=' . $object->id;
