...
$arrayfields = [
    ...
    'm.batch' => ['label' => "BatchNumberShort", 'checked' => 1, 'position' => 8, 'enabled' => (!empty($conf->productbatch->enabled))],
    'pl.eatby' => ['label' => "EatByDate", 'checked' => 0, 'position' => 9, 'enabled' => (!empty($conf->productbatch->enabled))],
    'pl.sellby' => ['label' => "SellByDate", 'checked' => 0, 'position' => 10, 'enabled' => (!empty($conf->productbatch->enabled))],
    ...
    */
    ...
    while ($i < ($limit ? min($num, $limit) : $num)) {
        ...
        if (!empty($arrayfields['m.inventorycode']['checked'])) {
            // Inventory code
            print '<td>';
            //print '<a href="' . DOL_URL_ROOT . '/Modules/Products/stock/movement_card.php' . '?id=' . $objp->entrepot_id . '&amp;search_inventorycode=' . $objp->inventorycode . '&amp;search_type_mouvement=' . $objp->type_mouvement . '">';
