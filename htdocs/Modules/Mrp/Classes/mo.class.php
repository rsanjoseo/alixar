...
class Mo extends CommonObject
{
    ...
    public $fields = [
        ...
        'fk_bom' => ['type' => 'integer:Bom:bom/class/bom.class.php:0:t.status=1', 'filter' => 'active=1', 'label' => 'BOM', 'enabled' => 1, 'visible' => 1, 'position' => 33, 'notnull' => -1, 'index' => 1, 'comment' => "Original BOM", 'css' => 'minwidth100 maxwidth300', 'csslist' => 'nowraponall'],
        ...
        'fk_product' => ['type' => 'integer:Product:product/class/product.class.php:0', 'label' => 'Product', 'enabled' => 1, 'visible' => 1, 'position' => 35, 'notnull' => 1, 'index' => 1, 'comment' => "Product to produce", 'css' => 'maxwidth300', 'csslist' => 'tdoverflowmax100', 'picto' => 'product'],
        ...
        'label' => ['type' => 'varchar(255)', 'label' => 'Label', 'enabled' => 1, 'visible' => 1, 'position' => 42, 'notnull' => -1, 'searchall' => 1, 'showoncombobox' => '2', 'css' => 'maxwidth300', 'csslist' => 'tdoverflowmax200'],
        'fk_soc' => ['type' => 'integer:Societe:societe/class/societe.class.php:1', 'label' => 'ThirdParty', 'picto' => 'company', 'enabled' => 1, 'visible' => -1, 'position' => 50, 'notnull' => -1, 'index' => 1, 'css' => 'maxwidth400', 'csslist' => 'tdoverflowmax150'],
        'fk_project' => ['type' => 'integer:Project:projet/class/project.class.php:1:fk_statut=1', 'label' => 'Project', 'picto' => 'project', 'enabled' => 1, 'visible' => -1, 'position' => 51, 'notnull' => -1, 'index' => 1, 'css' => 'minwidth200 maxwidth400', 'csslist' => 'tdoverflowmax100'],
        'fk_warehouse' => ['type' => 'integer:Entrepot:product/stock/class/entrepot.class.php:0', 'label' => 'WarehouseForProduction', 'picto' => 'stock', 'enabled' => 1, 'visible' => 1, 'position' => 52, 'css' => 'maxwidth400', 'csslist' => 'tdoverflowmax200'],
        ...
        'fk_user_creat' => ['type' => 'integer', 'label' => 'UserAuthor', 'enabled' => 1, 'visible' => -2, 'position' => 510, 'notnull' => 1, 'foreignkey' => 'user.rowid', 'csslist' => 'tdoverflowmax100'],
        'fk_user_modif' => ['type' => 'integer', 'label' => 'UserModif', 'enabled' => 1, 'visible' => -2, 'position' => 511, 'notnull' => -1, 'csslist' => 'tdoverflowmax100'],
        'date_start_planned' => ['type' => 'datetime', 'label' => 'DateStartPlannedMo', 'enabled' => 1, 'visible' => 1, 'position' => 55, 'notnull' => -1, 'index' => 1, 'help' => 'KeepEmptyForAsap'],
        'date_end_planned' => ['type' => 'datetime', 'label' => 'DateEndPlannedMo', 'enabled' => 1, 'visible' => 1, 'position' => 56, 'notnull' => -1, 'index' => 1,],
    ...
    public function updateProduction(User $user, $notrigger = true)
    {
        ...
        if (!$error) {
            ...
            if ($this->fk_bom > 0) {    // If a BOM is defined, we know what to produce.
                include_once DOL_DOCUMENT_ROOT . '/Modules/Bom/class/bom.class.php';
                $bom = new Bom($this->db);
    ...
    public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
    {
        ...
        $url = DOL_URL_ROOT . '/Modules/Mrp/mo_card.php?id=' . $this->id;
        if ($option == 'production') {
            $url = DOL_URL_ROOT . '/Modules/Mrp/mo_production.php?id=' . $this->id;
        }
    ...
    public function getLinesArray()
    {
        ...
        $result = $objectline->fetchAll('ASC', 'position', 0, 0, ['customsql' => 'fk_mo = ' . ((int) $this->id)]);
    ...
    public function printOriginLine($line, $var, $restrictlist = '', $defaulttpldir = '/core/tpl', $selectedLines = [])
    {
        ...
        $tpl = DOL_DOCUMENT_ROOT . '/Modules/Mrp/tpl/originproductline.tpl.php';
        $res = include $tpl;
    }
}
...
class MoLine extends CommonObjectLine
{
    ...
    public $fields = [
        ...
        'date_creation' => ['type' => 'datetime', 'label' => 'DateCreation', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 160],
