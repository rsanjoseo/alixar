...
$('#agenerateimgwebp').on('click', function() {
    ...
    <div id="ecm-layout-west" class="inline-block">
        ...
        if ($action == 'confirmconvertimgwebp') {
            ...
            $form = new Form($db);
            $formquestion['section_dir'] = ['type' => 'hidden', 'value' => $section_dir, 'name' => 'section_dir'];
            $formquestion['section'] = ['type' => 'hidden', 'value' => $section, 'name' => 'section'];
            if ($module == 'medias') {
                $formquestion['website'] = ['type' => 'hidden', 'value' => $website->ref, 'name' => 'website'];
            }
