...
$sign = 1;
if (!empty($conf->global->INVOICE_POSITIVE_CREDIT_NOTE_SCREEN) && in_array($object->element, ['facture', 'invoice_supplier']) && $object->type == $object::TYPE_CREDIT_NOTE) {
	$sign = -1;
}
...
if (($line->info_bits & 2) == 2) {
	print '<a href="'.DOL_URL_ROOT.'/Modules/Comm/remx.php?id='.$this->socid.'">';
	$txt = '';
