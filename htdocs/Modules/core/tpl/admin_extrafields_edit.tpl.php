...
<form action="<?php echo $_SERVER["PHP_SELF"]; ?>?attrname=<?php echo $attrname; ?>" id="formeditextrafield"
    ...
    <input type="hidden" name="enabled"
           value="<?php echo $extrafields->attributes[$elementtype]['enabled'][$attrname]; ?>">
    ...
    <table summary="listofattributes" class="border centpercent">
        ...
        <tr>
            ...
            <td class="valeur">
                ...
                $typewecanchangeinto = [
                    'varchar' => ['varchar', 'phone', 'mail', 'url', 'select', 'password', 'text', 'html'],
                    'double' => ['double', 'price'],
                    'price' => ['double', 'price'],
                    'text' => ['text', 'html'],
                    'html' => ['text', 'html'],
                    'password' => ['password', 'varchar'],
                    'mail' => ['varchar', 'phone', 'mail', 'url', 'select'],
                    'url' => ['varchar', 'phone', 'mail', 'url', 'select'],
                    'phone' => ['varchar', 'phone', 'mail', 'url', 'select'],
                    'select' => ['varchar', 'phone', 'mail', 'url', 'select'],
                    'date' => ['date', 'datetime'],
                ];
        ...
        <tr>
            ...
            <td class="valeur"><input type="text" name="pos" size="5" value="<?php echo dol_escape_htmltag($pos); ?>">
            </td>
        </tr>
