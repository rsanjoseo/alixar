...
if (empty($backtourl)) {
    ...
    if (in_array($modulepart, ['product', 'produit', 'service', 'produit|service'])) {
        $backtourl = DOL_URL_ROOT . "/Modules/Products/document.php?id=" . $id . '&file=' . urldecode($file);
    } elseif (in_array($modulepart, ['expensereport'])) {
        $backtourl = DOL_URL_ROOT . "/Modules/ExpenseReports/document.php?id=" . $id . '&file=' . urldecode($file);
    } elseif (in_array($modulepart, ['holiday'])) {
        $backtourl = DOL_URL_ROOT . "/Modules/Holiday/document.php?id=" . $id . '&file=' . urldecode($file);
    } elseif (in_array($modulepart, ['member'])) {
        $backtourl = DOL_URL_ROOT . "/Modules/Adherents/document.php?id=" . $id . '&file=' . urldecode($file);
    } elseif (in_array($modulepart, ['project'])) {
        $backtourl = DOL_URL_ROOT . "/Modules/Projects/document.php?id=" . $id . '&file=' . urldecode($file);
    } elseif (in_array($modulepart, ['propal'])) {
        $backtourl = DOL_URL_ROOT . "/Modules/Comm/propal/document.php?id=" . $id . '&file=' . urldecode($file);
    } elseif (in_array($modulepart, ['societe'])) {
        $backtourl = DOL_URL_ROOT . "/Modules/Societes/document.php?id=" . $id . '&file=' . urldecode($file);
    } elseif (in_array($modulepart, ['tax'])) {
        $backtourl = DOL_URL_ROOT . "/Modules/Compta/sociales/document.php?id=" . $id . '&file=' . urldecode($file);
    } elseif (in_array($modulepart, ['ticket'])) {
        $backtourl = DOL_URL_ROOT . "/Modules/Ticket/document.php?id=" . $id . '&file=' . urldecode($file);
    } elseif (in_array($modulepart, ['user'])) {
        $backtourl = DOL_URL_ROOT . "/Modules/Users/document.php?id=" . $id . '&file=' . urldecode($file);
    } elseif (in_array($modulepart, ['facture'])) {
        $backtourl = DOL_URL_ROOT . "/Modules/Compta/facture/document.php?id=" . $id . '&file=' . urldecode($file);
    } elseif (in_array($modulepart, ['facture_fourn', 'facture_fournisseur'])) {
        $backtourl = DOL_URL_ROOT . "/Modules/Fourn/facture/document.php?id=" . $id . '&file=' . urldecode($file);
    } elseif (in_array($modulepart, ['bank']) && preg_match('/\/statement\/([^\/]+)\//', $file, $regs)) {
        $num = $regs[1];
        $backtourl = DOL_URL_ROOT . "/Modules/Compta/bank/account_statement_document.php?id=" . $id . '&num=' . urlencode($num) . '&file=' . urldecode($file);
    } elseif (in_array($modulepart, ['bank'])) {
        $backtourl = DOL_URL_ROOT . "/Modules/Compta/bank/document.php?id=" . $id . '&file=' . urldecode($file);
    } elseif (in_array($modulepart, ['mrp'])) {
        $backtourl = DOL_URL_ROOT . "/mrp/mo_document.php?id=" . $id . '&file=' . urldecode($file);
    } elseif (in_array($modulepart, ['medias'])) {
...
$morejs = ['/includes/jquery/plugins/jcrop/js/jquery.Jcrop.min.js', '/core/js/lib_photosresize.js'];
$morecss = ['/includes/jquery/plugins/jcrop/css/jquery.Jcrop.css'];
