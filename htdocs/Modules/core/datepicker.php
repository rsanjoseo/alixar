...
function displayBox($selectedDate, $month, $year)
{
    ...
    <table class="dp">
        ...
        <tr>
            <td class="dpButtons"
                onClick="loadMonth('<?php echo DOL_URL_ROOT . '/core/' ?>','<?php echo $month ?>','<?php echo $year - 1 ?>','<?php echo $xyz ?>','<?php echo $langs->defaultlang ?>')">
                &lt;&lt;
            </td>
            <td class="dpButtons"
        ...
        <tr class="dpDayNames">
            ...
            $day_names = ['ShortSunday', 'ShortMonday', 'ShortTuesday', 'ShortWednesday', 'ShortThursday', 'ShortFriday', 'ShortSaturday'];
            for ($i = 0; $i < 7; $i++) {
