...
require_once DOL_DOCUMENT_ROOT . '/Modules/Products/stock/class/productstockentrepot.class.php';
...
$langs->loadlangs(['products', 'suppliers', 'orders', 'bills', 'stocks', 'sendings', 'margins']);
if (!empty($conf->productbatch->enabled)) {
...
$hookmanager->initHooks(['stockproductcard', 'globalcard']);
...
if ($id > 0 || $ref) {
    ...
    if ($result > 0) {
        ...
        if (!$variants) {
            ...
            print ' &nbsp; &nbsp;<a href="' . DOL_URL_ROOT . '/Modules/Products/stock/stockatdate.php?productid=' . $object->id . '">' . $langs->trans("StockAtDate") . '</a>';
            print '</td>';
            print '</tr>';
            ...
            print ' &nbsp; &nbsp;<a href="' . DOL_URL_ROOT . '/Modules/Products/stock/stockatdate.php?mode=future&productid=' . $object->id . '">' . $langs->trans("VirtualStockAtDate") . '</a>';
            print '</td>';
            print '</tr>';
            ...
            if (!empty($user->rights->stock->mouvement->lire)) {
                ...
                if ($lastmovementdate) {
                    ...
                    print '<a href="' . DOL_URL_ROOT . '/Modules/Products/stock/movement_list.php?idproduct=' . $object->id . '">' . $langs->trans("FullList") . '</a>';
                } else {
                    print img_picto($langs->trans("StockMovement"), 'movement', 'class="pictofixedwidth"');
                    print '<a href="' . DOL_URL_ROOT . '/Modules/Products/stock/movement_list.php?idproduct=' . $object->id . '">' . $langs->trans("None") . '</a>';
                }
                print "</td></tr>";
            }
        ...
        if (count($productCombinations)) {
            ...
            foreach ($productCombinations as $currcomb) {
                ...
                <tr class="oddeven">
                    ...
                    <td class="right">
                        <a class="paddingleft paddingright"
                           href="<?php echo dol_buildpath('/Modules/Products/stock/product.php?id=' . $currcomb->fk_product_child, 2) ?>"><?php echo img_edit() ?></a>
                    </td>
                    <?php
                    ?>
                </tr>
