...
if (!empty($conf->global->MAIN_SEARCH_FORM_ON_HOME_AREAS)) {     // This may be useless due to the global search combo
    print '<form method="post" action="' . DOL_URL_ROOT . '/Modules/Products/stock/list.php">';
...
if ($result) {
    ...
    print '<a href="' . DOL_URL_ROOT . '/Modules/Products/stock/list.php">';
    // TODO: "search_status" on "/Modules/Products/stock/list.php" currently only accept a single integer value
    //print '<a href="'.DOL_URL_ROOT.'/Modules/Products/stock/list.php?search_status='.Entrepot::STATUS_CLOSED.','.Entrepot::STATUS_OPEN_ALL.'">';
...
if ($resql) {
    ...
    print '<th class="right"><a class="notasortlink" href="' . DOL_URL_ROOT . '/Modules/Products/stock/movement_list.php">' . $langs->trans("FullList") . '</a></th>';
    print "</tr>\n";
