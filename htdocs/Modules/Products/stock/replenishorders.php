...
require_once DOL_DOCUMENT_ROOT . '/Modules/Products/stock/lib/replenishment.lib.php';
...
$head[0][0] = DOL_URL_ROOT . '/Modules/Products/stock/replenish.php';
$head[0][1] = $langs->trans('MissingStocks');
$head[0][2] = 'replenish';

$head[1][0] = DOL_URL_ROOT . '/Modules/Products/stock/replenishorders.php';
$head[1][1] = $texte;
...
if ($sall) {
    $sql .= natural_search(['cf.ref', 'cf.note'], $sall);
}
if (!empty($socid)) {
...
if ($resql) {
    ...
    while ($i < min($num, $search_product ? $num : $conf->liste_limit)) {
        ...
        if ($showline) {
            $href = DOL_URL_ROOT . '/Modules/Fourn/commande/card.php?id=' . $obj->rowid;
            ...
            // Company
            $href = DOL_URL_ROOT . '/Modules/Fourn/card.php?socid=' . $obj->socid;
