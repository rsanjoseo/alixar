...
class Productlot extends CommonObject
{
    ...
    public $fields = [
        ...
        'fk_product' => ['type' => 'integer:Product:product/class/product.class.php', 'label' => 'Product', 'enabled' => 1, 'visible' => 1, 'position' => 5, 'notnull' => 1, 'index' => 1, 'searchall' => 1],
        'batch' => ['type' => 'varchar(30)', 'label' => 'Batch', 'enabled' => 1, 'visible' => 1, 'notnull' => 0, 'showoncombobox' => 1, 'index' => 1, 'position' => 10, 'comment' => 'Batch', 'searchall' => 1],
        'entity' => ['type' => 'integer', 'label' => 'Entity', 'enabled' => 1, 'visible' => 0, 'default' => 1, 'notnull' => 1, 'index' => 1, 'position' => 20],
        'sellby' => ['type' => 'date', 'label' => 'SellByDate', 'enabled' => 'empty($conf->global->PRODUCT_DISABLE_SELLBY)?1:0', 'visible' => 5, 'position' => 60],
        'eol_date' => ['type' => 'date', 'label' => 'EndOfLife', 'enabled' => 'empty($conf->global->PRODUCT_ENABLE_TRACEABILITY)?0:1', 'visible' => 5, 'position' => 70],
        'manufacturing_date' => ['type' => 'date', 'label' => 'ManufacturingDate', 'enabled' => 'empty($conf->global->PRODUCT_ENABLE_TRACEABILITY)?0:1', 'visible' => 5, 'position' => 80],
        'scrapping_date' => ['type' => 'date', 'label' => 'DestructionDate', 'enabled' => 'empty($conf->global->PRODUCT_ENABLE_TRACEABILITY)?0:1', 'visible' => 5, 'position' => 90],
        ...
        'eatby' => ['type' => 'date', 'label' => 'EatByDate', 'enabled' => 'empty($conf->global->PRODUCT_DISABLE_EATBY)?1:0', 'visible' => 5, 'position' => 62],
        'datec' => ['type' => 'datetime', 'label' => 'DateCreation', 'enabled' => 1, 'visible' => 1, 'notnull' => 1, 'position' => 500],
        'tms' => ['type' => 'timestamp', 'label' => 'DateModification', 'enabled' => 1, 'visible' => -2, 'notnull' => 1, 'position' => 501],
        'fk_user_creat' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'UserAuthor', 'enabled' => 1, 'visible' => -2, 'notnull' => 1, 'position' => 510, 'foreignkey' => 'llx_user.rowid'],
        'fk_user_modif' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'UserModif', 'enabled' => 1, 'visible' => -2, 'notnull' => -1, 'position' => 511],
    ...
    public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $maxlen = 24, $morecss = '', $save_lastsearch_value = -1)
    {
        ...
        $url = DOL_URL_ROOT . '/Modules/Products/stock/productlot_card.php?id=' . $this->id;
