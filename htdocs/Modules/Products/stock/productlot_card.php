...
$hookmanager->initHooks(['productlotcard', 'globalcard']); // Note that conf->hooks_modules contains array
...
$hookmanager->initHooks(['productlotcard', 'globalcard']);
...
if (empty($reshook)) {
    ...
    $backurlforlist = dol_buildpath('/Modules/Products/stock/productlot_list.php', 1);
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create'))) {
    ...
    // Object card
    // ------------------------------------------------------------
    $linkback = '<a href="' . DOL_URL_ROOT . '/Modules/Products/stock/productlot_list.php?restore_lastsearch_values=1">' . $langs->trans("BackToList") . '</a>';
    ...
    // Link to other lists
    print '<a href="' . DOL_URL_ROOT . '/Modules/Products/reassortlot.php?sref=' . urlencode($producttmp->ref) . '&search_batch=' . urlencode($object->batch) . '">' . $langs->trans("ShowCurrentStockOfLot") . '</a><br>';
    print '<br>';
    print '<a href="' . DOL_URL_ROOT . '/Modules/Products/stock/movement_list.php?search_product_ref=' . urlencode($producttmp->ref) . '&search_batch=' . urlencode($object->batch) . '">' . $langs->trans("ShowLogOfMovementIfLot") . '</a><br>';
