...
$dirproduct = ['/core/modules/product/'];
$dirmodels = array_merge(['/'], (array) $conf->modules_parts['models']);
...
print ajax_constantonoff("PRODUIT_SOUSPRODUITS", [], $conf->entity, 0, 0, 1, 0);
...
print $form->selectarray(
    ...
    [0 => 'DoNotAutofillButAutoConcat', 1 => 'AutoFillFormFieldBeforeSubmit', 2 => 'DoNotUseDescriptionOfProdut'],
...
if (!empty($conf->global->PRODUCT_CANVAS_ABILITY)) {
    // Add canvas feature
    $dir = DOL_DOCUMENT_ROOT . "/Modules/Products/canvas/";
