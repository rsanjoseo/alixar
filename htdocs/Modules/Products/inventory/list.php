...
$hookmanager->initHooks(['inventorylist']); // Note that conf->hooks_modules contains array
...
$newcardbutton = dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', DOL_URL_ROOT . '/Modules/Products/inventory/card.php?action=create&backtopage=' . urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);
