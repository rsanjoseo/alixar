...
function inventoryPrepareHead(&$inventory, $title = 'Inventory', $get = '')
{
    ...
    return [
        [dol_buildpath('/Modules/Products/inventory/card.php?id=' . $inventory->id . $get, 1), $langs->trans('Card'), 'card'],
        [dol_buildpath('/Modules/Products/inventory/inventory.php?id=' . $inventory->id . $get, 1), $langs->trans('Inventory'), 'inventory'],
    ];
}
