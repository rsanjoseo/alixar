...
$hookmanager->initHooks(['agendathirdparty']);
...
if ($id > 0 || $ref) {
    ...
    if (!empty($conf->agenda->enabled)) {
        ...
        $morehtmlcenter = dolGetButtonTitle($langs->trans('AddAction'), '', 'fa fa-plus-circle', DOL_URL_ROOT . '/Modules/Comm/action/card.php?action=create' . $out, '', $linktocreatetimeBtnStatus);
    }
