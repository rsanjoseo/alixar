    ...
    public function assign_values(&$action, $id = 0, $ref = '')
    {
        ...
        if ($action == 'view') {
            ...
            if ($this->object->duration_value > 1) {
                $dur = ["h" => $langs->trans("Hours"), "d" => $langs->trans("Days"), "w" => $langs->trans("Weeks"), "m" => $langs->trans("Months"), "y" => $langs->trans("Years")];
            } elseif ($this->object->duration_value > 0) {
                $dur = ["h" => $langs->trans("Hour"), "d" => $langs->trans("Day"), "w" => $langs->trans("Week"), "m" => $langs->trans("Month"), "y" => $langs->trans("Year")];
            }
