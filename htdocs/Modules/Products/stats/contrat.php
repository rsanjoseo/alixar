...
$langs->loadLangs(['contracts', 'products', 'companies']);
...
$hookmanager->initHooks(['productstatscontract']);
        ...
        if ($result) {
            ...
            if ($num > 0) {
                while ($i < min($num, $limit)) {
                    ...
                    print "</td>\n";
                    print '<td><a href="' . DOL_URL_ROOT . '/Modules/Comm/card.php?socid=' . $objp->socid . '">' . img_object($langs->trans("ShowCompany"), "company") . ' ' . dol_trunc($objp->name, 44) . '</a></td>';
