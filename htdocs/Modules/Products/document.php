...
if (!empty($conf->global->PRODUIT_PDF_MERGE_PROPAL)) {
    require_once DOL_DOCUMENT_ROOT . '/Modules/Products/class/propalmergepdfproduct.class.php';
}

// Load translation files required by the page
$langs->loadLangs(['other', 'products']);
...
$hookmanager->initHooks(['productdocuments']);
...
if ($object->id) {
    ...
    if (!empty($conf->global->PRODUIT_PDF_MERGE_PROPAL)) {
        ...
        if (count($filearray) > 0) {
            ...
            print '<form name="filemerge" action="' . DOL_URL_ROOT . '/Modules/Products/document.php?id=' . $object->id . '" method="post">';
