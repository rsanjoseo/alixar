...
class Product extends CommonObject
{
    ...
    public $fields = [
        ...
        'label' => ['type' => 'varchar(255)', 'label' => 'Label', 'enabled' => 1, 'visible' => 1, 'notnull' => 1, 'showoncombobox' => 2, 'position' => 15],
        'barcode' => ['type' => 'varchar(255)', 'label' => 'Barcode', 'enabled' => '!empty($conf->barcode->enabled)', 'position' => 20, 'visible' => -1, 'showoncombobox' => 3],
        ...
        'mandatory_period' => ['type' => 'integer', 'label' => 'mandatory_period', 'enabled' => 1, 'visible' => 1, 'notnull' => 1, 'default' => 0, 'index' => 1, 'position' => 1000],
     ...
     * @return int                            <0 if KO, >0 if OK
     */
    public function updatePrice($newprice, $newpricebase, $user, $newvat = '', $newminprice = 0, $level = 0, $newnpr = 0, $newpbq = 0, $ignore_autogen = 0, $localtaxes_array = [], $newdefaultvatcode = '')
    {
        global $conf, $langs;
    ...
    public function getChildsArbo($id, $firstlevelonly = 0, $level = 1)
    {
        ...
        if ($level == 1) {
            $alreadyfound = [$id => 1]; // We init array of found object to start of tree, so if we found it later (should not happened), we stop immediatly
        }
