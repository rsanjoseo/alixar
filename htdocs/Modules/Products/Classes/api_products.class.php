...
class Products extends DolibarrApi
{
    ...
    public function getCategories($id, $sortfield = "s.rowid", $sortorder = 'ASC', $limit = 0, $page = 0)
    {
        ...
        if ($result < 0) {
            throw new RestException(503, 'Error when retrieve category list : ' . array_merge([$categories->error], $categories->errors));
        }
    ...
    public function getCustomerPricesPerSegment($id)
    {
        ...
        if ($result < 0) {
            throw new RestException(503, 'Error when retrieve prices list : ' . array_merge([$this->product->error], $this->product->errors));
        }
