...
$hookmanager->initHooks(['productreassortlist']);
...
if ($resql) {
    ...
    while ($i < min($num, $limit)) {
        ...
        print '<a href="' . DOL_URL_ROOT . '/Modules/Products/stock/movement_list.php?idproduct=' . $product->id . '">' . $langs->trans("Movements") . '</a>';
        print '</td>';
