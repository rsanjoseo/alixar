        ...
        if (!$error) {
            ...
            if ($res) {
                ...
                if ($sendto) {
                    ...
                    $message_admin .= '<p><a href="' . dol_buildpath('/Modules/Tickets/card.php', 2) . '?track_id=' . $object->track_id . '" rel="nofollow noopener">' . $langs->trans('SeeThisTicketIntomanagementInterface') . '</a></p>';
...
$arrayofjs = [];
$arrayofcss = ['/opensurvey/css/style.css', '/Modules/Tickets/css/styles.css.php'];
