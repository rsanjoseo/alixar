...
if (empty($reshook)) {
    ...
    $alwaysuncheckedmodules = ['dav', 'dynamicprices', 'incoterm', 'loan', 'multicurrency', 'paybox', 'paypal', 'stripe', 'google', 'printing', 'scanner', 'skype', 'website']; // Module we dont want by default
    // Not visible
    $alwayshiddencheckedmodules = [
