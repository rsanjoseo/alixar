...
<head>
    ...
    <link rel="stylesheet" type="text/css" title="default"
          href="<?php echo DOL_URL_ROOT ?>/theme/eldy/style.css.php<?php echo ($_GET["dol_use_jmobile"] == 1) ? '?dol_use_jmobile=1&dol_optimize_smallscreen=1' : ''; ?>"/>
...
<br>
<hr>
<br>Example 0a : Table with div+div+div containg a select that should be overflowed and truncated => Use this to align
text or form<br>
...
<br>
<hr>
<br>Example 0b: Table with div+form+div containg a select that should be overflowed and truncated => Use this to align
text or form<br>
...
<br>
<hr>
<br>Example 0c: Table with table+tr+td containg a select that should be overflowed and truncated => Use this to align
text or form<br>
