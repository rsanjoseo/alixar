...
if (! empty($conf->propal->enabled))
{
	...
	if ($resql)
	{
		...
		print '<td colspan="3">'.$langs->trans("ProposalsToProcess").' <a href="'.DOL_URL_ROOT.'/Modules/Commande/list.php?search_status=1"><span class="badge">'.$num.'</span></a></td></tr>';
...
if (! empty($conf->propal->enabled))
{
	...
	if ($resql)
	{
		...
		print '<table class="noborder centpercent">';
		print '<tr class="liste_titre">';
		print '<td colspan="3">'.$langs->trans("OnProcessOrders").' <a href="'.DOL_URL_ROOT.'/Modules/Commande/list.php?search_status=2"><span class="badge">'.$num.'</span></a></td></tr>';
