 ...
 */
namespace Alxarafe\Modules\Fourn\Classes;
...
class CommandeFournisseur extends CommonOrder
{
     ...
     */
    public $table_element_line = 'commande_fournisseurdet'; // 0=Draft -> 1=Validated -> 2=Approved -> 3=Ordered/Process runing -> 4=Received partially -> 5=Received totally -> (reopen) 4=Received partially
     ...
     */
    public $fk_element = 'fk_commande'; // List of status
    /**
    ...
    public $ref;
    public $ref_supplier;
    public $brouillon; // Used when SUPPLIER_ORDER_3_STEPS_TO_BE_APPROVED is set
    public $statut;
    public $statuts;
    public $billed;
    public $socid;
    public $fourn_id;
    public $date; // Total Local tax 1
    public $date_valid; // Total Local tax 2
    public $date_approve;
    ...
    public $total_ht;    // Label
    public $total_tva;        // Label on documents
    ...
    public $cond_reglement_code; // Used when SUPPLIER_ORDER_3_STEPS_TO_BE_APPROVED is set
    ...
    public $fields = [
        ...
        'ref' => ['type' => 'varchar(255)', 'label' => 'Ref', 'enabled' => 1, 'visible' => -1, 'showoncombobox' => 1, 'position' => 25],
        ...
        'ref_supplier' => ['type' => 'varchar(255)', 'label' => 'RefSupplier', 'enabled' => 1, 'visible' => -1, 'position' => 40],
        'fk_projet' => ['type' => 'integer:Project:projet/class/project.class.php:1:fk_statut=1', 'label' => 'Fk projet', 'enabled' => 1, 'visible' => -1, 'position' => 45],
        'date_creation' => ['type' => 'datetime', 'label' => 'Date creation', 'enabled' => 1, 'visible' => -1, 'position' => 50],
        'date_valid' => ['type' => 'datetime', 'label' => 'DateValidation', 'enabled' => 1, 'visible' => -1, 'position' => 55],
        'date_approve' => ['type' => 'datetime', 'label' => 'Date approve', 'enabled' => 1, 'visible' => -1, 'position' => 60],
        'date_approve2' => ['type' => 'datetime', 'label' => 'Date approve2', 'enabled' => 1, 'visible' => -1, 'position' => 65],
        'date_commande' => ['type' => 'date', 'label' => 'Date commande', 'enabled' => 1, 'visible' => -1, 'position' => 70],
        'fk_user_author' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'Fk user author', 'enabled' => 1, 'visible' => -1, 'position' => 75],
        ...
        'fk_user_approve' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'UserApproval', 'enabled' => 1, 'visible' => -1, 'position' => 90],
        'fk_user_approve2' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'UserSecondApproval', 'enabled' => 1, 'visible' => -1, 'position' => 95],
        'source' => ['type' => 'smallint(6)', 'label' => 'Source', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 100],
        'billed' => ['type' => 'smallint(6)', 'label' => 'Billed', 'enabled' => 1, 'visible' => -1, 'position' => 110],
        'amount_ht' => ['type' => 'double(24,8)', 'label' => 'Amount ht', 'enabled' => 1, 'visible' => -1, 'position' => 115],
        'remise_percent' => ['type' => 'double', 'label' => 'Remise percent', 'enabled' => 1, 'visible' => -1, 'position' => 120],
        'remise' => ['type' => 'double', 'label' => 'Remise', 'enabled' => 1, 'visible' => -1, 'position' => 125],
        'total_tva' => ['type' => 'double(24,8)', 'label' => 'Tva', 'enabled' => 1, 'visible' => -1, 'position' => 130, 'isameasure' => 1],
        ...
        'total_ht' => ['type' => 'double(24,8)', 'label' => 'TotalHT', 'enabled' => 1, 'visible' => -1, 'position' => 145, 'isameasure' => 1],
        'total_ttc' => ['type' => 'double(24,8)', 'label' => 'TotalTTC', 'enabled' => 1, 'visible' => -1, 'position' => 150, 'isameasure' => 1],
        ...
        'fk_input_method' => ['type' => 'integer', 'label' => 'InputMethod', 'enabled' => 1, 'visible' => -1, 'position' => 170],
        'fk_cond_reglement' => ['type' => 'integer', 'label' => 'PaymentTerm', 'enabled' => 1, 'visible' => -1, 'position' => 175],
        'fk_mode_reglement' => ['type' => 'integer', 'label' => 'PaymentMode', 'enabled' => 1, 'visible' => -1, 'position' => 180],
        'extraparams' => ['type' => 'varchar(255)', 'label' => 'Extraparams', 'enabled' => 1, 'visible' => -1, 'position' => 190],
        'date_livraison' => ['type' => 'datetime', 'label' => 'DeliveryDate', 'enabled' => 1, 'visible' => -1, 'position' => 195],
        'fk_account' => ['type' => 'integer', 'label' => 'Fk account', 'enabled' => 1, 'visible' => -1, 'position' => 200],
        'fk_incoterms' => ['type' => 'integer', 'label' => 'IncotermCode', 'enabled' => 1, 'visible' => -1, 'position' => 205],
        'location_incoterms' => ['type' => 'varchar(255)', 'label' => 'IncotermLocation', 'enabled' => 1, 'visible' => -1, 'position' => 210],
        'fk_multicurrency' => ['type' => 'integer', 'label' => 'Fk multicurrency', 'enabled' => 1, 'visible' => -1, 'position' => 215],
        'multicurrency_code' => ['type' => 'varchar(255)', 'label' => 'MulticurrencyCode', 'enabled' => 1, 'visible' => -1, 'position' => 220],
        'multicurrency_tx' => ['type' => 'double(24,8)', 'label' => 'MulticurrencyRate', 'enabled' => 1, 'visible' => -1, 'position' => 225],
        'multicurrency_total_ht' => ['type' => 'double(24,8)', 'label' => 'MulticurrencyTotalHT', 'enabled' => 1, 'visible' => -1, 'position' => 230],
        'multicurrency_total_tva' => ['type' => 'double(24,8)', 'label' => 'MulticurrencyTotalVAT', 'enabled' => 1, 'visible' => -1, 'position' => 235],
        'multicurrency_total_ttc' => ['type' => 'double(24,8)', 'label' => 'MulticurrencyTotalTTC', 'enabled' => 1, 'visible' => -1, 'position' => 240],
        'last_main_doc' => ['type' => 'varchar(255)', 'label' => 'LastMainDoc', 'enabled' => 1, 'visible' => -1, 'position' => 245],
    ...
    public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $save_lastsearch_value = -1, $addlinktonotes = 0)
    {
        ...
        $picto = 'order';
        $url = DOL_URL_ROOT . '/Modules/Fourn/commande/card.php?id=' . $this->id;
        ...
        if ($addlinktonotes) {
            ...
            if ($txttoshow) {
                ...
                $result .= '<a href="' . DOL_URL_ROOT . '/Modules/Fourn/commande/note.php?id=' . $this->id . '" class="classfortooltip" title="' . dol_escape_htmltag($notetoshow) . '">';
    ...
    public function load_board($user, $mode = 'opened')
    {
        ...
        if ($resql) {
            ...
            $response->url = DOL_URL_ROOT . '/Modules/Fourn/commande/list.php?search_status=1,2&mainmenu=commercial&leftmenu=orders_suppliers';
            $response->img = img_object('', "order");

            if ($mode === 'awaiting') {
                $response->label = $langs->trans("SuppliersOrdersAwaitingReception");
                $response->labelShort = $langs->trans("AwaitingReception");
                $response->url = DOL_URL_ROOT . '/Modules/Fourn/commande/list.php?search_status=3,4&mainmenu=commercial&leftmenu=orders_suppliers';
            }
