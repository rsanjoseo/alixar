...
class ProductFournisseur extends Product
{
    ...
    public $reputations = []; // list of available supplier reputations
     ...
     * @return    int                                            <0 if KO, >=0 if OK
     */
    public function update_buyprice($qty, $buyprice, $user, $price_base_type, $fourn, $availability, $ref_fourn, $tva_tx, $charges = 0, $remise_percent = 0, $remise = 0, $newnpr = 0, $delivery_time_days = 0, $supplier_reputation = '', $localtaxes_array = [], $newdefaultvatcode = '', $multicurrency_buyprice = 0, $multicurrency_price_base_type = 'HT', $multicurrency_tx = 1, $multicurrency_code = '', $desc_fourn = '', $barcode = '', $fk_barcode_type = '')
    {
        // phpcs:enable
        global $conf, $langs;
        //global $mysoc;
    ...
    public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
    {
        ...
        $url = dol_buildpath('/Modules/Products/fournisseurs.php', 1) . '?id=' . $this->id . '&action=add_price&socid=' . $this->fourn_id . '&rowid=' . $this->product_fourn_price_id;
