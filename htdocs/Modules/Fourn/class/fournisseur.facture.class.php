...
class FactureFournisseur extends CommonInvoice
{
    ...
    public $fields = [
        ...
        'fk_soc' => ['type' => 'integer:Societe:societe/class/societe.class.php', 'label' => 'ThirdParty', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 40],
        ...
        'fk_projet' => ['type' => 'integer:Project:projet/class/project.class.php:1:fk_statut=1', 'label' => 'Project', 'enabled' => 1, 'visible' => -1, 'position' => 145],
        'fk_account' => ['type' => 'integer', 'label' => 'Account', 'enabled' => 1, 'visible' => -1, 'position' => 150],
