...
$langs->loadLangs(["bills", "suppliers", "companies"]);
...
$linkback = '<a href="' . DOL_URL_ROOT . '/Modules/Fourn/paiement/list.php?restore_lastsearch_values=1">' . $langs->trans("BackToList") . '</a>';
