...
$morejs = ['/Modules/Fourn/js/lib_dispatch.js.php'];
...
if ($id > 0 || !empty($ref)) {
    ...
    $linkback = '<a href="' . DOL_URL_ROOT . '/Modules/Fourn/commande/list.php' . (!empty($socid) ? '?socid=' . $socid : '') . '">' . $langs->trans("BackToList") . '</a>';
            ...
            while ($i < $num) {
                ...
                if (!$objp->fk_product > 0) {
                    ...
                    if ($remaintodispatch || empty($conf->global->SUPPLIER_ORDER_DISABLE_STOCK_DISPATCH_WHEN_TOTAL_REACHED)) {
                        ...
                        $linktoprod = '<a href="' . DOL_URL_ROOT . '/Modules/Products/fournisseurs.php?id=' . $objp->fk_product . '">' . img_object($langs->trans("ShowProduct"), 'product') . ' ' . $objp->ref . '</a>';
    ...
    if ($resql) {
        ...
        if ($num > 0) {
            ...
            while ($i < $num) {
                ...
                print '<td>';
                print '<a href="' . DOL_URL_ROOT . '/Modules/Products/fournisseurs.php?id=' . $objp->fk_product . '">' . img_object($langs->trans("ShowProduct"), 'product') . ' ' . $objp->ref . '</a>';
                print ' - ' . $objp->label;
                print "</td>\n";
                ...
                if (!empty($conf->productbatch->enabled)) {
                    if ($objp->batch) {
                        include_once DOL_DOCUMENT_ROOT . '/Modules/Products/stock/class/productlot.class.php';
