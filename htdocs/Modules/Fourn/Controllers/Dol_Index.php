...
$langs->loadLangs(["suppliers", "orders", "companies"]);
...
if ($resql) {
    ...
    while ($i < $num) {
        ...
        print '<td class="center"><a href="' . DOL_URL_ROOT . '/Modules/Fourn/commande/list.php?statut=' . $row[1] . '">' . $commandestatic->LibStatut($row[1], 3) . '</a></td>';
