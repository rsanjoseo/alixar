...
function bomPrepareHead($object)
{
    ...
    if (isset($object->fields['note_public']) || isset($object->fields['note_private'])) {
        ...
        $head[$h][0] = DOL_URL_ROOT . '/Modules/Bom/bom_note.php?id=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Bom/bom_document.php?id=' . $object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT . '/Modules/Bom/bom_agenda.php?id=' . $object->id;
