...
/**
 *       \file       htdocs/Modules/Categories/photos.php
 *       \ingroup    category
...
$langs->loadlangs(['categories', 'bills']);
...
if ($object->id) {
    ...
    $morehtmlref = '<br><div class="refidno"><a href="' . DOL_URL_ROOT . '/Modules/Categories/index.php?leftmenu=cat&type=' . $type . '">' . $langs->trans("Root") . '</a> >> ';
