...
/**
 *        \file       htdocs/Modules/Categories/card.php
 *        \ingroup    category
...
$hookmanager->initHooks(['categorycard']);
...
if ($action == 'add' && $user->rights->categorie->creer) {
    ...
    if ($cancel) {
        if ($urlfrom) {
            ...
            header("Location: " . DOL_URL_ROOT . '/Modules/Categories/viewcat.php?id=' . $idProdOrigin . '&type=' . $type);
            exit;
        } elseif ($idCompanyOrigin) {
            header("Location: " . DOL_URL_ROOT . '/Modules/Categories/viewcat.php?id=' . $idCompanyOrigin . '&type=' . $type);
            exit;
        } elseif ($idSupplierOrigin) {
            header("Location: " . DOL_URL_ROOT . '/Modules/Categories/viewcat.php?id=' . $idSupplierOrigin . '&type=' . $type);
            exit;
        } elseif ($idMemberOrigin) {
            header("Location: " . DOL_URL_ROOT . '/Modules/Categories/viewcat.php?id=' . $idMemberOrigin . '&type=' . $type);
            exit;
        } elseif ($idContactOrigin) {
            header("Location: " . DOL_URL_ROOT . '/Modules/Categories/viewcat.php?id=' . $idContactOrigin . '&type=' . $type);
            exit;
        } elseif ($idProjectOrigin) {
            header("Location: " . DOL_URL_ROOT . '/Modules/Categories/viewcat.php?id=' . $idProjectOrigin . '&type=' . $type);
            exit;
        } else {
            header("Location: " . DOL_URL_ROOT . '/Modules/Categories/index.php?leftmenu=cat&type=' . $type);
            exit;
        }
    }
...
if (($action == 'add' || $action == 'confirmed') && $user->rights->categorie->creer) {
    ...
    if ($action == 'confirmed') {
        if ($urlfrom) {
            ...
            header("Location: " . DOL_URL_ROOT . '/Modules/Categories/viewcat.php?id=' . $idProdOrigin . '&type=' . $type . '&mesg=' . urlencode($langs->trans("CatCreated")));
            exit;
        } elseif ($idCompanyOrigin) {
            header("Location: " . DOL_URL_ROOT . '/Modules/Categories/viewcat.php?id=' . $idCompanyOrigin . '&type=' . $type . '&mesg=' . urlencode($langs->trans("CatCreated")));
            exit;
        } elseif ($idSupplierOrigin) {
            header("Location: " . DOL_URL_ROOT . '/Modules/Categories/viewcat.php?id=' . $idSupplierOrigin . '&type=' . $type . '&mesg=' . urlencode($langs->trans("CatCreated")));
            exit;
        } elseif ($idMemberOrigin) {
            header("Location: " . DOL_URL_ROOT . '/Modules/Categories/viewcat.php?id=' . $idMemberOrigin . '&type=' . $type . '&mesg=' . urlencode($langs->trans("CatCreated")));
            exit;
        } elseif ($idContactOrigin) {
            header("Location: " . DOL_URL_ROOT . '/Modules/Categories/viewcat.php?id=' . $idContactOrigin . '&type=' . $type . '&mesg=' . urlencode($langs->trans("CatCreated")));
            exit;
        } elseif ($idProjectOrigin) {
            header("Location: " . DOL_URL_ROOT . '/Modules/Categories/viewcat.php?id=' . $idProjectOrigin . '&type=' . $type . '&mesg=' . urlencode($langs->trans("CatCreated")));
            exit;
        }

        header("Location: " . DOL_URL_ROOT . '/Modules/Categories/viewcat.php?id=' . $result . '&type=' . $type);
        exit;
    }
}
