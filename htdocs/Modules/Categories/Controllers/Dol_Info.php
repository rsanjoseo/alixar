...
/**
 *      \file       htdocs/Modules/Categories/info.php
 *      \ingroup    categories
...
$langs->loadLangs(['categories', 'sendings']);
...
$backtolist = (GETPOST('backtolist') ? GETPOST('backtolist') : DOL_URL_ROOT . '/Modules/Categories/index.php?leftmenu=cat&type=' . urlencode($type));
$linkback = '<a href="' . dol_sanitizeUrl($backtolist) . '">' . $langs->trans("BackToList") . '</a>';
$object->next_prev_filter = ' type = ' . $object->type;
$object->ref = $object->label;
$morehtmlref = '<br><div class="refidno"><a href="' . DOL_URL_ROOT . '/Modules/Categories/index.php?leftmenu=cat&type=' . urlencode($type) . '">' . $langs->trans("Root") . '</a> >> ';
