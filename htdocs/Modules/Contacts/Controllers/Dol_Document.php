...
$langs->loadLangs(['other', 'companies', 'contact']);
...
$upload_dir = $conf->societe->multidir_output[$object->entity] . '/Modules/Contacts/' . dol_sanitizeFileName($object->ref);
$modulepart = 'contact';

// Initialize technical object to manage hooks of page. Note that conf->hooks_modules contains array of hook context
$hookmanager->initHooks(['contactdocument']);
