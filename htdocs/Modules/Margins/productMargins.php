...
$hookmanager->initHooks(['marginproductlist']);
...
print img_picto('', 'product') . $form->select_produits(($id > 0 ? $id : ''), 'id', '', 20, 0, 1, 2, '', 1, [], 0, 'All', 0, '', 0, '', null, 1);
print '</td></tr>';

// Categories
$TCats = $form->select_all_categories(0, [], '', 64, 0, 1);
...
$invoice_status_except_list = [Facture::STATUS_DRAFT, Facture::STATUS_ABANDONED];
