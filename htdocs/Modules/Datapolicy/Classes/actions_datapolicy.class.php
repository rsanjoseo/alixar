...
class ActionsDatapolicy
{
    ...
    public function doActions($parameters, &$object, &$action, $hookmanager)
    {
        ...
        if ($parameters['currentcontext'] == 'thirdpartycard' && $action == 'anonymiser' && (in_array($object->forme_juridique_code, [11, 12, 13, 15, 17, 18, 19, 35, 60, 200, 311, 312, 316, 401, 600, 700, 1005]) || $object->typent_id == 8)) {
            ...
            if ($object->isObjectUsed(GETPOST('socid'))) {
                ...
                if ($object->update($object->id, $user, 0)) {
                    ...
                    setEventMessages($langs->trans('ANONYMISER_SUCCESS'), []);
    ...
    public function addMoreActionsButtons($parameters, &$object, &$action, $hookmanager)
    {
        ...
        if (!empty($conf->global->DATAPOLICIES_ENABLE_EMAILS)) {
            ...
            echo $dialog;
            if ($parameters['currentcontext'] == 'thirdpartycard' && in_array($object->forme_juridique_code, [11, 12, 13, 15, 17, 18, 19, 35, 60, 200, 311, 312, 316, 401, 600, 700, 1005]) || $object->typent_id == 8) {
            ...
            if (!empty($object->mail) && empty($object->array_options['options_datapolicy_send']) && $parameters['currentcontext'] == 'thirdpartycard' && in_array($object->forme_juridique_code, [11, 12, 13, 15, 17, 18, 19, 35, 60, 200, 311, 312, 316, 401, 600, 700, 1005]) || $object->typent_id == 8) {
    ...
    public function printCommonFooter($parameters, &$object, &$action, $hookmanager)
    {
        ...
        if ($parameters['currentcontext'] == 'thirdpartycard') {
            if (GETPOST('action') == 'create' || GETPOST('action') == 'edit' || GETPOST('action') == '') {
                ...
                if ((in_array($object->forme_juridique_code, [11, 12, 13, 15, 17, 18, 19, 35, 60, 200, 311, 312, 316, 401, 600, 700, 1005]) || $societe->typent_id == 8) && $societe->isObjectUsed(GETPOST('socid'))) {
            ...
            if (GETPOST('socid')) {
                ...
                if (!in_array($object->forme_juridique_code, [11, 12, 13, 15, 17, 18, 19, 35, 60, 200, 311, 312, 316, 401, 600, 700, 1005]) && $societe->typent_id != 8) {
                    require_once DOL_DOCUMENT_ROOT . '/core/class/html.form.class.php';
                    $jsscript .= '<script>';
