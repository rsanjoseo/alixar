    ...
    public function cleanDataForDataPolicy()
    {
        ...
        $arrayofparameters = [
            'DATAPOLICIES_TIERS_CLIENT' => [
                ...
                ",
                "class" => "Societe",
                "file" => DOL_DOCUMENT_ROOT . '/Modules/Societes/class/societe.class.php',
                'fields_anonym' => [
                    'name' => 'MAKEANONYMOUS',
                    'name_bis' => '',
                    'name_alias' => '',
            ...
            'DATAPOLICIES_TIERS_PROSPECT_CLIENT' => [
                'sql' => "
                    SELECT s.rowid FROM " . MAIN_DB_PREFIX . "societe as s
                    WHERE s.entity = %d
                    AND s.client = 3
            ...
            'DATAPOLICIES_TIERS_NIPROSPECT_NICLIENT' => [
                'sql' => "
                    SELECT s.rowid FROM " . MAIN_DB_PREFIX . "societe as s
                    WHERE s.entity = %d
                    AND s.client = 0
            ...
            'DATAPOLICIES_CONTACT_CLIENT' => [
                ...
                ",
                "class" => "Contact",
                "file" => DOL_DOCUMENT_ROOT . '/Modules/Contacts/class/contact.class.php',
                'fields_anonym' => [
            ...
            'DATAPOLICIES_CONTACT_PROSPECT_CLIENT' => [
                'sql' => "
                    SELECT c.rowid FROM " . MAIN_DB_PREFIX . "socpeople as c
                    INNER JOIN " . MAIN_DB_PREFIX . "societe as s ON s.rowid = c.fk_soc
                    WHERE c.entity = %d
            ...
            'DATAPOLICIES_CONTACT_NIPROSPECT_NICLIENT' => [
                'sql' => "
                    SELECT c.rowid FROM " . MAIN_DB_PREFIX . "socpeople as c
                    INNER JOIN " . MAIN_DB_PREFIX . "societe as s ON s.rowid = c.fk_soc
                    WHERE c.entity = %d
            ...
            'DATAPOLICIES_ADHERENT' => [
                ...
                ",
                "class" => "Adherent",
                "file" => DOL_DOCUMENT_ROOT . '/Modules/Adherents/class/adherent.class.php',
                'fields_anonym' => [
                    'lastname' => 'MAKEANONYMOUS',
