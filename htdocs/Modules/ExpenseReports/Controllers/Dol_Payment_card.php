...
if ($action == 'confirm_delete' && $confirm == 'yes' && $user->rights->expensereport->supprimer) {
    ...
    if ($result > 0) {
        $db->commit();
        header("Location: " . DOL_URL_ROOT . "/Modules/ExpenseReports/index.php");
        exit;
    } else {
...
$linkback = '';
// $linkback = '<a href="' . DOL_URL_ROOT . '/Modules/ExpenseReports/payment/list.php">' . $langs->trans("BackToList") . '</a>';
