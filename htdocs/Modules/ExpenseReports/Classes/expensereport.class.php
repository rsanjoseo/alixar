...
require_once DOL_DOCUMENT_ROOT . '/Modules/ExpenseReports/class/expensereport_rule.class.php';
...
class ExpenseReport extends CommonObject
{
     ...
     */
    public $fk_statut;
    public $fk_c_paiement; // Note fk_user_author is not the 'author' but the guy the expense report is for.
    ...
    public $date_refuse; // User that is defined to approve

    // Validation
    public $detail_refuse; // User making validation
    public $fk_user_refuse;
    public $date_cancel;

    // Approve
    public $detail_cancel;
    public $fk_user_cancel; // User that has approved

    // Paiement
    public $fk_user_validator;
    public $date_valid;    // for backward compatibility (real field should be total_localtax1 defined into CommonObject)
    public $fk_user_valid;    // for backward compatibility (real field should be total_localtax2 defined into CommonObject)
    ...
    public $fields = [
        ...
        'note_public' => ['type' => 'text', 'label' => 'Note public', 'enabled' => 1, 'visible' => 0, 'position' => 150],
        'note_private' => ['type' => 'text', 'label' => 'Note private', 'enabled' => 1, 'visible' => 0, 'position' => 155],
    ...
    public function __construct($db)
    {
        ...
        $this->statuts_short = [0 => 'Draft', 2 => 'Validated', 4 => 'Canceled', 5 => 'Approved', 6 => 'Paid', 99 => 'Refused'];
        $this->statuts = [0 => 'Draft', 2 => 'ValidatedWaitingApproval', 4 => 'Canceled', 5 => 'Approved', 6 => 'Paid', 99 => 'Refused'];
        $this->statuts_logo = [0 => 'status0', 2 => 'status1', 4 => 'status6', 5 => 'status4', 6 => 'status6', 99 => 'status5'];
    }
