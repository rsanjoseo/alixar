...
require_once DOL_DOCUMENT_ROOT . '/Modules/Societes/class/client.class.php';
...
if (!empty($conf->contrat->enabled)) {
    require_once DOL_DOCUMENT_ROOT . '/Modules/Contrats/class/contrat.class.php';
}
if (!empty($conf->adherent->enabled)) {
    require_once DOL_DOCUMENT_ROOT . '/Modules/Adherents/class/adherent.class.php';
}
if (!empty($conf->ficheinter->enabled)) {
    require_once DOL_DOCUMENT_ROOT . '/Modules/Fichinter/class/fichinter.class.php';
}
    ...
    */
    ...
    if ($isCustomer) {
        ...
        if ($user->rights->societe->creer && !$user->socid > 0) {
            print '<a class="editfielda" href="' . DOL_URL_ROOT . '/Modules/Comm/remise.php?id=' . $object->id . '">' . img_edit($langs->trans("Modify")) . '</a>';
        }
        print '</td></tr></table>';
        print '</td><td>' . ($object->remise_percent ? '<a href="' . DOL_URL_ROOT . '/Modules/Comm/remise.php?id=' . $object->id . '">' . $object->remise_percent . '%</a>' : '') . '</td>';
        print '</tr>';
        ...
        print '<td><td class="right">';
        if ($user->rights->societe->creer && !$user->socid > 0) {
            print '<a class="editfielda" href="' . DOL_URL_ROOT . '/Modules/Comm/remx.php?id=' . $object->id . '&backtopage=' . urlencode($_SERVER["PHP_SELF"] . '?socid=' . $object->id) . '">' . img_edit($langs->trans("Modify")) . '</a>';
        }
        print '</td></tr></table>';
        print '</td>';
        print '<td>';
        ...
        if ($amount_discount > 0) {
            print '<a href="' . DOL_URL_ROOT . '/Modules/Comm/remx.php?id=' . $object->id . '&backtopage=' . urlencode($_SERVER["PHP_SELF"] . '?socid=' . $object->id) . '">' . price($amount_discount, 1, $langs, 1, -1, -1, $conf->currency) . '</a>';
        }
    ...
    if (!empty($conf->global->PRODUIT_MULTIPRICES) || !empty($conf->global->PRODUIT_CUSTOMER_PRICES_BY_QTY_MULTIPRICES)) {
        ...
        if ($user->rights->societe->creer) {
            print '<a class="editfielda" href="' . DOL_URL_ROOT . '/Modules/Comm/multiprix.php?id=' . $object->id . '">' . img_edit($langs->trans("Modify")) . '</a>';
        }
        print '</td></tr></table>';
        print '</td><td>';
    ...
    if (!empty($conf->propal->enabled) && $user->rights->propal->lire) {
        ...
        $link = DOL_URL_ROOT . '/Modules/Comm/propal/list.php?socid=' . $object->id;
        $icon = 'bill';
        if ($link) {
    ...
    if (!empty($conf->commande->enabled) && $user->rights->commande->lire) {
        ...
        $link = DOL_URL_ROOT . '/Modules/Commande/list.php?socid=' . $object->id;
        $icon = 'bill';
        if ($link) {
            $boxstat .= '<a href="' . $link . '" class="boxstatsindicator thumbstat nobold nounderline">';
        }
    ...
    if (!empty($conf->facture->enabled) && $user->rights->facture->lire) {
        ...
        $link = DOL_URL_ROOT . '/Modules/Compta/facture/list.php?socid=' . $object->id;
        $icon = 'bill';
        if ($link) {
            $boxstat .= '<a href="' . $link . '" class="boxstatsindicator thumbstat nobold nounderline">';
        }
        ...
        $link = DOL_URL_ROOT . '/Modules/Compta/recap-compta.php?socid=' . $object->id;
        $icon = 'bill';
        if ($link) {
            $boxstat .= '<a href="' . $link . '" class="boxstatsindicator thumbstat nobold nounderline">';
        }
    ...
    if (!empty($conf->propal->enabled) && $user->rights->propal->lire) {
        ...
        if ($resql) {
            ...
            if ($num > 0) {
                ...
                print '<td colspan="4"><table width="100%" class="nobordernopadding"><tr><td>' . $langs->trans("LastPropals", ($num <= $MAXLIST ? "" : $MAXLIST)) . '</td><td class="right"><a class="notasortlink" href="' . DOL_URL_ROOT . '/Modules/Comm/propal/list.php?socid=' . $object->id . '">' . $langs->trans("AllPropals") . '<span class="badge marginleftonlyshort">' . $num . '</span></a></td>';
                print '<td width="20px" class="right"><a href="' . DOL_URL_ROOT . '/Modules/Comm/propal/stats/index.php?socid=' . $object->id . '">' . img_picto($langs->trans("Statistics"), 'stats') . '</a></td>';
                print '</tr></table></td>';
                print '</tr>';
            }
    ...
    if (!empty($conf->commande->enabled) && $user->rights->commande->lire) {
        ...
        if ($resql) {
            ...
            if ($num > 0) {
                ...
                print '<tr class="liste_titre">';
                print '<td colspan="4"><table width="100%" class="nobordernopadding"><tr><td>' . $langs->trans("LastCustomerOrders", ($num <= $MAXLIST ? "" : $MAXLIST)) . '</td><td class="right"><a class="notasortlink" href="' . DOL_URL_ROOT . '/Modules/Commande/list.php?socid=' . $object->id . '">' . $langs->trans("AllOrders") . '<span class="badge marginleftonlyshort">' . $num . '</span></a></td>';
                print '<td width="20px" class="right"><a href="' . DOL_URL_ROOT . '/Modules/Commande/stats/index.php?socid=' . $object->id . '">' . img_picto($langs->trans("Statistics"), 'stats') . '</a></td>';
                print '</tr></table></td>';
                print '</tr>';
            }
    ...
    if (!empty($conf->expedition->enabled) && $user->rights->expedition->lire) {
        ...
        if ($resql) {
            ...
            if ($num > 0) {
                ...
                print '<tr class="liste_titre">';
                print '<td colspan="4"><table width="100%" class="nobordernopadding"><tr><td>' . $langs->trans("LastSendings", ($num <= $MAXLIST ? "" : $MAXLIST)) . '</td><td class="right"><a class="notasortlink" href="' . DOL_URL_ROOT . '/Modules/Expedition/list.php?socid=' . $object->id . '">' . $langs->trans("AllSendings") . '<span class="badge marginleftonlyshort">' . $num . '</span></a></td>';
                print '<td width="20px" class="right"><a href="' . DOL_URL_ROOT . '/Modules/Expedition/stats/index.php?socid=' . $object->id . '">' . img_picto($langs->trans("Statistics"), 'stats') . '</a></td>';
                print '</tr></table></td>';
                print '</tr>';
            }
    ...
    if (!empty($conf->contrat->enabled) && $user->rights->contrat->lire) {
        ...
        if ($resql) {
            ...
            if ($num > 0) {
                ...
                print '<td class="right"><a class="notasortlink" href="' . DOL_URL_ROOT . '/Modules/Contrats/list.php?socid=' . $object->id . '">' . $langs->trans("AllContracts") . '<span class="badge marginleftonlyshort">' . $num . '</span></a></td>';
    ...
    if (!empty($conf->ficheinter->enabled) && $user->rights->ficheinter->lire) {
        ...
        if ($resql) {
            ...
            if ($num > 0) {
                ...
                print '<tr class="liste_titre">';
                print '<td colspan="3"><table width="100%" class="nobordernopadding"><tr><td>' . $langs->trans("LastInterventions", ($num <= $MAXLIST ? "" : $MAXLIST)) . '</td><td class="right"><a class="notasortlink" href="' . DOL_URL_ROOT . '/Modules/Fichinter/list.php?socid=' . $object->id . '">' . $langs->trans("AllInterventions") . '<span class="badge marginleftonlyshort">' . $num . '</span></td>';
                print '<td width="20px" class="right"><a href="' . DOL_URL_ROOT . '/Modules/Fichinter/stats/index.php?socid=' . $object->id . '">' . img_picto($langs->trans("Statistics"), 'stats') . '</a></td>';
                print '</tr></table></td>';
                print '</tr>';
            }
    ...
    if (!empty($conf->facture->enabled) && $user->rights->facture->lire) {
        ...
        if ($resql) {
            ...
            if ($num > 0) {
                ...
                print '<tr class="liste_titre">';
                print '<td colspan="5"><table width="100%" class="nobordernopadding"><tr><td>' . $langs->trans("LastCustomersBills", ($num <= $MAXLIST ? "" : $MAXLIST)) . '</td><td class="right"><a class="notasortlink" href="' . DOL_URL_ROOT . '/Modules/Compta/facture/list.php?socid=' . $object->id . '">' . $langs->trans("AllBills") . '<span class="badge marginleftonlyshort">' . $num . '</span></a></td>';
                print '<td width="20px" class="right"><a href="' . DOL_URL_ROOT . '/Modules/Compta/facture/stats/index.php?socid=' . $object->id . '">' . img_picto($langs->trans("Statistics"), 'stats') . '</a></td>';
                print '</tr></table></td>';
                print '</tr>';
            }
    ...
    if (empty($reshook)) {
        ...
        if (!empty($conf->propal->enabled) && $user->rights->propal->creer && $object->status == 1) {
            $langs->load("propal");
            print '<div class="inline-block divButAction"><a class="butAction" href="' . DOL_URL_ROOT . '/Modules/Comm/propal/card.php?socid=' . $object->id . '&amp;action=create">' . $langs->trans("AddProp") . '</a></div>';
        }

        if (!empty($conf->commande->enabled) && $user->rights->commande->creer && $object->status == 1) {
            $langs->load("orders");
            print '<div class="inline-block divButAction"><a class="butAction" href="' . DOL_URL_ROOT . '/Modules/Commande/card.php?socid=' . $object->id . '&amp;action=create">' . $langs->trans("AddOrder") . '</a></div>';
        }

        if (!empty($user->rights->contrat->creer) && $object->status == 1) {
            $langs->load("contracts");
            print '<div class="inline-block divButAction"><a class="butAction" href="' . DOL_URL_ROOT . '/Modules/Contrats/card.php?socid=' . $object->id . '&amp;action=create">' . $langs->trans("AddContract") . '</a></div>';
        }

        if (!empty($conf->ficheinter->enabled) && $user->rights->ficheinter->creer && $object->status == 1) {
            $langs->load("fichinter");
            print '<div class="inline-block divButAction"><a class="butAction" href="' . DOL_URL_ROOT . '/Modules/Fichinter/card.php?socid=' . $object->id . '&amp;action=create">' . $langs->trans("AddIntervention") . '</a></div>';
        }
        ...
        if ($user->socid == 0) {
            if (!empty($conf->deplacement->enabled) && $object->status == 1) {
                $langs->load("trips");
                print '<div class="inline-block divButAction"><a class="butAction" href="' . DOL_URL_ROOT . '/Modules/Compta/deplacement/card.php?socid=' . $object->id . '&amp;action=create">' . $langs->trans("AddTrip") . '</a></div>';
            }
            ...
            if (!empty($conf->facture->enabled) && $object->status == 1) {
                if (empty($user->rights->facture->creer)) {
                    ...
                    if (!empty($conf->commande->enabled)) {
                        if ($object->client != 0 && $object->client != 2) {
                            if (!empty($orders2invoice) && $orders2invoice > 0) {
                                print '<div class="inline-block divButAction"><a class="butAction" href="' . DOL_URL_ROOT . '/Modules/Commande/list.php?socid=' . $object->id . '&search_billed=0&autoselectall=1">' . $langs->trans("CreateInvoiceForThisCustomer") . '</a></div>';
                            } else {
                    ...
                    if ($object->client != 0 && $object->client != 2) {
                        print '<div class="inline-block divButAction"><a class="butAction" href="' . DOL_URL_ROOT . '/Modules/Compta/facture/card.php?action=create&socid=' . $object->id . '">' . $langs->trans("AddBill") . '</a></div>';
                    } else {
                        print '<div class="inline-block divButAction"><a class="butActionRefused classfortooltip" title="' . dol_escape_js($langs->trans("ThirdPartyMustBeEditAsCustomer")) . '" href="#">' . $langs->trans("AddBill") . '</a></div>';
                    }
                }
        ...
        if (!empty($conf->agenda->enabled) && !empty($conf->global->MAIN_REPEATTASKONEACHTAB) && $object->status == 1) {
            if ($user->rights->agenda->myactions->create) {
                print '<div class="inline-block divButAction"><a class="butAction" href="' . DOL_URL_ROOT . '/Modules/Comm/action/card.php?action=create&socid=' . $object->id . '">' . $langs->trans("AddAction") . '</a></div>';
            } else {
