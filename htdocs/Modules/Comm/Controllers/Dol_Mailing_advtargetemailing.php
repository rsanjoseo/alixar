...
require_once DOL_DOCUMENT_ROOT . '/Modules/Comm/mailing/class/advtargetemailing.class.php';
require_once DOL_DOCUMENT_ROOT . '/Modules/Comm/mailing/class/html.formadvtargetemailing.class.php';
...
if ($object->fetch($id) >= 0) {
    ...
    $linkback = '<a href="' . DOL_URL_ROOT . '/Modules/Comm/mailing/liste.php">' . $langs->trans("BackToList") . '</a>';
