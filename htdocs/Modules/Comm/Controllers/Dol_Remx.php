        ...
        if ($resql) {
            ...
            if ($num > 0) {
                while ($i < $num) {
                    ...
                    print '<a href="' . DOL_URL_ROOT . '/Modules/Users/card.php?id=' . $obj->user_id . '">' . img_object($langs->trans("ShowUser"), 'user') . ' ' . $obj->login . '</a>';
                    print '</td>';
        ...
        if ($resql2) {
            ...
            if ($num > 0) {
                ...
                while ($i < $num) {
                    ...
                    if ($obj->invoiceid) {
                        print '<a href="' . DOL_URL_ROOT . '/Modules/Compta/facture/card.php?facid=' . $obj->invoiceid . '">' . img_object($langs->trans("ShowBill"), 'bill') . ' ' . $obj->ref . '</a>';
                    }
                    print '</td>';
                    print '<td class="right">' . price($obj->amount_ht) . '</td>';
                    if (!empty($conf->multicurrency->enabled)) {
        ...
        if ($resql2) {
            ...
            if ($num > 0) {
                ...
                while ($i < $num) {
                    ...
                    print '<td class="left nowrap">';
                    if ($obj->invoiceid) {
                        print '<a href="' . DOL_URL_ROOT . '/Modules/Fourn/facture/card.php?facid=' . $obj->invoiceid . '">' . img_object($langs->trans("ShowBill"), 'bill') . ' ' . $obj->ref . '</a>';
                    }
                    print '</td>';
                    print '<td class="right">' . price($obj->amount_ht) . '</td>';
                    if (!empty($conf->multicurrency->enabled)) {
