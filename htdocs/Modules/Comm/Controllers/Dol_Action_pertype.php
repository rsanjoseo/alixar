...
jQuery(document).ready(function() {
	jQuery(".onclickopenref").click(function() {
		...
		{
			/* alert(\'no event\'); */
			url = "' . DOL_URL_ROOT . '/Modules/Comm/action/card.php?action=create&assignedtouser="+userid+"&datep="+year+month+day+hour+min+"00&backtopage=' . urlencode($_SERVER["PHP_SELF"] . '?year=' . $year . '&month=' . $month . '&day=' . $day) . '"
