...
if (!empty($conf->propal->enabled)) {
    $var = false;
    print '<form method="post" action="' . DOL_URL_ROOT . '/Modules/Comm/propal/card.php">';
    ...
    if ($resql) {
        ...
        if ($num > 0) {
            ...
            while ($i < $num) {
                ...
                print '<tr class="oddeven"><td>';
                print '<a href="' . DOL_URL_ROOT . '/Modules/Comm/propal/card.php?id=' . $obj->rowid . '">' . img_object($langs->trans("ShowPropal"), "propal") . ' ' . $obj->ref . '</a>';
