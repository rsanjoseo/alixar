...
print '<form method="post" action="' . DOL_URL_ROOT . '/Modules/Comm/mailing/list.php">';
...
if ($result) {
    ...
    print '<td class="right"><a href="' . DOL_URL_ROOT . '/Modules/Comm/mailing/list.php">' . $langs->trans("AllEMailings") . '</a></td></tr>';
