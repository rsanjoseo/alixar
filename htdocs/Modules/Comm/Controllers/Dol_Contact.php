...
if ($resql) {
    ...
    while ($i < min($num, $limit)) {
        ...
        print '<td><a href="' . DOL_URL_ROOT . '/Modules/Contacts/card.php?id=' . $obj->cidp . '&socid=' . $obj->rowid . '">' . img_object($langs->trans("ShowContact"), "contact");
        print '</a>&nbsp;<a href="' . DOL_URL_ROOT . '/Modules/Contacts/card.php?id=' . $obj->cidp . '&socid=' . $obj->rowid . '">' . $obj->name . '</a></td>';
