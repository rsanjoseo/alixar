...
if ($action == 'create') {
    ...
    if ($object->id > 0) {
        ...
        if ($action != 'edit' && $action != 'edithtml') {
            ...
            $linkback = '<a href="' . DOL_URL_ROOT . '/Modules/Comm/mailing/list.php?restore_lastsearch_values=1">' . $langs->trans("BackToList") . '</a>';
            ...
            if (GETPOST('cancel', 'alpha') || $confirm == 'no' || $action == '' || in_array($action, ['settodraft', 'valid', 'delete', 'sendall', 'clone', 'test'])) {
