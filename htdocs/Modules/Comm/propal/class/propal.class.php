...
class Propal extends CommonObject
{
     ...
     */
    public $date_signature; // deprecated; Use delivery_date instead.
    /**
     * @var User $user_signature
     */
    public $user_signature; // Date expected of shipment (date starting shipment, not the reception that occurs some days after)
    /**
    ...
    public $fields = [
        ...
        'fk_soc' => ['type' => 'integer:Societe:societe/class/societe.class.php', 'label' => 'ThirdParty', 'enabled' => 1, 'visible' => -1, 'position' => 23],
        'fk_projet' => ['type' => 'integer:Project:projet/class/project.class.php:1:fk_statut=1', 'label' => 'Fk projet', 'enabled' => 1, 'visible' => -1, 'position' => 24],
        ...
        'fk_account' => ['type' => 'integer', 'label' => 'BankAccount', 'enabled' => 1, 'visible' => -1, 'position' => 150],
        ...
        'note_private' => ['type' => 'text', 'label' => 'NotePublic', 'enabled' => 1, 'visible' => 0, 'position' => 170],
        'note_public' => ['type' => 'text', 'label' => 'NotePrivate', 'enabled' => 1, 'visible' => 0, 'position' => 175],
        ...
        'fk_warehouse' => ['type' => 'integer:Entrepot:product/stock/class/entrepot.class.php', 'label' => 'Fk warehouse', 'enabled' => 1, 'visible' => -1, 'position' => 191],
        ...
        'multicurrency_code' => ['type' => 'varchar(255)', 'label' => 'MulticurrencyCurrency', 'enabled' => '$conf->multicurrency->enabled', 'visible' => -1, 'position' => 235],
        'multicurrency_tx' => ['type' => 'double(24,8)', 'label' => 'MulticurrencyRate', 'enabled' => '$conf->multicurrency->enabled', 'visible' => -1, 'position' => 240, 'isameasure' => 1],
        'multicurrency_total_ht' => ['type' => 'double(24,8)', 'label' => 'MulticurrencyAmountHT', 'enabled' => '$conf->multicurrency->enabled', 'visible' => -1, 'position' => 245, 'isameasure' => 1],
        'multicurrency_total_tva' => ['type' => 'double(24,8)', 'label' => 'MulticurrencyAmountVAT', 'enabled' => '$conf->multicurrency->enabled', 'visible' => -1, 'position' => 250, 'isameasure' => 1],
        'multicurrency_total_ttc' => ['type' => 'double(24,8)', 'label' => 'MulticurrencyAmountTTC', 'enabled' => '$conf->multicurrency->enabled', 'visible' => -1, 'position' => 255, 'isameasure' => 1],
