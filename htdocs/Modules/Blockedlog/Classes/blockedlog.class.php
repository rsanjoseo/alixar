...
class BlockedLog
{
    ...
    public function getObjectLink()
    {
        ...
        if ($this->element === 'invoice_supplier') {
            ...
            require_once DOL_DOCUMENT_ROOT . '/Modules/Compta/cashcontrol/class/cashcontrol.class.php';
            ...
            if (is_array($object->amounts) && !empty($object->amounts)) {
                ...
                foreach ($object->amounts as $objid => $amount) {
                    ...
                    if ($this->element == 'payment_supplier') {
                        ...
                        include_once DOL_DOCUMENT_ROOT . '/Modules/Compta/bank/class/paymentvarious.class.php';
