...
if ($dirins && $action == 'initobject' && $module && $objectname) {
    ...
    if (!$error) {
        ...
        \$this->menu[\$r++]=array(
            ...
            dolReplaceInFile($moduledescriptorfile, ['END MODULEBUILDER LEFTMENU MYOBJECT */' => '*/' . "\n" . $stringtoadd . "\n\t\t/* END MODULEBUILDER LEFTMENU MYOBJECT */"]);
...
if ($module == 'initmodule') {
    ...
    if (!$error) {
        ...
        if ($tab == 'cli') {
            ...
            if ($action != 'editfile' || empty($file)) {
                ...
                if (!empty($clifiles)) {
                    ...
                    print '<tr><td><span class="fa fa-file-o"></span> ' . $langs->trans("CLIFile") . ' : <span class="opacitymedium">' . $langs->trans("FileNotYetGenerated");
                    '</span>';
        ...
        if ($tab == 'cron') {
            ...
            if ($action != 'editfile' || empty($file)) {
                print '<span class="opacitymedium">' . str_replace('{s1}', '<a target="adminbis" class="nofocusvisible" href="' . DOL_URL_ROOT . '/Modules/Cron/list.php">' . $langs->transnoentities('CronList') . '</a>', $langs->trans("CronJobDefDesc", '{s1}')) . '</span><br>';
                print '<br>';
