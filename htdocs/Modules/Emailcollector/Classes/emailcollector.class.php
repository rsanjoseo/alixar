...
require_once DOL_DOCUMENT_ROOT . '/Modules/Comm/propal/class/propal.class.php'; // customer proposal
require_once DOL_DOCUMENT_ROOT . '/Modules/Commande/class/commande.class.php'; // customer order
require_once DOL_DOCUMENT_ROOT . '/Modules/Expedition/class/expedition.class.php'; // Shipment
require_once DOL_DOCUMENT_ROOT . '/Modules/Fourn/class/fournisseur.facture.class.php'; // supplier invoice
require_once DOL_DOCUMENT_ROOT . '/Modules/Fourn/class/fournisseur.commande.class.php'; // supplier order
...
//require_once DOL_DOCUMENT_ROOT.'/Modules/Holiday/class/holiday.class.php'; // Holidays (leave request)
//require_once DOL_DOCUMENT_ROOT.'/Modules/ExpenseReports/class/expensereport.class.php'; // expernse report
...
class EmailCollector extends CommonObject
{
    ...
    public $fields = [
        ...
        'ref' => ['type' => 'varchar(128)', 'label' => 'Ref', 'enabled' => 1, 'visible' => 1, 'notnull' => 1, 'showoncombobox' => 1, 'index' => 1, 'position' => 10, 'searchall' => 1, 'help' => 'Example: MyCollector1'],
        'label' => ['type' => 'varchar(255)', 'label' => 'Label', 'visible' => 1, 'enabled' => 1, 'position' => 30, 'notnull' => -1, 'searchall' => 1, 'help' => 'Example: My Email collector'],
        'description' => ['type' => 'text', 'label' => 'Description', 'visible' => -1, 'enabled' => 1, 'position' => 60, 'notnull' => -1],
        'host' => ['type' => 'varchar(255)', 'label' => 'EMailHost', 'visible' => 1, 'enabled' => 1, 'position' => 90, 'notnull' => 1, 'searchall' => 1, 'comment' => "IMAP server", 'help' => 'Example: imap.gmail.com'],
        'hostcharset' => ['type' => 'varchar(16)', 'label' => 'HostCharset', 'visible' => -1, 'enabled' => 1, 'position' => 91, 'notnull' => 0, 'searchall' => 0, 'comment' => "IMAP server charset", 'help' => 'Example: "UTF-8" (May be "US-ASCII" with some Office365)'],
        'login' => ['type' => 'varchar(128)', 'label' => 'Login', 'visible' => 1, 'enabled' => 1, 'position' => 101, 'notnull' => -1, 'index' => 1, 'comment' => "IMAP login", 'help' => 'Example: myaccount@gmail.com'],
        'password' => ['type' => 'password', 'label' => 'Password', 'visible' => -1, 'enabled' => 1, 'position' => 102, 'notnull' => -1, 'comment' => "IMAP password", 'help' => 'WithGMailYouCanCreateADedicatedPassword'],
        'source_directory' => ['type' => 'varchar(255)', 'label' => 'MailboxSourceDirectory', 'visible' => -1, 'enabled' => 1, 'position' => 103, 'notnull' => 1, 'default' => 'Inbox', 'help' => 'Example: INBOX'],
        ...
        'maxemailpercollect' => ['type' => 'integer', 'label' => 'MaxEmailCollectPerCollect', 'visible' => -1, 'enabled' => 1, 'position' => 111, 'default' => 100],
        'datelastresult' => ['type' => 'datetime', 'label' => 'DateLastCollectResult', 'visible' => 1, 'enabled' => '$action != "create" && $action != "edit"', 'position' => 121, 'notnull' => -1,],
        'codelastresult' => ['type' => 'varchar(16)', 'label' => 'CodeLastResult', 'visible' => 1, 'enabled' => '$action != "create" && $action != "edit"', 'position' => 122, 'notnull' => -1,],
        'lastresult' => ['type' => 'varchar(255)', 'label' => 'LastResult', 'visible' => 1, 'enabled' => '$action != "create" && $action != "edit"', 'position' => 123, 'notnull' => -1,],
        'datelastok' => ['type' => 'datetime', 'label' => 'DateLastcollectResultOk', 'visible' => 1, 'enabled' => '$action != "create"', 'position' => 125, 'notnull' => -1,],
                ...
                foreach ($this->actions as $operation) {
                    ...
                    if ($operation['type'] == 'loadthirdparty' || $operation['type'] == 'loadandcreatethirdparty') {
                        ...
                        if (!is_object($hookmanager)) {
                            $hookmanager->initHooks(['emailcollectorcard']);
                        }
