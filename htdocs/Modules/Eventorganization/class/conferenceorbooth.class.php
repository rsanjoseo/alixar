...
class ConferenceOrBooth extends ActionComm
{
     ...
     */
    public $fields = [
        'id' => ['type' => 'integer', 'label' => 'TechnicalID', 'enabled' => '1', 'position' => 1, 'notnull' => 1, 'visible' => 0, 'noteditable' => '1', 'index' => 1, 'css' => 'left', 'comment' => "Id"],
        'ref' => ['type' => 'integer', 'label' => 'Ref', 'enabled' => '1', 'position' => 1, 'notnull' => 1, 'visible' => 2, 'noteditable' => '1', 'index' => 1, 'css' => 'left', 'comment' => "Id"],
        'label' => ['type' => 'varchar(255)', 'label' => 'Label', 'enabled' => '1', 'position' => 30, 'notnull' => 0, 'visible' => 1, 'searchall' => 1, 'css' => 'minwidth300', 'help' => "Help text", 'showoncombobox' => '1',],
        'fk_soc' => ['type' => 'integer:Societe:societe/class/societe.class.php:1:status=1 AND entity IN (__SHARED_ENTITIES__)', 'label' => 'ThirdParty', 'enabled' => '1', 'position' => 50, 'notnull' => -1, 'visible' => 1, 'index' => 1, 'help' => "LinkToThirparty", 'picto' => 'company', 'css' => 'tdoverflowmax150 maxwidth500'],
        'fk_project' => ['type' => 'integer:Project:projet/class/project.class.php:1:t.usage_organize_event=1', 'label' => 'Project', 'enabled' => '1', 'position' => 52, 'notnull' => -1, 'visible' => -1, 'index' => 1, 'picto' => 'project', 'css' => 'tdoverflowmax150 maxwidth500'],
        'note' => ['type' => 'text', 'label' => 'Description', 'enabled' => '1', 'position' => 60, 'notnull' => 0, 'visible' => 1],
        'fk_action' => ['type' => 'sellist:c_actioncomm:libelle:id::module LIKE (\'%@eventorganization\')', 'label' => 'Format', 'enabled' => '1', 'position' => 60, 'notnull' => 1, 'visible' => 1, 'css' => 'width300'],
        'datep' => ['type' => 'datetime', 'label' => 'DateStart', 'enabled' => '1', 'position' => 70, 'notnull' => 0, 'visible' => 1, 'showoncombobox' => '2',],
        'datep2' => ['type' => 'datetime', 'label' => 'DateEnd', 'enabled' => '1', 'position' => 71, 'notnull' => 0, 'visible' => 1, 'showoncombobox' => '3',],
        'datec' => ['type' => 'datetime', 'label' => 'DateCreation', 'enabled' => '1', 'position' => 500, 'notnull' => 1, 'visible' => -2,],
        'tms' => ['type' => 'timestamp', 'label' => 'DateModification', 'enabled' => '1', 'position' => 501, 'notnull' => 0, 'visible' => -2,],
        'fk_user_author' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'UserAuthor', 'enabled' => '1', 'position' => 510, 'notnull' => 1, 'visible' => -2, 'foreignkey' => 'user.rowid',],
        'fk_user_mod' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'UserModif', 'enabled' => '1', 'position' => 511, 'notnull' => -1, 'visible' => -2,],
        'import_key' => ['type' => 'varchar(14)', 'label' => 'ImportId', 'enabled' => '1', 'position' => 1000, 'notnull' => -1, 'visible' => -2,],
        'status' => ['type' => 'smallint', 'label' => 'Status', 'enabled' => '1', 'position' => 1000, 'notnull' => 1, 'visible' => 1, 'default' => '0', 'index' => 1, 'arrayofkeyval' => ['0' => 'EvntOrgDraft', '1' => 'EvntOrgSuggested', '2' => 'EvntOrgConfirmed', '3' => 'EvntOrgNotQualified', '4' => 'EvntOrgDone', '9' => 'EvntOrgCancelled'],],
        'num_vote' => ['type' => 'smallint', 'label' => 'NbVotes', 'enabled' => '1', 'position' => 1001, 'notnull' => -1, 'visible' => 5, 'default' => '0', 'index' => 0],
    ];
    public $rowid;
    public $id;
    public $label;
    ...
    public function fetch($id, $ref = null, $ref_ext = '', $email_msgid = '')
    {
        ...
        $link_subscription = $dolibarr_main_url_root . '/public/Modules/Eventorganization/attendee_register.php?id=' . urlencode($id) . '&type=conf';

        $encodedsecurekey = dol_hash($conf->global->EVENTORGANIZATION_SECUREKEY . 'conferenceorbooth' . $id, 2);
        $link_subscription .= '&securekey=' . urlencode($encodedsecurekey);

        $this->fields['pubregister'] = ['type' => 'url', 'label' => $langs->trans("PublicAttendeeSubscriptionPage"), 'enabled' => '1', 'position' => 72, 'notnull' => 0, 'visible' => 1];
    ...
    public function getNomUrl($withpicto = 0, $maxlength = 0, $classname = '', $option = '', $overwritepicto = 0, $notooltip = 0, $save_lastsearch_value = -1, $morecss = '')
    {
        ...
        $url = DOL_URL_ROOT . '/Modules/Eventorganization/conferenceorbooth_card.php?id=' . $this->id;
        ...
        $hookmanager->initHooks(['conferenceorboothdao']);
    ...
    public function generateDocument($modele, $outputlangs, $hidedetails = 0, $hidedesc = 0, $hideref = 0, $moreparams = null)
    {
        ...
        $modelpath = "'Modules/Eventorganization/doc/";
