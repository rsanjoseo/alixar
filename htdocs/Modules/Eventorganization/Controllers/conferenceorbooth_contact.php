...
$langs->loadLangs(["eventorganization@eventorganization", "companies", "other", "mails"]);
...
$hookmanager->initHooks(['conferenceorboothcontact', 'globalcard']); // Note that conf->hooks_modules contains array
...
if ($object->id) {
    ...
    $linkback = '<a href="' . dol_buildpath('/Modules/Eventorganization/conferenceorbooth_list.php', 1) . '?restore_lastsearch_values=1' . (!empty($socid) ? '&socid=' . $socid : '') . '">' . $langs->trans("BackToList") . '</a>';
