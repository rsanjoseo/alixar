...
$langs->loadLangs(["eventorganization", "companies", "other", "mails"]);
...
$hookmanager->initHooks(['conferenceorboothdocument', 'globalcard']); // Note that conf->hooks_modules contains array
