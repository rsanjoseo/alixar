...
dol_include_once('/Modules/Eventorganization/class/conferenceorboothattendee.class.php');
dol_include_once('/Modules/Eventorganization/lib/eventorganization_conferenceorboothattendee.lib.php');

// Load translation files required by the page
$langs->loadLangs(["eventorganization@eventorganization", "companies"]);
...
$hookmanager->initHooks(['conferenceorboothattendeenote', 'globalcard']); // Note that conf->hooks_modules contains array
...
if ($id > 0 || !empty($ref)) {
    ...
    // Object card
    // ------------------------------------------------------------
    $linkback = '<a href="' . dol_buildpath('/Modules/Eventorganization/conferenceorboothattendee_list.php', 1) . '?restore_lastsearch_values=1' . (!empty($socid) ? '&socid=' . $socid : '') . '">' . $langs->trans("BackToList") . '</a>';
