...
class ConferenceOrBoothAttendee extends CommonObject
{
    ...
    public $fields = [
        ...
        'ref' => ['type' => 'varchar(128)', 'label' => 'Ref', 'enabled' => '1', 'position' => 10, 'notnull' => 1, 'visible' => 2, 'index' => 1, 'comment' => "Reference of object"],
        'fk_actioncomm' => ['type' => 'integer:ActionComm:comm/action/class/actioncomm.class.php:1', 'label' => 'ConferenceOrBooth', 'enabled' => '1', 'position' => 55, 'notnull' => 0, 'visible' => 0, 'index' => 1, 'picto' => 'agenda'],
        'fk_project' => ['type' => 'integer:Project:projet/class/project.class.php:1', 'label' => 'Project', 'enabled' => '1', 'position' => 20, 'notnull' => 1, 'visible' => 0, 'index' => 1, 'picto' => 'project', 'css' => 'tdoverflowmax150 maxwidth500'],
        'email' => ['type' => 'mail', 'label' => 'EmailAttendee', 'enabled' => '1', 'position' => 30, 'notnull' => 1, 'visible' => 1, 'index' => 1,],
        'fk_soc' => ['type' => 'integer:Societe:societe/class/societe.class.php:1:status = 1 AND entity IN (__SHARED_ENTITIES__)', 'label' => 'ThirdParty', 'enabled' => '1', 'position' => 40, 'notnull' => -1, 'visible' => 1, 'index' => 1, 'help' => "LinkToThirparty", 'picto' => 'company', 'css' => 'tdoverflowmax150 maxwidth500'],
        'date_subscription' => ['type' => 'datetime', 'label' => 'DateOfRegistration', 'enabled' => '1', 'position' => 56, 'notnull' => 0, 'visible' => 1, 'showoncombobox' => '1',],
        'fk_invoice' => ['type' => 'integer:Facture:compta/facture/class/facture.class.php', 'label' => 'Invoice', 'enabled' => '1', 'position' => 57, 'notnull' => 0, 'visible' => -1, 'index' => 0, 'picto' => 'bill', 'css' => 'tdoverflowmax150 maxwidth500'],
        'amount' => ['type' => 'price', 'label' => 'AmountPaid', 'enabled' => '1', 'position' => 57, 'notnull' => 0, 'visible' => 1, 'default' => 'null', 'isameasure' => '1', 'help' => "AmountOfSubscriptionPaid",],
        'note_public' => ['type' => 'html', 'label' => 'NotePublic', 'enabled' => '1', 'position' => 61, 'notnull' => 0, 'visible' => 3,],
        'note_private' => ['type' => 'html', 'label' => 'NotePrivate', 'enabled' => '1', 'position' => 62, 'notnull' => 0, 'visible' => 3,],
        ...
        'fk_user_creat' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'UserAuthor', 'enabled' => '1', 'position' => 510, 'notnull' => -1, 'visible' => -2],
        ...
        'status' => ['type' => 'smallint', 'label' => 'Status', 'enabled' => '1', 'position' => 1000, 'default' => 0, 'notnull' => 1, 'visible' => 1, 'index' => 1, 'arrayofkeyval' => ['0' => 'Draft', '1' => 'Validated', '9' => 'Canceled'],],
    ];
    public $rowid;
    public $ref;
    public $fk_soc;
    ...
    public function getNextNumRef()
    {
        ...
        if (!empty($conf->global->EVENTORGANIZATION_CONFERENCEORBOOTHATTENDEE_ADDON)) {
            ...
            foreach ($dirmodels as $reldir) {
                $dir = dol_buildpath($reldir . "'Modules/Eventorganization/");
    ...
    public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
    {
        ...
        $url = DOL_URL_ROOT . '/Modules/Eventorganization/conferenceorboothattendee_card.php?id=' . $this->id;
        ...
        $hookmanager->initHooks(['conferenceorboothattendeedao']);
    ...
    public function getLinesArray()
    {
        ...
        $result = $objectline->fetchAll('ASC', 'position', 0, 0, ['customsql' => 'fk_conferenceorboothattendee = ' . ((int) $this->id)]);
