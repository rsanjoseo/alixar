...
$langs->loadLangs(['admin', 'cron', 'members']);
...
if (!empty($cancel)) {
    if (!empty($id) && empty($backtopage)) {
        ...
        if ($backtopage) {
            ...
            header("Location: " . DOL_URL_ROOT . '/Modules/Cron/list.php');
            exit;
        }
    }
}
...
if (($action == "create") || ($action == "edit")) {
    ...
    $linkback = '<a href="' . DOL_URL_ROOT . '/Modules/Cron/list.php?restore_lastsearch_values=1">' . $langs->trans("BackToList") . '</a>';
