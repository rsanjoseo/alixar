...
if (!$ret) {
    ...
    if (($element_id || $element_ref) && $element == 'action') {
        ...
        if (is_object($act)) {
            ...
            $linkback .= '<a href="' . DOL_URL_ROOT . '/Modules/Comm/action/list.php?action=show_list">' . $langs->trans("BackToList") . '</a>';
            ...
            $out .= '<a href="' . DOL_URL_ROOT . '/Modules/Comm/action/peruser.php?action=show_peruser&year=' . dol_print_date($act->datep, '%Y') . '&month=' . dol_print_date($act->datep, '%m') . '&day=' . dol_print_date($act->datep, '%d') . '">' . $langs->trans("ViewPerUser") . '</a>';
            $out .= '</li><li class="noborder litext">' . img_picto($langs->trans("ViewCal"), 'object_calendar', 'class="hideonsmartphone pictoactionview"');
            $out .= '<a href="' . DOL_URL_ROOT . '/Modules/Comm/action/index.php?action=show_month&year=' . dol_print_date($act->datep, '%Y') . '&month=' . dol_print_date($act->datep, '%m') . '&day=' . dol_print_date($act->datep, '%d') . '">' . $langs->trans("ViewCal") . '</a>';
            ...
            $out .= '<a href="' . DOL_URL_ROOT . '/Modules/Comm/action/index.php?action=show_day&year=' . dol_print_date($act->datep, '%Y') . '&month=' . dol_print_date($act->datep, '%m') . '&day=' . dol_print_date($act->datep, '%d') . '">' . $langs->trans("ViewWeek") . '</a>';
            $out .= '</li><li class="noborder litext">' . img_picto($langs->trans("ViewDay"), 'object_calendarday', 'class="hideonsmartphone pictoactionview"');
            $out .= '<a href="' . DOL_URL_ROOT . '/Modules/Comm/action/index.php?action=show_day&year=' . dol_print_date($act->datep, '%Y') . '&month=' . dol_print_date($act->datep, '%m') . '&day=' . dol_print_date($act->datep, '%d') . '">' . $langs->trans("ViewDay") . '</a>';
            ...
            if (!empty($conf->projet->enabled)) {
                ...
                if (!empty($act->fk_project)) {
                    ...
                    $morehtmlref .= '<a href="' . DOL_URL_ROOT . '/Modules/Projects/card.php?id=' . $act->fk_project . '" title="' . $langs->trans('ShowProject') . '">';
    ...
    if (($element_id || $element_ref) && $element == 'fichinter') {
        ...
        if (is_object($fichinter)) {
            ...
            // Intervention card
            $linkback = '<a href="' . DOL_URL_ROOT . '/Modules/Fichinter/list.php' . (!empty($socid) ? '?socid=' . $socid : '') . '">' . $langs->trans("BackToList") . '</a>';
            ...
            if (!empty($conf->projet->enabled)) {
                ...
                if ($user->rights->commande->creer) {
                    ...
                    if (!empty($fichinter->fk_project)) {
                        ...
                        $morehtmlref .= '<a href="' . DOL_URL_ROOT . '/Modules/Projects/card.php?id=' . $fichinter->fk_project . '" title="' . $langs->trans('ShowProject') . '">';
                        $morehtmlref .= $proj->ref;
                        $morehtmlref .= '</a>';
                    } else {
                        $morehtmlref .= '';
