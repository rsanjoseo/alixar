...
if ($action == 'create') {
    ...
    print img_picto('', 'user') . ' ' . $form->select_dolusers(GETPOSTISSET('userid') ? GETPOST('userid', 'int') : $user->id, 'userid', 0, '', 0, ($user->admin ? '' : [$user->id]), '', 0, 0, 0, '', ($user->admin) ? 1 : 0, '', 'maxwidth300');
