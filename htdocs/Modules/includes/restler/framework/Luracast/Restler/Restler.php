...
class Restler extends EventDispatcher
{
     ...
     * @var array
     */
    protected $postAuthFilterClasses = [];
    ...
    protected function getPath()
    {
        ...
        [$base, $path] = Util::splitCommonPath(
    ...
    public function getRequestData($includeQueryParameters = true)
    {
        ...
        if ($this->requestMethod == 'PUT'
            ...
            $r = is_array($r)
                ? array_merge($r, [Defaults::$fullRequestDataName => $r])
                : [Defaults::$fullRequestDataName => $r];
            return $includeQueryParameters
                ? $r + $get
                : $r;
        }
        return $includeQueryParameters ? $get : []; //no body
    }
    ...
    protected function route()
    {
        ...
        if (!Defaults::$smartParameterParsing) {
            $params = $params + [Defaults::$fullRequestDataName => $params];
        }
    ...
    protected function negotiateResponseFormat()
    {
        ...
        if ($metadata && isset($metadata['format'])) {
            ...
            call_user_func_array([$this, 'setSupportedFormats'], $formats);
        }
    ...
    protected function postCall()
    {
        ...
        if (method_exists($o->className, $postCall)) {
            ...
            $this->responseData = call_user_func([
                Scope::get($o->className),
                $postCall,
            ], $this->responseData);
        }
