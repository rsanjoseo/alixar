...
class Odf
{
    ...
    public $creator;
    public $title;            // To store content of content.xml file
    public $subject;                // To store content of meta.xml file
    public $userdefined = [];            // To store content of styles.xml file
    protected $config = [
    ...
    public function __construct($filename, $config = [])
    {
        ...
        if (in_array($this->config['ZIP_PROXY'], ['PclZipProxy']) && !is_dir($this->config['PATH_TO_TMP'])) {
