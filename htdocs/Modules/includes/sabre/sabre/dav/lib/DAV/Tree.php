...
class Tree
{
    ...
    function nodeExists($path)
    {
        ...
        try {
            ...
            [$parent, $base] = URLUtil::splitPath($path);
    ...
    function getNodeForPath($path)
    {
        ...
        [$parentName, $baseName] = URLUtil::splitPath($path);
    ...
    function move($sourcePath, $destinationPath)
    {
        ...
        [$sourceDir] = URLUtil::splitPath($sourcePath);
        [$destinationDir, $destinationName] = URLUtil::splitPath($destinationPath);
    ...
    function getMultipleNodes($paths)
    {
        ...
        foreach ($paths as $path) {
            [$parent, $node] = URLUtil::splitPath($path);
