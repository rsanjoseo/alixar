...
if ($resql) {
    ...
    print '<a href="' . DOL_URL_ROOT . '/Modules/Expedition/list.php?search_status=' . Expedition::STATUS_DRAFT . '">';
    ...
    if ($num) {
        ...
        while ($i < $num) {
            ...
            print "</td>";
            print '<td>';
            print '<a href="' . DOL_URL_ROOT . '/Modules/Comm/card.php?socid=' . $obj->socid . '">' . $obj->name . '</a>';
            print '</td>';
            print '<td>';
            if ($obj->commande_id) {
                print '<a href="' . DOL_URL_ROOT . '/Modules/Commande/card.php?id=' . $obj->commande_id . '">' . $obj->commande_ref . '</a>';
            }
            print '</td></tr>';
            $i++;
        }
...
if ($resql) {
    ...
    print '<a href="' . DOL_URL_ROOT . '/Modules/Expedition/list.php?search_status=' . Expedition::STATUS_VALIDATED . '">';
    print '<span class="badge">' . $num . '</span>';
    print '</a>';
    print '</th>';
    print '</tr>';
...
if ($resql) {
    ...
    print '<a href="' . DOL_URL_ROOT . '/Modules/Commande/list.php?search_status=' . Commande::STATUS_VALIDATED . ',' . Commande::STATUS_ACCEPTED . '">';
    print '<span class="badge">' . $num . '</span>';
    print '</a>';
    print '</th>';
    print '</tr>';
