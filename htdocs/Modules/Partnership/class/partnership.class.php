...
class Partnership extends CommonObject
{
    ...
    public $fields = [
        ...
        'status' => ['type' => 'smallint', 'label' => 'Status', 'enabled' => '1', 'position' => 54, 'notnull' => 0, 'visible' => 2, 'index' => 1, 'arrayofkeyval' => ['-1' => '', '0' => 'Draft', '1' => 'Accepted', '2' => 'Refused', '9' => 'Canceled'],],
        'count_last_url_check_error' => ['type' => 'integer', 'label' => 'CountLastUrlCheckError', 'enabled' => '1', 'position' => 63, 'notnull' => 0, 'visible' => -2, 'default' => '0',],
        'last_check_backlink' => ['type' => 'datetime', 'label' => 'LastCheckBacklink', 'enabled' => '1', 'position' => 65, 'notnull' => 0, 'visible' => -2,],
        'reason_decline_or_cancel' => ['type' => 'text', 'label' => 'ReasonDeclineOrCancel', 'enabled' => '1', 'position' => 64, 'notnull' => 0, 'visible' => -2,],
