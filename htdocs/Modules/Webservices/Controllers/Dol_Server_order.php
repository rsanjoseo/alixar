...
$order_fields = [
    ...
    'ref_int' => ['name' => 'ref_int', 'type' => 'xsd:string'],
    ...
    'remise' => ['name' => 'remise', 'type' => 'xsd:string'],
    'remise_percent' => ['name' => 'remise_percent', 'type' => 'xsd:string'],
    'remise_absolue' => ['name' => 'remise_absolue', 'type' => 'xsd:string'],
