...
print $form->selectarray("PAYPAL_SSLVERSION", ['1' => $langs->trans('TLSv1'), '6' => $langs->trans('TLSv1.2')], $conf->global->PAYPAL_SSLVERSION);
print '</td></tr>';
...
print $form->selectarray("PAYPAL_API_INTEGRAL_OR_PAYPALONLY", ['integral' => $langs->trans('PaypalModeIntegral'), 'paypalonly' => $langs->trans('PaypalModeOnlyPaypal')], $conf->global->PAYPAL_API_INTEGRAL_OR_PAYPALONLY);
print '</td></tr>';
