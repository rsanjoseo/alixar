...
$langs->loadLangs(["knowledgemanagement", "ticket", "other"]);
...
$hookmanager->initHooks(['knowledgerecordcard', 'globalcard']); // Note that conf->hooks_modules contains array
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create'))) {
    ...
    if ($action != 'presend') {
        ...
        $linktoelem = $form->showLinkToObjectBlock($object, null, ['knowledgerecord']);
