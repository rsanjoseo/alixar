...
$langs->loadLangs(["knowledgemanagement", "companies", "other", "mails"]);
...
$hookmanager->initHooks(['knowledgerecorddocument', 'globalcard']); // Note that conf->hooks_modules contains array
