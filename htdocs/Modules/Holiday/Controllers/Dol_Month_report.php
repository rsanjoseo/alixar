...
$arrayfields = [
    ...
    'cp.fk_user' => ['label' => $langs->trans('Employee'), 'checked' => 1],
    'ct.label' => ['label' => $langs->trans('Type'), 'checked' => 1],
    'cp.date_debut' => ['label' => $langs->trans('DateDebCP'), 'checked' => 1],
    'cp.date_fin' => ['label' => $langs->trans('DateFinCP'), 'checked' => 1],
    'used_days' => ['label' => $langs->trans('NbUseDaysCPShort'), 'checked' => 1],
    'date_start_month' => ['label' => $langs->trans('DateStartInMonth'), 'checked' => 1],
    'date_end_month' => ['label' => $langs->trans('DateEndInMonth'), 'checked' => 1],
    'used_days_month' => ['label' => $langs->trans('NbUseDaysCPShortInMonth'), 'checked' => 1],
    'cp.description' => ['label' => $langs->trans('DescCP'), 'checked' => 1],
];
