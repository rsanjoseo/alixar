...
$arrayfields = [
    ...
    'cp.date_approve' => ['label' => $langs->trans("DateApprove"), 'checked' => 1, 'position' => 70],
...
if ($resql) {
    ...
    if ($id > 0) {        // For user tab
        ...
        if ($canedit) {
            print '<a href="' . DOL_URL_ROOT . '/Modules/Holiday/card.php?action=create&fuserid=' . $user_id . '" class="butAction">' . $langs->trans("AddCP") . '</a>';
        }
        ...
        $newcardbutton = dolGetButtonTitle($langs->trans('MenuAddCP'), '', 'fa fa-plus-circle', DOL_URL_ROOT . '/Modules/Holiday/card.php?action=create', '', $user->rights->holiday->write);
