...
if (!$rowid && $action != 'create' && $action != 'edit') {
    ...
    if ($result) {
        ...
        if ($user->rights->adherent->configurer) {
            $newcardbutton .= dolGetButtonTitle($langs->trans('NewMemberType'), '', 'fa fa-plus-circle', DOL_URL_ROOT . '/Modules/Adherents/type.php?action=create');
        }
...
if ($action == 'create') {
    ...
    print $form->selectarray('status', ['0' => $langs->trans('ActivityCeased'), '1' => $langs->trans('InActivity')], 1);
    print '</td></tr>';
...
if ($rowid > 0) {
    if ($action != 'edit') {
        ...
        $linkback = '<a href="' . DOL_URL_ROOT . '/Modules/Adherents/type.php?restore_lastsearch_values=1">' . $langs->trans("BackToList") . '</a>';
    ...
    if ($action == 'edit') {
        ...
        print '<tr><td>' . $langs->trans("Status") . '</td><td>';
        print $form->selectarray('status', ['0' => $langs->trans('ActivityCeased'), '1' => $langs->trans('InActivity')], $object->status);
        print '</td></tr>';
