...
$arrayfields = [
    ...
    'd.civility' => ['label' => $langs->trans("Civility"), 'checked' => 0],
    'd.lastname' => ['label' => $langs->trans("Lastname"), 'checked' => 1],
    'd.firstname' => ['label' => $langs->trans("Firstname"), 'checked' => 1],
    'd.gender' => ['label' => $langs->trans("Gender"), 'checked' => 0],
    'd.company' => ['label' => $langs->trans("Company"), 'checked' => 1],
    'd.login' => ['label' => $langs->trans("Login"), 'checked' => 1],
    'd.morphy' => ['label' => $langs->trans("MemberNature"), 'checked' => 1],
    't.libelle' => ['label' => $langs->trans("Type"), 'checked' => 1],
    'd.email' => ['label' => $langs->trans("Email"), 'checked' => 1],
    'd.address' => ['label' => $langs->trans("Address"), 'checked' => 0],
    'd.zip' => ['label' => $langs->trans("Zip"), 'checked' => 0],
    'd.town' => ['label' => $langs->trans("Town"), 'checked' => 0],
    'd.phone' => ['label' => $langs->trans("Phone"), 'checked' => 0],
    'd.phone_perso' => ['label' => $langs->trans("PhonePerso"), 'checked' => 0],
    'd.phone_mobile' => ['label' => $langs->trans("PhoneMobile"), 'checked' => 0],
    'state.nom' => ['label' => $langs->trans("State"), 'checked' => 0],
    'country.code_iso' => ['label' => $langs->trans("Country"), 'checked' => 0],
    /*'d.note_public'=>array('label'=>$langs->trans("NotePublic"), 'checked'=>0),
    'd.note_private'=>array('label'=>$langs->trans("NotePrivate"), 'checked'=>0),*/
    'd.datefin' => ['label' => $langs->trans("EndSubscription"), 'checked' => 1, 'position' => 500],
    'd.datec' => ['label' => $langs->trans("DateCreation"), 'checked' => 0, 'position' => 500],
    'd.birth' => ['label' => $langs->trans("Birthday"), 'checked' => 0, 'position' => 500],
    'd.tms' => ['label' => $langs->trans("DateModificationShort"), 'checked' => 0, 'position' => 500],
    'd.statut' => ['label' => $langs->trans("Status"), 'checked' => 1, 'position' => 1000],
];
// Extra fields
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $sall) {
    ...
    $id = $obj->rowid;
    header("Location: " . DOL_URL_ROOT . '/Modules/Adherents/card.php?id=' . $id);
    exit;
}
...
$newcardbutton = '';
if ($user->rights->adherent->creer) {
    $newcardbutton .= dolGetButtonTitle($langs->trans('NewMember'), '', 'fa fa-plus-circle', DOL_URL_ROOT . '/Modules/Adherents/card.php?action=create');
}
