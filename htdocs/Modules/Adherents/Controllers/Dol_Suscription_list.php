...
$arrayfields = [
    ...
    'd.bank' => ['label' => "BankAccount", 'checked' => 1, 'enabled' => (!empty($conf->banque->enabled))],
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $sall) {
    ...
    $id = $obj->rowid;
    header("Location: " . DOL_URL_ROOT . '/Modules/Adherents/subscription/card.php?id=' . $id);
    exit;
}
...
if ($user->rights->adherent->cotisation->creer) {
    $newcardbutton .= dolGetButtonTitle($langs->trans('NewSubscription'), '', 'fa fa-plus-circle', DOL_URL_ROOT . '/Modules/Adherents/list.php?status=-1,1');
}
