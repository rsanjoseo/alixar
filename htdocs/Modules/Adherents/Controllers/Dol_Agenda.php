...
if ($object->id > 0) {
    ...
    if (!empty($conf->agenda->enabled)) {
        $newcardbutton .= dolGetButtonTitle($langs->trans('AddAction'), '', 'fa fa-plus-circle', DOL_URL_ROOT . '/Modules/Comm/action/card.php?action=create&backtopage=1&origin=member&originid=' . $id);
    }
