...
class Adherent extends CommonObject
{
    ...
    public $fields = [
        ...
        'gender' => ['type' => 'varchar(10)', 'label' => 'Gender', 'enabled' => 1, 'visible' => -1, 'position' => 250],
        ...
        'fk_adherent_type' => ['type' => 'integer', 'label' => 'Fk adherent type', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 55],
        'morphy' => ['type' => 'varchar(3)', 'label' => 'MorPhy', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 60],
        ...
        'email' => ['type' => 'varchar(255)', 'label' => 'Email', 'enabled' => 1, 'visible' => -1, 'position' => 100],
        'url' => ['type' => 'varchar(255)', 'label' => 'Url', 'enabled' => 1, 'visible' => -1, 'position' => 110],
        'socialnetworks' => ['type' => 'text', 'label' => 'Socialnetworks', 'enabled' => 1, 'visible' => -1, 'position' => 105],
        ...
        'note_private' => ['type' => 'text', 'label' => 'NotePublic', 'enabled' => 1, 'visible' => 0, 'position' => 155],
        'note_public' => ['type' => 'text', 'label' => 'NotePrivate', 'enabled' => 1, 'visible' => 0, 'position' => 160],
        ...
        'statut' => [
            'type' => 'smallint(6)', 'label' => 'Statut', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 500,
            'arrayofkeyval' => [-1 => 'Draft', 1 => 'Validated', 0 => 'MemberStatusResiliatedShort', -2 => 'MemberStatusExcludedShort'],
        ],
                ...
                while ($i < $num_rows) {
                    ...
                    if (empty($adherent->email)) {
                        ...
                        if (!empty($labeltouse) && is_object($arraydefaultmessage) && $arraydefaultmessage->id > 0) {
                            ...
                            include_once DOL_DOCUMENT_ROOT . '/core/class/CMailFile.class.php';
                            $cmail = new CMailFile($subject, $to, $from, $msg, [], [], [], '', '', 0, 1, '', '', $trackid, $moreinheader);
