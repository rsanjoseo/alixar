...
<form method="post" name="formmember" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
    ...
    <table class="border allwidth">
        ...
        <tr>
            ...
            <td colspan="3"><input name="morphy" type="text" class="minwidth200"
                                   value="<?php echo $this->control->tpl['select_morphy']; ?>"></td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3" class="tdtop"><textarea name="note" cols="70"
