...
if (!empty($conf->mrp->enabled)) {
    require_once DOL_DOCUMENT_ROOT . '/Modules/Mrp/class/mo.class.php';
}
...
$listofreferent = [
    'entrepot' => [
        ...
        'urlnew' => DOL_URL_ROOT . '/Modules/Products/stock/card.php?action=create&projectid=' . $id,
        'lang' => 'entrepot',
    ...
    'propal' => [
        ...
        'table' => 'propal',
        'datefieldname' => 'datep',
        'urlnew' => DOL_URL_ROOT . '/Modules/Comm/propal/card.php?action=create&origin=project&originid=' . $id . '&socid=' . $socid,
        'lang' => 'propal',
        'buttonnew' => 'AddProp',
    ...
    'order' => [
        ...
        'urlnew' => DOL_URL_ROOT . '/Modules/Commande/card.php?action=create&projectid=' . $id . '&socid=' . $socid,
        'lang' => 'orders',
    ...
    'invoice' => [
        ...
        'table' => 'facture',
        'datefieldname' => 'datef',
        'urlnew' => DOL_URL_ROOT . '/Modules/Compta/facture/card.php?action=create&projectid=' . $id . '&socid=' . $socid,
        'lang' => 'bills',
    ...
    'order_supplier' => [
        ...
        'datefieldname' => 'date_commande',
        'urlnew' => DOL_URL_ROOT . '/Modules/Fourn/commande/card.php?action=create&projectid=' . $id, // No socid parameter here, the socid is often the customer and we create a supplier object
        'lang' => 'suppliers',
    ...
    'invoice_supplier' => [
        ...
        'table' => 'facture_fourn',
        'datefieldname' => 'datef',
        'urlnew' => DOL_URL_ROOT . '/Modules/Fourn/facture/card.php?action=create&projectid=' . $id, // No socid parameter here, the socid is often the customer and we create a supplier object
        'lang' => 'suppliers',
    ...
    'contract' => [
        ...
        'urlnew' => DOL_URL_ROOT . '/Modules/Contrats/card.php?action=create&projectid=' . $id . '&socid=' . $socid,
        'lang' => 'contracts',
    ...
    'intervention' => [
        ...
        'disableamount' => 0,
        'margin' => 'minus',
        'urlnew' => DOL_URL_ROOT . '/Modules/Fichinter/card.php?action=create&origin=project&originid=' . $id . '&socid=' . $socid,
        'lang' => 'interventions',
    ...
    'shipping' => [
        ...
        'table' => 'expedition',
        'datefieldname' => 'date_valid',
        'urlnew' => DOL_URL_ROOT . '/Modules/Expedition/card.php?action=create&origin=project&originid=' . $id . '&socid=' . $socid,
        'lang' => 'sendings',
    ...
    'mrp' => [
        ...
        'table' => 'mrp_mo',
        'datefieldname' => 'date_valid',
        'urlnew' => DOL_URL_ROOT . '/Modules/Mrp/mo_card.php?action=create&origin=project&originid=' . $id . '&socid=' . $socid,
        'lang' => 'mrp',
        'buttonnew' => 'CreateMO',
    ...
    'expensereport' => [
        ...
        'margin' => 'minus',
        'disableamount' => 0,
        'urlnew' => DOL_URL_ROOT . '/Modules/ExpenseReports/card.php?action=create&projectid=' . $id . '&socid=' . $socid,
        'lang' => 'trips',
        'buttonnew' => 'AddTrip',
    ...
    'donation' => [
        ...
        'disableamount' => 0,
        'urlnew' => DOL_URL_ROOT . '/Modules/Don/card.php?action=create&projectid=' . $id . '&socid=' . $socid,
        'lang' => 'donations',
    ...
    'chargesociales' => [
        ...
        'disableamount' => 0,
        'urlnew' => DOL_URL_ROOT . '/Modules/Compta/sociales/card.php?action=create&projectid=' . $id,
        'lang' => 'compta',
    ...
    'project_task' => [
        ...
        'disableamount' => 0,
        'urlnew' => DOL_URL_ROOT . '/Modules/Projects/tasks/time.php?withproject=1&action=createtime&projectid=' . $id,
    ...
    'variouspayment' => [
        ...
        'margin' => 'minus',
        'disableamount' => 0,
        'urlnew' => DOL_URL_ROOT . '/Modules/Compta/bank/various_payment/card.php?action=create&projectid=' . $id,
        'lang' => 'banks',
    ...
    'agenda'=>array(
        ...
        'datefieldname'=>'datep',
        'disableamount'=>1,
        'urlnew'=>DOL_URL_ROOT.'/Modules/Comm/action/card.php?action=create&projectid='.$id.'&socid='.$socid,
        'lang'=>'agenda',
        'buttonnew'=>'AddEvent',
...
foreach ($listofreferent as $key => $value) {
    ...
    if ($qualified) {
        ...
        } elseif (in_array($tablename, ['expensereport_det', 'don', 'projet_task', 'stock_mouvement', 'payment_salary'])) {
        ...
        if (is_array($elementarray) && count($elementarray) > 0) {
            ...
            for ($i = 0; $i < $num; $i++) {
                ...
                if ($tablename == 'actioncomm') {
                    ...
                    print '<a href="' . DOL_URL_ROOT . '/Modules/Projects/tasks/time.php?id=' . $idofelement . '&withproject=1">';
