 ...
 * Statistics
 */
include DOL_DOCUMENT_ROOT . '/Modules/Projects/graph_opportunities.inc.php';

// List of draft projects
print_projecttasks_array($db, $form, $socid, $projectsListId, 0, 0, $listofoppstatus, ['projectlabel', 'plannedworkload', 'declaredprogress', 'prospectionstatus', 'projectstatus']);
...
if ($resql) {
    ...
    while ($i < $num) {
        ...
        if ($obj->socid) {
            print '<a href="' . DOL_URL_ROOT . '/Modules/Projects/list.php?socid=' . $obj->socid . '&search_status=1">' . $obj->nb . '</a>';
        } else {
            print '<a href="' . DOL_URL_ROOT . '/Modules/Projects/list.php?search_societe=' . urlencode('^$') . '&search_status=1">' . $obj->nb . '</a>';
        }
        print '</td>';
        print "</tr>\n";
