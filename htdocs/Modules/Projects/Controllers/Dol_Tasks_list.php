...
$arrayfields = [
    ...
    'p.ref' => ['label' => "ProjectRef", 'checked' => 1],
    'p.title' => ['label' => "ProjectLabel", 'checked' => 0],
    's.nom' => ['label' => "ThirdParty", 'checked' => 0],
    'p.fk_statut' => ['label' => "ProjectStatus", 'checked' => 1],
    't.planned_workload' => ['label' => "PlannedWorkload", 'checked' => 1, 'position' => 102],
    't.duration_effective' => ['label' => "TimeSpent", 'checked' => 1, 'position' => 103],
    't.progress_calculated' => ['label' => "ProgressCalculated", 'checked' => 1, 'position' => 104],
    't.progress' => ['label' => "ProgressDeclared", 'checked' => 1, 'position' => 105],
    't.progress_summary' => ['label' => "TaskProgressSummary", 'checked' => 1, 'position' => 106],
    't.tobill' => ['label' => "TimeToBill", 'checked' => 0, 'position' => 110],
    't.billed' => ['label' => "TimeBilled", 'checked' => 0, 'position' => 111],
    't.datec' => ['label' => "DateCreation", 'checked' => 0, 'position' => 500],
    't.tms' => ['label' => "DateModificationShort", 'checked' => 0, 'position' => 500],
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all) {
    ...
    $id = $obj->id;
    header("Location: " . DOL_URL_ROOT . '/Modules/Projects/tasks/task.php?id=' . $id . '&withproject=1');
    exit;
}
...
$newcardbutton = dolGetButtonTitle($langs->trans('NewTask'), '', 'fa fa-plus-circle', DOL_URL_ROOT . '/Modules/Projects/tasks.php?action=create', '', $user->rights->projet->creer);
    ...
    if ($userAccess >= 0) {
        ...
        if (!empty($arrayfields['t.duration_effective']['checked'])) {
            ...
            if ($showlineingray) {
                ...
                print '<a href="' . DOL_URL_ROOT . '/Modules/Projects/tasks/time.php?id=' . $object->id . ($showproject ? '' : '&withproject=1') . '">';
            }
