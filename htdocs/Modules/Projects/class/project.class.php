...
class Project extends CommonObject
{
    ...
    public $title;
    public $date_start;
    public $date_end; // To store id of thirdparty
     ...
     */
    public $fk_user_close; //!< Tell if this is a public or private project
    /**
     * @var int user close id
     */
     ...
     */
    public $price_booth;
    public $statuts_short; // 0=draft, 1=opened, 2=closed
    public $statuts_long; // opportunity status, into table llx_c_lead_status
    public $statut; // opportunity probability
    public $opp_status;
    public $opp_percent;
    ...
    public $fields = [
        ...
        'fk_opp_status' => ['type' => 'integer', 'label' => 'OpportunityStatusShort', 'enabled' => 1, 'visible' => 1, 'position' => 75],
        'opp_percent' => ['type' => 'double(5,2)', 'label' => 'OpportunityProbabilityShort', 'enabled' => 1, 'visible' => 1, 'position' => 80],
        'note_private' => ['type' => 'text', 'label' => 'NotePrivate', 'enabled' => 1, 'visible' => 0, 'position' => 85, 'searchall' => 1],
        'note_public' => ['type' => 'text', 'label' => 'NotePublic', 'enabled' => 1, 'visible' => 0, 'position' => 90, 'searchall' => 1],
        ...
        'opp_amount' => ['type' => 'double(24,8)', 'label' => 'OpportunityAmountShort', 'enabled' => 1, 'visible' => 1, 'position' => 115],
        'budget_amount' => ['type' => 'double(24,8)', 'label' => 'Budget', 'enabled' => 1, 'visible' => 1, 'position' => 119],
        'usage_bill_time' => ['type' => 'integer', 'label' => 'UsageBillTimeShort', 'enabled' => 1, 'visible' => -1, 'position' => 130],
        'usage_opportunity' => ['type' => 'integer', 'label' => 'UsageOpportunity', 'enabled' => 1, 'visible' => -1, 'position' => 135],
        'usage_task' => ['type' => 'integer', 'label' => 'UsageTasks', 'enabled' => 1, 'visible' => -1, 'position' => 140],
        'usage_organize_event' => ['type' => 'integer', 'label' => 'UsageOrganizeEvent', 'enabled' => 1, 'visible' => -1, 'position' => 145],
        'accept_conference_suggestions' => ['type' => 'integer', 'label' => 'AllowUnknownPeopleSuggestConf', 'enabled' => 1, 'visible' => -1, 'position' => 146],
        'accept_booth_suggestions' => ['type' => 'integer', 'label' => 'AllowUnknownPeopleSuggestBooth', 'enabled' => 1, 'visible' => -1, 'position' => 147],
        'price_registration' => ['type' => 'double(24,8)', 'label' => 'PriceOfRegistration', 'enabled' => 1, 'visible' => -1, 'position' => 148],
        'price_booth' => ['type' => 'double(24,8)', 'label' => 'PriceOfBooth', 'enabled' => 1, 'visible' => -1, 'position' => 149],
        'datec' => ['type' => 'datetime', 'label' => 'DateCreationShort', 'enabled' => 1, 'visible' => -2, 'position' => 200],
        'tms' => ['type' => 'timestamp', 'label' => 'DateModificationShort', 'enabled' => 1, 'visible' => -2, 'notnull' => 1, 'position' => 205],
        'fk_user_creat' => ['type' => 'integer', 'label' => 'UserCreation', 'enabled' => 1, 'visible' => 0, 'notnull' => 1, 'position' => 210],
        'fk_user_modif' => ['type' => 'integer', 'label' => 'UserModification', 'enabled' => 1, 'visible' => 0, 'position' => 215],
        'import_key' => ['type' => 'varchar(14)', 'label' => 'ImportId', 'enabled' => 1, 'visible' => 0, 'position' => 220],
        'email_msgid' => ['type' => 'varchar(255)', 'label' => 'EmailMsgID', 'enabled' => 1, 'visible' => -1, 'position' => 250, 'help' => 'EmailMsgIDWhenSourceisEmail'],
    ...
    public function __construct($db)
    {
        ...
        $this->statuts_short = [0 => 'Draft', 1 => 'Opened', 2 => 'Closed'];
        $this->statuts_long = [0 => 'Draft', 1 => 'Opened', 2 => 'Closed'];
