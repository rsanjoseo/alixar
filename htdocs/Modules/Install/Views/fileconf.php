        ...
        <table class="nobordernopadding<?php if ($force_install_noedit) {
            ...
            <tr>
                <td colspan="3" class="label">
                    <h3><img class="valignmiddle inline-block paddingright"
                             src="<?= BASE_URI ?>/theme/common/octicons/build/svg/globe.svg" width="20"
            ...
            <tr>
                <td colspan="3" class="label"><br>
                    <h3><img class="valignmiddle inline-block paddingright"
                             src="<?= BASE_URI ?>/theme/common/octicons/build/svg/database.svg" width="20"
                             alt="webserver"> <?php echo $langs->trans("DolibarrDatabase"); ?></h3>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="label">
                    ...
                    $dir = DOL_DOCUMENT_ROOT . '/Database/Engines';
                    $files = scandir($dir);
                    if ($files === false) {
                        die('No database drivers found in ' . $dir);
                    }
                    foreach ($files as $file) {
                        if (!is_dir($dir . '/' . $file)) {
                            // If not is a .php file, then continue with the next value
                            if (strtolower(substr($file, -4)) !== '.php') {
                                continue;
                            }

                            $data = substr($file, 0, -4); // Delete .php extension
            ...
            <tr class="hidesqlite hideroot">
                <td colspan="3" class="label"><br>
                    <h3><img class="valignmiddle inline-block paddingright"
                             src="' . BASE_URI . '/theme/common/octicons/build/svg/shield.svg" width="20"
