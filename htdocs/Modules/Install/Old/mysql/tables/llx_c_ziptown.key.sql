...
ALTER TABLE llx_c_ziptown
    ADD INDEX idx_c_ziptown_fk_county (fk_county);
ALTER TABLE llx_c_ziptown
    ADD INDEX idx_c_ziptown_fk_pays (fk_pays);
ALTER TABLE llx_c_ziptown
    ADD INDEX idx_c_ziptown_zip (zip);
...
ALTER TABLE llx_c_ziptown
    ADD UNIQUE INDEX uk_ziptown_fk_pays (zip, town, fk_pays);
