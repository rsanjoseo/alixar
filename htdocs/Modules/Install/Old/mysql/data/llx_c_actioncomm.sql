...
insert into llx_c_actioncomm (id, code, libelle, type, module, active, position)
values (2, 'AC_FAX', 'Send Fax', 'system', NULL, 1, 3);
insert into llx_c_actioncomm (id, code, libelle, type, module, active, position)
values (4, 'AC_EMAIL', 'Send Email', 'system', NULL, 1, 4);
insert into llx_c_actioncomm (id, code, libelle, type, module, active, position)
values (5, 'AC_RDV', 'Rendez-vous', 'system', NULL, 1, 1);
insert into llx_c_actioncomm (id, code, libelle, type, module, active, position)
values (6, 'AC_EMAIL_IN', 'reception Email', 'system', NULL, 1, 4);
insert into llx_c_actioncomm (id, code, libelle, type, module, active, position)
...
insert into llx_c_actioncomm (id, code, libelle, type, module, active, position)
values (50, 'AC_OTH', 'Other (manually inserted events)', 'systemauto', NULL, 1, 5);
