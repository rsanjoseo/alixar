...
$conf->file->dol_document_root = [DOL_DOCUMENT_ROOT];
...
function pHeader($subtitle, $next, $action = 'set', $param = '', $forcejqueryurl = '', $csstable = 'main-inside')
{
    ...
    print '<link rel="stylesheet" type="text/css" href="' . BASE_URI . '/Modules/Install/Views/css/default.css">' . "\n";
    ...
    if ($jQueryCustomPath) {
        ...
        print '<script type="text/javascript" src="' . BASE_URI . '/includes/jquery/js/jquery.min.js"></script>' . "\n";
    }
    if ($jQueryUiCustomPath) {
        print '<script type="text/javascript" src="' . $jQueryUiCustomPath . 'jquery-ui.min.js"></script>' . "\n";
    } else {
        print '<script type="text/javascript" src="' . BASE_URI . '/includes/jquery/js/jquery-ui.min.js"></script>' . "\n";
    }
    ...
    print '<img class="imglogoinstall" src="' . BASE_URI . '/theme/dolibarr_logo.svg" alt="Dolibarr logo" width="300px"><br>';
    print DOL_VERSION;
    print '</div><br>';
    ...
    // print '<form name="forminstall" style="width: 100%" action="' . BASE_URI . '?module=Install&controller=' . ucfirst($next) . $param . '" method="POST"';
    print '<form name="forminstall" style="width: 100%" action="' . BASE_URI . '/Modules/Install/Controllers/Dol_' . ucfirst($next) . $param . '.php" method="POST"';
...
function pFooter($nonext = 0, $setuplang = '', $jscheckfunction = '', $withpleasewait = 0, $morehtml = '')
{
    ...
    $langs->loadLangs(["main", "other", "admin"]);
