...
$hookmanager->initHooks(['ordersindex']);
...
if (!empty($conf->commande->enabled)) {
    ...
    if ($resql) {
        ...
        print '<table class="noborder centpercent">';
        print '<tr class="liste_titre">';
        print '<th colspan="4">' . $langs->trans("OrdersToProcess") . ' <a href="' . DOL_URL_ROOT . '/Modules/Commande/list.php?search_status=' . Commande::STATUS_VALIDATED . '"><span class="badge">' . $num . '</span></a></th></tr>';
...
if (!empty($conf->commande->enabled)) {
    ...
    if ($resql) {
        ...
        print '<table class="noborder centpercent">';
        print '<tr class="liste_titre">';
        print '<th colspan="4">' . $langs->trans("OnProcessOrders") . ' <a href="' . DOL_URL_ROOT . '/Modules/Commande/list.php?search_status=' . Commande::STATUS_ACCEPTED . '"><span class="badge">' . $num . '</span></a></th></tr>';
