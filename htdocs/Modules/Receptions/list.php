...
$arrayfields = [
    ...
    'e.billed' => ['label' => $langs->trans("Billed"), 'checked' => 1, 'position' => 1000, 'enabled' => (!empty($conf->global->WORKFLOW_BILL_ON_RECEPTION))],
];
...
if (!empty($arrayfields['e.fk_statut']['checked'])) {
    ...
    print $form->selectarray('search_status', ['0' => $langs->trans('StatusReceptionDraftShort'), '1' => $langs->trans('StatusReceptionValidatedShort'), '2' => $langs->trans('StatusReceptionProcessedShort')], $search_status, 1);
    print '</td>';
}
// Status billed
