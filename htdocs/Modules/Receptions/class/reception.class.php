...
class Reception extends CommonObject
{
    ...
    {
        // phpcs:enable
        dol_include_once('/Modules/Fourn/class/fournisseur.commande.dispatch.class.php');
    ...
    public function initAsSpecimen()
    {
        ...
        include_once DOL_DOCUMENT_ROOT . '/Modules/Fourn/class/fournisseur.commande.dispatch.class.php';
        $now = dol_now();
