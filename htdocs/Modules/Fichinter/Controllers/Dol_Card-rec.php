...
require_once DOL_DOCUMENT_ROOT . '/Modules/Fichinter/class/fichinterrec.class.php';
...
$langs->loadLangs(["interventions", "admin", "compta", "bills"]);
...
$arrayfields = [
    ...
    'f.fk_contrat' => ['label' => "Contract", 'checked' => 1],
    'f.duree' => ['label' => "Duration", 'checked' => 1],
    'f.total_ttc' => ['label' => "AmountTTC", 'checked' => 1],
    'f.frequency' => ['label' => "RecurringInvoiceTemplate", 'checked' => 1],
    'f.nb_gen_done' => ['label' => "NbOfGenerationDoneShort", 'checked' => 1],
    'f.date_last_gen' => ['label' => "DateLastGeneration", 'checked' => 1],
    'f.date_when' => ['label' => "NextDateToExecution", 'checked' => 1],
...
if ($action == 'add') {
    ...
    if ($newfichinterid > 0) {
        ...
        header('Location: ' . DOL_URL_ROOT . '/Modules/Fichinter/card.php?id=' . $newfichinterid);
        exit;
    } else {
...
if ($action == 'create') {
    ...
    if ($object->fetch($id, $ref) > 0) {
        ...
        if (!empty($conf->projet->enabled)) {
            ...
            print ' &nbsp; <a href="' . DOL_URL_ROOT . '/Modules/Projects/card.php?socid=' . $object->thirdparty->id;
            ...
            if (!empty($conf->projet->enabled)) {
                ...
                if ($user->rights->ficheinter->creer) {
                    ...
                    if (!empty($object->fk_project)) {
                        ...
                        $morehtmlref .= '<a href="' . DOL_URL_ROOT . '/Modules/Projects/card.php?id=' . $object->fk_project . '"';
