...
require_once DOL_DOCUMENT_ROOT . '/Modules/Fichinter/class/fichinterstats.class.php';
...
$langs->loadLangs(['interventions', 'companies', 'other', 'suppliers']);
...
$h = 0;
$head = [];
$head[$h][0] = DOL_URL_ROOT . '/Modules/Fichinter/stats/index.php';
