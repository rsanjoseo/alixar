...
class Fichinter extends CommonObject
{
    ...
    public $fields = [
        ...
        'fk_soc' => ['type' => 'integer:Societe:societe/class/societe.class.php', 'label' => 'ThirdParty', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 15],
        'fk_projet' => ['type' => 'integer:Project:projet/class/project.class.php:1:fk_statut=1', 'label' => 'Fk projet', 'enabled' => 1, 'visible' => -1, 'position' => 20],
        'fk_contrat' => ['type' => 'integer', 'label' => 'Fk contrat', 'enabled' => 1, 'visible' => -1, 'position' => 25],
        ...
        'fk_statut' => ['type' => 'smallint(6)', 'label' => 'Fk statut', 'enabled' => 1, 'visible' => -1, 'position' => 500],
        ...
        'description' => ['type' => 'text', 'label' => 'Description', 'enabled' => 1, 'visible' => -1, 'position' => 105, 'showoncombobox' => 2],
        'note_private' => ['type' => 'text', 'label' => 'NotePrivate', 'enabled' => 1, 'visible' => 0, 'position' => 110],
        'note_public' => ['type' => 'text', 'label' => 'NotePublic', 'enabled' => 1, 'visible' => 0, 'position' => 115],
    ...
    public $dateo;
    public $datee;
    public $datet; // 0=draft, 1=validated, 2=invoiced, 3=Terminate
    /**
