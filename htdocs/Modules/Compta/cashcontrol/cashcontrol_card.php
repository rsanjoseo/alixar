...
if (empty($backtopage)) {
    $backtopage = DOL_URL_ROOT . '/Modules/Compta/cashcontrol/cashcontrol_card.php?id=' . ($id > 0 ? $id : '__ID__');
}
$backurlforlist = DOL_URL_ROOT . '/Modules/Compta/cashcontrol/cashcontrol_list.php';
...
if (empty($action) || $action == "view" || $action == "close") {
    ...
    if ($result <= 0) {
        ...
        $head = [];
        $head[0][0] = DOL_URL_ROOT . '/Modules/Compta/cashcontrol/cashcontrol_card.php?id=' . $object->id;
        ...
        $linkback = '<a href="' . DOL_URL_ROOT . '/Modules/Compta/cashcontrol/cashcontrol_list.php?restore_lastsearch_values=1">' . $langs->trans("BackToList") . '</a>';
