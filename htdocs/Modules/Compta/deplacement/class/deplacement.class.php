...
class Deplacement extends CommonObject
{
    ...
    public function __construct($db)
    {
        ...
        $this->statuts_short = [0 => 'Draft', 1 => 'Validated', 2 => 'Refunded'];
        $this->statuts = [0 => 'Draft', 1 => 'Validated', 2 => 'Refunded'];
    }
    ...
    public function getNomUrl($withpicto = 0)
    {
        ...
        $link = '<a href="' . DOL_URL_ROOT . '/Modules/Compta/deplacement/card.php?id=' . $this->id . '" title="' . dol_escape_htmltag($label, 1) . '" class="classfortooltip">';
        $linkend = '</a>';
