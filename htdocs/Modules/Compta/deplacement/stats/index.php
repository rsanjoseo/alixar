...
require_once DOL_DOCUMENT_ROOT . '/Modules/Compta/deplacement/class/deplacementstats.class.php';
...
$h = 0;
$head = [];
$head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/deplacement/stats/index.php';
...
print $form->select_company($socid, 'socid', $filter, 1, 1, 0, [], 0, 'widthcentpercentminusx maxwidth300', '');
print '</td></tr>';
// User
