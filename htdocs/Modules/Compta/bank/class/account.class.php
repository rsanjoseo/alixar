...
class Account extends CommonObject
{
    ...
    public $fields = [
        ...
        'fk_pays' => ['type' => 'integer', 'label' => 'Fk pays', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 95],
        'proprio' => ['type' => 'varchar(60)', 'label' => 'Proprio', 'enabled' => 1, 'visible' => -1, 'position' => 100],
        'owner_address' => ['type' => 'text', 'label' => 'Owner address', 'enabled' => 1, 'visible' => -1, 'position' => 105],
        ...
        'note_public' => ['type' => 'text', 'label' => 'NotePrivate', 'enabled' => 1, 'visible' => 0, 'position' => 170],
