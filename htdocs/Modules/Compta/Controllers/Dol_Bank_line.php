...
if ($result) {
    ...
    if ($db->num_rows($result)) {
        ...
        if (count($links)) {
            ...
            foreach ($links as $key => $val) {
                ...
                if ($links[$key]['type'] == 'payment') {
                    ...
                    /*print '<a href="'.DOL_URL_ROOT.'/Modules/Compta/paiement/card.php?id='.$links[$key]['url_id'].'">';
                    ...
                    $paymenttmp->fetch($links[$key]['url_id']);
                    $paymenttmp->ref = $langs->trans("Payment") . ' ' . $paymenttmp->ref;
                    /*print '<a href="'.DOL_URL_ROOT.'/Modules/Fourn/paiement/card.php?id='.$links[$key]['url_id'].'">';
                    print img_object($langs->trans('Payment'),'payment').' ';
                    print $langs->trans("Payment");
                    print '</a>';*/
                    print $paymenttmp->getNomUrl(1);
                    ...
                    print '<a href="' . DOL_URL_ROOT . '/Modules/Compta/tva/card.php?id=' . $links[$key]['url_id'] . '">';
                    ...
                    print '<a href="' . DOL_URL_ROOT . '/Modules/Compta/payment_vat/card.php?id=' . $links[$key]['url_id'] . '">';
                    ...
                    print '<a href="' . DOL_URL_ROOT . '/Modules/Don/payment/card.php?id=' . $links[$key]['url_id'] . '">';
                    print img_object($langs->trans('Donation'), 'payment') . ' ';
                    print $langs->trans("DonationPayment");
                    print '</a>';
                } elseif ($links[$key]['type'] == 'banktransfert') {
                    print '<a href="' . DOL_URL_ROOT . '/Modules/Compta/bank/line.php?rowid=' . $links[$key]['url_id'] . '">';
                    ...
                    print '<a href="' . DOL_URL_ROOT . '/Modules/Compta/bank/various_payment/card.php?id=' . $links[$key]['url_id'] . '">';
        ...
        if ($user->rights->banque->modifier || $user->rights->banque->consolidate) {
            ...
            if ($objp->receiptid) {
                include_once DOL_DOCUMENT_ROOT . '/Modules/Compta/paiement/cheque/class/remisecheque.class.php';
        ...
        */
        ...
        if ($acct->canBeConciliated() > 0) {  // Si compte rapprochable
            ...
            if ($user->rights->banque->consolidate) {
                ...
                if ($objp->num_releve) {
                    print ' &nbsp; (<a href="' . DOL_URL_ROOT . '/Modules/Compta/bank/releve.php?num=' . $objp->num_releve . '&account=' . $acct->id . '">' . $langs->trans("AccountStatement") . ' ' . $objp->num_releve . ')</a>';
                }
                print '</td>';
            } else {
