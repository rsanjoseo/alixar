...
/*
* TODO: fill array "$fields" in "/Modules/Compta/bank/class/paymentvarious.class.php" and use
*
*
...
$arrayfields = [
    ...
    'project' => ['label' => "Project", 'checked' => 1, 'position' => 200, "enabled" => !empty($conf->projet->enabled)],
    'bank' => ['label' => "BankAccount", 'checked' => 1, 'position' => 300, "enabled" => !empty($conf->banque->enabled)],
    'entry' => ['label' => "BankTransactionLine", 'checked' => 1, 'position' => 310, "enabled" => !empty($conf->banque->enabled)],
    'account' => ['label' => "AccountAccountingShort", 'checked' => 1, 'position' => 400, "enabled" => !empty($conf->accounting->enabled)],
    'subledger' => ['label' => "SubledgerAccount", 'checked' => 1, 'position' => 410, "enabled" => !empty($conf->accounting->enabled)],
...
if ($result) {
    ...
    if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all) {
        ...
        $id = $obj->rowid;
        header("Location: " . DOL_URL_ROOT . '/Modules/Compta/bank/various_payment/card.php?id=' . $id);
        exit;
    }
    ...
    $url = DOL_URL_ROOT . '/Modules/Compta/bank/various_payment/card.php?action=create';
    if (!empty($socid)) {
