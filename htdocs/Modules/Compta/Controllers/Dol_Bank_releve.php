...
require_once DOL_DOCUMENT_ROOT . '/Modules/Compta/paiement/cheque/class/remisecheque.class.php';
...
$langs->loadLangs(["banks", "categories", "companies", "bills", "trips", "donations", "loan"]);
...
if (empty($numref)) {
    ...
    if ($result) {
        ...
        if ($object->canBeConciliated() > 0) {
            ...
            if ($user->rights->banque->consolidate) {
                $buttonreconcile = '<a class="butAction" href="' . DOL_URL_ROOT . '/Modules/Compta/bank/bankentries_list.php?action=reconcile&sortfield=b.datev,b.dateo,b.rowid&sortorder=asc,asc,asc&search_conciliated=0&search_account=' . $id . $param . '">' . $titletoconciliatemanual . '</a>';
            } else {
    ...
    if ($result) {
        ...
        while ($i < $numrows) {
            ...
            print '<a href="' . DOL_URL_ROOT . '/Modules/Compta/bank/line.php?rowid=' . $objp->rowid . '&amp;account=' . $object->id . '">';
            $reg = [];
            ...
            foreach ($links as $key => $val) {
                ...
                if ($links[$key]['type'] == 'payment') {
                    ...
                    print '<a href="' . DOL_URL_ROOT . '/Modules/Compta/payment_sc/card.php?id=' . $links[$key]['url_id'] . '">';
                    ...
                    print '<a href="' . DOL_URL_ROOT . '/Modules/Adherents/card.php?rowid=' . $links[$key]['url_id'] . '">';
                    print img_object($langs->trans('ShowMember'), 'user') . ' ';
                    print $links[$key]['label'];
                    print '</a>';
                    $newline = 0;
                } elseif ($links[$key]['type'] == 'user') {
                    print '<a href="' . DOL_URL_ROOT . '/Modules/Users/card.php?id=' . $links[$key]['url_id'] . '">';
                    print img_object($langs->trans('ShowUser'), 'user') . ' ';
                    print $links[$key]['label'];
                    print '</a>';
                    $newline = 0;
                } elseif ($links[$key]['type'] == 'sc') {
                    print '<a href="' . DOL_URL_ROOT . '/Modules/Compta/sociales/card.php?id=' . $links[$key]['url_id'] . '">';
            ...
            if ($user->rights->banque->modifier || $user->rights->banque->consolidate) {
                print '<td class="center"><a class="editfielda reposition" href="' . DOL_URL_ROOT . '/Modules/Compta/bank/line.php?rowid=' . $objp->rowid . '&account=' . $object->id . '&backtopage=' . urlencode($_SERVER["PHP_SELF"] . '?account=' . $object->id . '&num=' . $numref) . '">';
                print img_edit();
                print "</a></td>";
            } else {
