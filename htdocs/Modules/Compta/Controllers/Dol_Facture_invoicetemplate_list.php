...
$langs->loadLangs(['bills', 'compta', 'admin', 'other']);
...
$arrayfields = [
    ...
    'recurring' => ['label' => "RecurringInvoiceTemplate", 'checked' => 1],
        ...
        while ($i < min($num, $limit)) {
            ...
            if ($user->rights->facture->creer && empty($invoicerectmp->suspended)) {
                if ($invoicerectmp->isMaxNbGenReached()) {
                    ...
                    print '<a href="' . DOL_URL_ROOT . '/Modules/Compta/facture/card.php?action=create&amp;socid=' . $objp->socid . '&amp;fac_rec=' . $objp->facid . '">';
