...
$listofchoices = [
    'selectinvoices' => ['label' => 'Invoices', 'lang' => 'bills', 'enabled' => !empty($conf->facture->enabled), 'perms' => !empty($user->rights->facture->lire)],
    'selectsupplierinvoices' => ['label' => 'BillsSuppliers', 'lang' => 'bills', 'enabled' => !empty($conf->supplier_invoice->enabled), 'perms' => !empty($user->rights->fournisseur->facture->lire)],
    'selectexpensereports' => ['label' => 'ExpenseReports', 'lang' => 'trips', 'enabled' => !empty($conf->expensereport->enabled), 'perms' => !empty($user->rights->expensereport->lire)],
    'selectdonations' => ['label' => 'Donations', 'lang' => 'donation', 'enabled' => !empty($conf->don->enabled), 'perms' => !empty($user->rights->don->lire)],
    'selectsocialcontributions' => ['label' => 'SocialContributions', 'enabled' => !empty($conf->tax->enabled), 'perms' => !empty($user->rights->tax->charges->lire)],
    'selectpaymentsofsalaries' => ['label' => 'SalariesPayments', 'lang' => 'salaries', 'enabled' => !empty($conf->salaries->enabled), 'perms' => !empty($user->rights->salaries->read)],
    'selectvariouspayment' => ['label' => 'VariousPayment', 'enabled' => !empty($conf->banque->enabled), 'perms' => !empty($user->rights->banque->lire)],
    'selectloanspayment' => ['label' => 'PaymentLoan', 'enabled' => !empty($conf->loan->enabled), 'perms' => !empty($user->rights->loan->read)],
];
