...
require_once DOL_DOCUMENT_ROOT . '/Modules/Compta/facture/class/facturestats.class.php';
...
$h = 0;
$head = [];
$head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/facture/stats/index.php?mode=' . urlencode($mode);
