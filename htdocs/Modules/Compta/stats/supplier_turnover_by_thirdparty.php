...
if (count($amount)) {
    ...
    foreach ($arrayforsort as $key => $value) {
        ...
        if ($modecompta != 'CREANCES-DETTES') {
            if ($key > 0) {
                print '<a href="' . DOL_URL_ROOT . '/Modules/Fourn/facture/paiement/list.php?socid=' . $key . '">';
            } else {
                print '<a href="' . DOL_URL_ROOT . '/Modules/Fourn/facture/paiement/list.php?socid=-1">';
            }
        } else {
            if ($key > 0) {
                print '<a href="' . DOL_URL_ROOT . '/Modules/Fourn/facture/list.php?socid=' . $key . '">';
            } else {
                print '<a href="#">';
            }
        ...
        if ($modecompta != 'CREANCES-DETTES') {
            if ($key > 0) {
                ...
                print '<a href="' . DOL_URL_ROOT . '/Modules/Fourn/facture/paiement/list.php?orphelins=1">';
            }
        } else {
            if ($key > 0) {
                print '<a href="' . DOL_URL_ROOT . '/Modules/Fourn/facture/list.php?socid=' . $key . '">';
        ...
        if (!empty($conf->supplier_proposal->enabled) && $key > 0) {
            print '&nbsp;<a href="' . DOL_URL_ROOT . '/Modules/Comm/propal/stats/index.php?socid=' . $key . '">' . img_picto($langs->trans("ProposalStats"), "stats") . '</a>&nbsp;';
        }
        if (((!empty($conf->fournisseur->enabled) && empty($conf->global->MAIN_USE_NEW_SUPPLIERMOD)) || !empty($conf->supplier_order->enabled)) && $key > 0) {
            print '&nbsp;<a href="' . DOL_URL_ROOT . '/Modules/Commande/stats/index.php?mode=supplier&socid=' . $key . '">' . img_picto($langs->trans("OrderStats"), "stats") . '</a>&nbsp;';
        }
        if (((!empty($conf->fournisseur->enabled) && empty($conf->global->MAIN_USE_NEW_SUPPLIERMOD)) || !empty($conf->supplier_invoice->enabled)) && $key > 0) {
            print '&nbsp;<a href="' . DOL_URL_ROOT . '/Modules/Compta/facture/stats/index.php?mode=supplier&socid=' . $key . '">' . img_picto($langs->trans("InvoiceStats"), "stats") . '</a>&nbsp;';
        }
        print '</td>';
        print "</tr>\n";
        $i++;
