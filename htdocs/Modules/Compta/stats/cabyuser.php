...
if (count($amount)) {
    ...
    foreach ($arrayforsort as $key => $value) {
        ...
        $fullname = $name[$key];
        if ($key >= 0) {
            $linkname = '<a href="' . DOL_URL_ROOT . '/Modules/Users/card.php?id=' . $key . '">' . img_object($langs->trans("ShowUser"), 'user') . ' ' . $fullname . '</a>';
        } else {
        ...
        if ($modecompta == 'RECETTES-DEPENSES') {
            if ($key > 0) {
                //print '<a href="'.DOL_URL_ROOT.'/Modules/Compta/paiement/list.php?userid='.$key.'">';
            } else {
                //print '<a href="'.DOL_URL_ROOT.'/Modules/Compta/paiement/list.php?userid=-1">';
            }
        } elseif ($modecompta == 'CREANCES-DETTES') {
            if ($key > 0) {
                print '<a href="' . DOL_URL_ROOT . '/Modules/Compta/facture/list.php?userid=' . $key . '">';
            } else {
                //print '<a href="#">';
            }
        ...
        if (!empty($conf->propal->enabled) && $key > 0) {
            print '&nbsp;<a href="' . DOL_URL_ROOT . '/Modules/Comm/propal/stats/index.php?userid=' . $key . '">' . img_picto($langs->trans("ProposalStats"), "stats") . '</a>&nbsp;';
        }
        if (!empty($conf->commande->enabled) && $key > 0) {
            print '&nbsp;<a href="' . DOL_URL_ROOT . '/Modules/Commande/stats/index.php?userid=' . $key . '">' . img_picto($langs->trans("OrderStats"), "stats") . '</a>&nbsp;';
        }
        if (!empty($conf->facture->enabled) && $key > 0) {
            print '&nbsp;<a href="' . DOL_URL_ROOT . '/Modules/Compta/facture/stats/index.php?userid=' . $key . '">' . img_picto($langs->trans("InvoiceStats"), "stats") . '</a>&nbsp;';
        }
        print '</td>';
        print "</tr>\n";
        $i++;
