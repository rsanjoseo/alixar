...
$linkback = '<a href="' . DOL_URL_ROOT . '/Modules/Compta/paiement/list.php?restore_lastsearch_values=1">' . $langs->trans("BackToList") . '</a>';
...
if (!empty($conf->banque->enabled)) {
    if ($object->fk_account > 0) {
        if ($object->type_code == 'CHQ' && $bankline->fk_bordereau > 0) {
            dol_include_once('/Modules/Compta/paiement/cheque/class/remisecheque.class.php');
