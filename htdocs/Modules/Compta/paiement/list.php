...
$arrayfields = [
    ...
    'transaction' => ['label' => "BankTransactionLine", 'checked' => 1, 'position' => 50, 'enabled' => (!empty($conf->banque->enabled))],
    'ba.label' => ['label' => "Account", 'checked' => 1, 'position' => 60, 'enabled' => (!empty($conf->banque->enabled))],
    ...
    'p.statut' => ['label' => "Status", 'checked' => 1, 'position' => 90, 'enabled' => (!empty($conf->global->BILL_ADD_PAYMENT_VALIDATION))],
];
