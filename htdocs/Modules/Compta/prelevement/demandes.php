...
$newcardbutton = '<a class="marginrightonly" href="' . DOL_URL_ROOT . '/Modules/Compta/prelevement/index.php">' . $langs->trans("Back") . '</a>';
if ($type == 'bank-transfer') {
    $newcardbutton = '<a class="marginrightonly" href="' . DOL_URL_ROOT . '/Modules/Compta/paymentbybanktransfer/index.php">' . $langs->trans("Back") . '</a>';
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans($label), '', 'fa fa-plus-circle', DOL_URL_ROOT . '/Modules/Compta/prelevement/create.php' . ($typefilter ? '?' . $typefilter : ''));
