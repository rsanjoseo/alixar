...
if ($result) {
    ...
    if ($num) {
        while ($i < min($num, $limit)) {
            ...
            print "&nbsp;";
            print '<a href="' . DOL_URL_ROOT . '/Modules/Compta/prelevement/line.php?id=' . $obj->rowid_ligne . '">';
            ...
            print '&nbsp;<a href="' . DOL_URL_ROOT . '/Modules/Compta/facture/card.php?facid=' . $obj->facid . '">' . $obj->invoiceref . "</a></td>\n";
            print '</a>';
            print '</td>';
