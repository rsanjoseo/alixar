...
require_once DOL_DOCUMENT_ROOT . '/Modules/Compta/prelevement/class/ligneprelevement.class.php';
require_once DOL_DOCUMENT_ROOT . '/Modules/Compta/prelevement/class/rejetprelevement.class.php';
...
$langs->loadlangs(['banks', 'categories', 'bills', 'withdrawals']);
...
$h = 0;
$head[$h][0] = DOL_URL_ROOT . '/Modules/Compta/prelevement/line.php?id=' . $id . '&type=' . $type;
$head[$h][1] = $title;
$hselected = $h;
$h++;
...
if ($id) {
    ...
    if ($result) {
        ...
        while ($i < min($num, $conf->liste_limit)) {
            ...
            print '<a href="' . DOL_URL_ROOT . '/Modules/Compta/facture/card.php?facid=' . $obj->facid . '">';
            print img_object($langs->trans("ShowBill"), "bill");
            print '</a>&nbsp;';

            print '<a href="' . DOL_URL_ROOT . '/Modules/Compta/facture/card.php?facid=' . $obj->facid . '">' . $obj->ref . "</a></td>\n";

            print '<td><a href="' . DOL_URL_ROOT . '/Modules/Comm/card.php?socid=' . $obj->socid . '">';
