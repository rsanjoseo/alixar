    ...
    if ($action == 'confirm_delete') {
        ...
        if ($res > 0) {
            if ($object->type == 'bank-transfer') {
                header("Location: " . DOL_URL_ROOT . '/Modules/Compta/paymentbybanktransfer/index.php');
            } else {
                header("Location: " . DOL_URL_ROOT . '/Modules/Compta/prelevement/index.php');
            }
            exit;
        }
    }
...
if ($id > 0 || $ref) {
    ...
    $linkback = '<a href="' . DOL_URL_ROOT . '/Modules/Compta/prelevement/orders_list.php?restore_lastsearch_values=1' . ($object->type != 'bank-transfer' ? '' : '&type=bank-transfer') . '">' . $langs->trans("BackToList") . '</a>';
    ...
    */
    ...
    if ($result) {
        ...
        while ($i < min($num, $limit)) {
            ...
            print "&nbsp;";
            print '<a href="' . DOL_URL_ROOT . '/Modules/Compta/prelevement/line.php?id=' . $obj->rowid . '&type=' . $object->type . '&token=' . newToken() . '">';
