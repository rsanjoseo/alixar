...
if ($resql) {
    ...
    if ($num > 0) {
        ...
        while ($i < $num) {
            ...
            print '<a href="' . DOL_URL_ROOT . '/Modules/Compta/prelevement/line.php?id=' . $obj->rowid . '">';
            print img_picto('', 'statut' . $obj->statut) . ' ';
            print substr('000000' . $obj->rowid, -6);
            print '</a></td>';
            print '<td><a href="' . DOL_URL_ROOT . '/Modules/Comm/card.php?socid=' . $obj->socid . '">' . $obj->name . "</a></td>\n";
