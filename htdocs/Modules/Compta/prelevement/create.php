...
if (empty($reshook)) {
    ...
    if ($action == 'create') {
        ...
        if ((empty($bank->ics) && $type !== 'bank-transfer')
            ...
            header("Location: " . DOL_URL_ROOT . '/Modules/Compta/prelevement/create.php');
            exit;
        }
        ...
        if ($result < 0) {
            ...
            header("Location: " . DOL_URL_ROOT . '/Modules/Compta/prelevement/card.php?id=' . $bprev->id);
            exit;
        }
    }
...
/*$h=0;
$head[$h][0] = DOL_URL_ROOT.'/Modules/Compta/prelevement/create.php';
