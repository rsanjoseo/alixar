...
require_once DOL_DOCUMENT_ROOT . '/Modules/Margins/lib/margins.lib.php';
...
class Facture extends CommonInvoice
{
    ...
    const CLOSECODE_REPLACED = 'replaced'; // Date invoice
    /**
     ...
     */
    public $table_element = 'facture'; // deprecated; Use delivery_date instead.
    /**
     * @var string    Name of subtable line
     */
    public $table_element_line = 'facturedet'; // Date expected of shipment (date starting shipment, not the reception that occurs some days after)
    /**
    ...
    public $total_ht = 0;
    public $total_tva = 0;
    public $total_localtax1 = 0; // Code in llx_c_paiement
    public $total_localtax2 = 0; // Code in llx_c_paiement
    public $total_ttc = 0;
    public $revenuestamp;
    /**
     ...
     */
    public $retained_warranty_date_limit; // Abandonned remain - escompte
    /**
     * @var int Code in llx_c_paiement
     */
    public $retained_warranty_fk_cond_reglement; // Abandonned - bad
    /**
    ...
    public $fields = [
        ...
        'remise_percent' => ['type' => 'double', 'label' => 'RelativeDiscount', 'enabled' => 1, 'visible' => -1, 'position' => 90],
        'remise_absolue' => ['type' => 'double', 'label' => 'CustomerRelativeDiscount', 'enabled' => 1, 'visible' => -1, 'position' => 91],
        ...
        'fk_user_author' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'UserAuthor', 'enabled' => 1, 'visible' => -1, 'position' => 165],
        'fk_user_modif' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'UserModif', 'enabled' => 1, 'visible' => -2, 'notnull' => -1, 'position' => 166],
        'fk_user_valid' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'UserValidation', 'enabled' => 1, 'visible' => -1, 'position' => 167],
        'fk_user_closing' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'UserClosing', 'enabled' => 1, 'visible' => -1, 'position' => 168],
        ...
        'note_private' => ['type' => 'text', 'label' => 'NotePublic', 'enabled' => 1, 'visible' => 0, 'position' => 205],
        'note_public' => ['type' => 'text', 'label' => 'NotePrivate', 'enabled' => 1, 'visible' => 0, 'position' => 210],
        ...
        'fk_multicurrency' => ['type' => 'integer', 'label' => 'MulticurrencyID', 'enabled' => '$conf->multicurrency->enabled', 'visible' => -1, 'position' => 275],
        'multicurrency_code' => ['type' => 'varchar(255)', 'label' => 'Currency', 'enabled' => '$conf->multicurrency->enabled', 'visible' => -1, 'position' => 280],
        'multicurrency_tx' => ['type' => 'double(24,8)', 'label' => 'CurrencyRate', 'enabled' => '$conf->multicurrency->enabled', 'visible' => -1, 'position' => 285, 'isameasure' => 1],
        'multicurrency_total_ht' => ['type' => 'double(24,8)', 'label' => 'MulticurrencyAmountHT', 'enabled' => '$conf->multicurrency->enabled', 'visible' => -1, 'position' => 290, 'isameasure' => 1],
        'multicurrency_total_tva' => ['type' => 'double(24,8)', 'label' => 'MulticurrencyAmountVAT', 'enabled' => '$conf->multicurrency->enabled', 'visible' => -1, 'position' => 291, 'isameasure' => 1],
        'multicurrency_total_ttc' => ['type' => 'double(24,8)', 'label' => 'MulticurrencyAmountTTC', 'enabled' => '$conf->multicurrency->enabled', 'visible' => -1, 'position' => 292, 'isameasure' => 1],
        ...
        'module_source' => ['type' => 'varchar(32)', 'label' => 'POSModule', 'enabled' => 1, 'visible' => -1, 'position' => 315],
        'pos_source' => ['type' => 'varchar(32)', 'label' => 'POSTerminal', 'enabled' => 1, 'visible' => -1, 'position' => 320],
        'datec' => ['type' => 'datetime', 'label' => 'DateCreation', 'enabled' => 1, 'visible' => -1, 'position' => 500],
        'tms' => ['type' => 'timestamp', 'label' => 'DateModificationShort', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 500],
                ...
                if (!$error) {
                    ...
                    if ($res > 0) {
                        ...
                        if (!$error) {
                            ...
                            // Mail Creation
                            $cMailFile = new CMailFile($sendTopic, $to, $from, $sendContent, [], [], [], '', "", 0, 1, $errors_to, '', $trackid, '', '', '');
