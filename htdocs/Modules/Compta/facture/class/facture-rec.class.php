...
class FactureRec extends CommonInvoice
{
    ...
    public $fields = [
        ...
        'fk_soc' => ['type' => 'integer:Societe:societe/class/societe.class.php', 'label' => 'ThirdParty', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 25],
        ...
        'remise' => ['type' => 'double', 'label' => 'Remise', 'enabled' => 1, 'visible' => -1, 'position' => 40],
        ...
        'fk_projet' => ['type' => 'integer:Project:projet/class/project.class.php:1:fk_statut=1', 'label' => 'Fk projet', 'enabled' => 1, 'visible' => -1, 'position' => 85],
        ...
        'date_last_gen' => ['type' => 'varchar(7)', 'label' => 'Last gen', 'enabled' => 1, 'visible' => -1, 'position' => 120],
        ...
        'fk_account' => ['type' => 'integer', 'label' => 'Fk account', 'enabled' => 1, 'visible' => -1, 'position' => 175],
    ...
    public function getNomUrl($withpicto = 0, $option = '', $max = 0, $short = 0, $moretitle = '', $notooltip = '', $save_lastsearch_value = -1)
    {
        ...
        $url = DOL_URL_ROOT . '/Modules/Compta/facture/card-rec.php?facid=' . $this->id;
