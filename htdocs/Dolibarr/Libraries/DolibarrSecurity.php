 ...
 *
 * Set of function used for dolibarr security (common function included into filefunc.inc.php)
 * Warning, this file must not depends on other library files, except function.lib.php
 * because it is used at low code level.
 *
 * @package Alxarafe\Dolibarr\Libraries
 */
abstract class DolibarrSecurity
{
    /**
     ...
     * @see dol_decode()
     */
    static public function dol_encode($chain, $key = '1')
    {
     ...
     *  This static public function is called by filefunc.inc.php at each page call.
     *
     ...
     * @see dol_encode()
     */
    static public function dol_decode($chain, $key = '1')
    {
     ...
     */
    static public function restrictedArea($user, $features, $objectid = 0, $tableandshare = '', $feature2 = '', $dbt_keyfield = 'fk_soc', $dbt_select = 'rowid', $isdraft = 0, $mode = 0)
    {
        global $db, $conf;
        global $hookmanager;
        ...
        if (!empty($objectid) && $objectid > 0) {
            ...
            $params = ['objectid' => $objectid, 'features' => join(',', $featuresarray), 'features2' => $feature2];
     ...
     * @see restrictedArea()
     */
    static public function checkUserAccessToObject($user, array $featuresarray, $objectid = 0, $tableandshare = '', $feature2 = '', $dbt_keyfield = '', $dbt_select = 'rowid', $parenttableforentity = '')
    {
        global $db, $conf;
        ...
        foreach ($featuresarray as $feature) {
            ...
            $check = ['adherent', 'banque', 'bom', 'don', 'mrp', 'user', 'usergroup', 'payment', 'payment_supplier', 'product', 'produit', 'service', 'produit|service', 'categorie', 'resource', 'expensereport', 'holiday', 'salaries', 'website']; // Test on entity only (Objects with no link to company)
            $checksoc = ['societe']; // Test for societe object
            $checkother = ['contact', 'agenda']; // Test on entity + link to third party on field $dbt_keyfield. Allowed if link is empty (Ex: contacts...).
     ...
     * @return    void
     */
    static public function accessforbidden($message = '', $printheader = 1, $printfooter = 1, $showonlymessage = 0, $params = null)
    {
