...
abstract class DolibarrJson
{
     ...
     */
    static public function json_encode($elements)
    {
     ...
     * @see json_encode()
     */
    static public function dol_json_encode($elements)
    {
     ...
     */
    static public function _val($val)
    {
        if (is_string($val)) {
     ...
     * @see json_decode()
     */
    static public function dol_json_decode($json, $assoc = false)
    {
        dol_syslog("For better performance, enable the native json in your PHP", LOG_WARNING);
     ...
     * @return  string          Formated value
     */
    static public function _unval($val)
    {
        $reg = [];
