...
abstract class DolibarrFunctions2
{
    /**
     ...
     */
    static function colorArrayToHex($arraycolor, $colorifnotfound = '888888')
    {
     ...
     */
    static function colorStringToArray($stringcolor, $colorifnotfound = [88, 88, 88])
    {
     ...
     * @return string
     */
    static function colorDarker($hex, $percent)
    {
        $steps = intval(255 * $percent / 100) * -1;
        return self::colorAdjustBrightness($hex, $steps);
    }
     ...
     */
    static function colorAdjustBrightness($hex, $steps)
    {
     ...
     */
    static function colorHexToRgb($hex, $alpha = false, $returnArray = false)
    {
        $string = '';
        $hex = str_replace('#', '', $hex);
        $length = strlen($hex);
    ...
    function getModuleDirForApiClass($moduleobject)
    {
        ...
        } elseif (in_array($moduleobject, ['products', 'expensereports', 'users', 'tickets', 'boms'])) {
