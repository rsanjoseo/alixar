...
class InterfaceActionsAuto extends DolibarrTriggers
{
    ...
    public function runTrigger($action, $object, User $user, $langs, Conf $conf)
    {
        ...
        if ($action == 'COMPANY_CREATE') {
            ...
            $langs->loadLangs(["agenda", "other", "companies"]);
            ...
            // Load translation files required by the page
            $langs->loadLangs(["agenda", "other", "orders"]);
            ...
            $object->sendtoid = [$object->id => $object->id];
            ...
            // Load translation files required by the page
            $langs->loadLangs(["agenda", "other", "contracts"]);
            ...
            // Load translation files required by the page
            $langs->loadLangs(["agenda", "other", "propal"]);
            ...
            // Load translation files required by the page
            $langs->loadLangs(["agenda", "other", "bills"]);
            ...
            // Load translation files required by the page
            $langs->loadLangs(["agenda", "other", "interventions"]);
            ...
            // Load translation files required by the page
            $langs->loadLangs(["agenda", "other", "sendings"]);
            ...
            // Load translation files required by the page
            $langs->loadLangs(["agenda", "other", "orders", "main"]);
            ...
            // Load translation files required by the page
            $langs->loadLangs(["agenda", "other", "bills", "orders"]);
            ...
            // Members
            // Load translation files required by the page
            $langs->loadLangs(["agenda", "other", "members"]);
            ...
            // Projects
            // Load translation files required by the page
            $langs->loadLangs(["agenda", "other", "projects"]);
        ...
        if (!in_array($elementtype, ['societe', 'contact', 'project'])) {
