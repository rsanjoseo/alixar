    ...
    function main()
    {
        ...
        */
        ...
        if (!defined('NOLOGIN')) {
            ...
            /**
             * TODO: Authentication don't work correctly (Very urgent)
             */
            $this->user->login = true; // TODO: Authentication don't work correctly
            $this->user->statut = 1; // TODO: Authentication don't work correctly
        }
        ...
        $warning = '';
        $error = 0;
        // deprecated, see DolibarrFunctions::setEventMessage() and dol_htmloutput_events()
        $mesgs = [];
        $warnings = [];
        $errors = [];
            ...
            */
            ...
            if ($resultFetchUser <= 0) {
                ...
                if ($resultFetchUser == 0) {
                    ...
                    $_SESSION["dol_loginmesg"] = $this->langs->transnoentitiesnoconv("ErrorCantLoadUserFromDolibarrDatabase", $login);
            ...
            DolibarrFunctions::dol_syslog("- This is an already logged session. _SESSION['dol_login']=" . $login . " _SESSION['dol_entity']=" . $entity, LOG_DEBUG);
